...
* `lets_encrypt_environment` - (Optional, String) The configuration of the Let's Encrypt CA environment.
...
* `lets_encrypt_private_key` - (Optional, String) The PEM encoded private key of your Lets Encrypt account.
