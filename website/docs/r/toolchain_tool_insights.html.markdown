...
You can import the `ibm_toolchain_tool_insights` resource by using `id`.
...
# Syntax
```
$ terraform import ibm_toolchain_tool_insights.toolchain_tool_insights <toolchain_id>/<integration_id>
```
