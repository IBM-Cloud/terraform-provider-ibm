...
- `access_tags` - (Optional, List of Strings) A list of access management tags to attach to the volume. **Note** For more information, about creating access tags, see [working with tags](https://cloud.ibm.com/docs/account?topic=account-tag).
