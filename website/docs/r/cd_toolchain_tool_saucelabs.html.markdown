...
More information on this Continuous Delivery tool integration can be found [here](https://cloud.ibm.com/docs/ContinuousDelivery?topic=ContinuousDelivery-saucelabs).
...
Nested scheme for **parameters**:
	* `access_key` - (Required, String) The access key for the Sauce Labs account.
