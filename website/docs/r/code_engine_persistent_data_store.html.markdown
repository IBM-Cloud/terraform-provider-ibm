...
Nested schema for **data**:
	* `bucket_location` - (Optional, Forces new resource, String) Specify the location of the bucket.
	...
	* `bucket_name` - (Optional, Forces new resource, String) Specify the name of the bucket.
	...
	* `secret_name` - (Optional, Forces new resource, String) Specify the name of the HMAC secret.
