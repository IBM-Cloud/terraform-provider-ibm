...
- `disks` - (List) The Collection of the dedicated host's disks. 
  ...
  - `created_at` - The creation date and time of the disk.
  - `href` - The URL for the disk.
  - `id` - The unique identifier for the disk.
  - `instance_disks` - Instance disks that are on the dedicated host disk. 

     Nested scheme for `instance_disks`:
     - `deleted` - If present, this property indicates the referenced resource has been deleted and provides some supplementary information. 
   ...
   - `name` - The user-defined or system-provided name for the disk.
   - `provisionable` - Indicates whether the dedicated host disk is available for instance disk creation.
...
- `instances` -  (String) Array of instances that are allocated to this dedicated host. 
  ...
  - `deleted` -  (String) If present, this property indicates the referenced resource has been deleted and provides supplementary information. 
