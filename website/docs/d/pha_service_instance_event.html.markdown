---
layout: "ibm"
page_title: "IBM : ibm_pha_service_instance_event"
description: |-
  Get information about pha_service_instance_event
subcategory: "PowerhaAutomation Service"
---

# ibm_pha_service_instance_event

Retrieve details of a single PowerHA automation event using the specified event ID.

## Example Usage

```hcl
data "ibm_pha_service_instance_event" "pha_service_instance_event" {
	accept_language = "en-US"
	event_id = "00116b2a-9326-4024-839e-fb5364bvfv90"
...
* `id` - The unique identifier of the pha_service_instance_event.
