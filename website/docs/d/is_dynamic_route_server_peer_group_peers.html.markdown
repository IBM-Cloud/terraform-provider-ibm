---
layout: "ibm"
page_title: "IBM : ibm_is_dynamic_route_server_peer_group_peers"
description: |-
  Get information about DynamicRouteServerPeerGroupPeerCollection
subcategory: "Virtual Private Cloud API"
---

# ibm_is_dynamic_route_server_peer_group_peers

Provides a read-only data source to retrieve information about a DynamicRouteServerPeerGroupPeerCollection. You can then reference the fields of the data source in other resources within the same configuration by using interpolation syntax.

## Example Usage

```hcl
data "ibm_is_dynamic_route_server_peer_group_peers" "is_dynamic_route_server_peer_group_peers" {
...
* `id` - The unique identifier of the DynamicRouteServerPeerGroupPeerCollection.
* `peers` - (List) 
