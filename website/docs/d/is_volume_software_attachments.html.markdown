---
layout: "ibm"
page_title: "IBM : ibm_is_volume_software_attachments"
description: |-
  Get information about VolumeSoftwareAttachmentCollection
subcategory: "Virtual Private Cloud API"
---

# ibm_is_volume_software_attachments

Provides a read-only data source to retrieve information about a VolumeSoftwareAttachmentCollection. You can then reference the fields of the data source in other resources within the same configuration by using interpolation syntax.
...
* `id` - The unique identifier of the VolumeSoftwareAttachmentCollection.
* `software_attachments` - (List) The software attachments for the volume.
