...
* `description` - (String) Human-readable message explaining the proxy IP validation result.
* `status` - (String) Status of the proxy IP validation (for example, valid, invalid, or error).
