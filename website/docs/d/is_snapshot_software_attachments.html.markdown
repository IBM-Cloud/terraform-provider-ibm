---
layout: "ibm"
page_title: "IBM : ibm_is_snapshot_software_attachments"
description: |-
  Get information about SnapshotSoftwareAttachmentCollection
subcategory: "Virtual Private Cloud API"
---

# ibm_is_snapshot_software_attachments

Provides a read-only data source to retrieve information about a SnapshotSoftwareAttachmentCollection. You can then reference the fields of the data source in other resources within the same configuration by using interpolation syntax.
