---
layout: "ibm"
page_title: "IBM : ibm_backup_recovery_manager_get_management_alerts_summary"
description: |-
  Get information about backup_recovery_manager_get_management_alerts_summary
...
```hcl
data "ibm_backup_recovery_manager_get_management_alerts_summary" "backup_recovery_manager_get_management_alerts_summary" {
}
```
...
* `cluster_identifiers` - (Optional, List) Specifies the list of cluster identifiers. Format is clusterId:clusterIncarnationId.
...
* `id` - The unique identifier of the backup_recovery_manager_get_management_alerts_summary.
