---
layout: "ibm"
page_title: "IBM : ibm_is_vpn_gateway_members"
description: |-
  Get information about VPNGatewayMemberCollection
subcategory: "Virtual Private Cloud API"
---

# ibm_is_vpn_gateway_members

Provides a read-only data source to retrieve information about a VPNGatewayMemberCollection. You can then reference the fields of the data source in other resources within the same configuration by using interpolation syntax.

## Example Usage

```hcl
data "ibm_is_vpn_gateway_members" "is_vpn_gateway_members" {
...
- `id` - The unique identifier of the VPNGatewayMemberCollection.
