...
description: |-
  Get information about brs_migration_workload
subcategory: "IBM Cloud Backup and Recovery Migration API"
---

# ibm_brs_migration_workload

Provides a read-only data source to retrieve information about a brs_migration_workload. You can then reference the fields of the data source in other resources within the same configuration by using interpolation syntax.

## Example Usage

```hcl
data "ibm_brs_migration_workload" "brs_migration_workload" {
