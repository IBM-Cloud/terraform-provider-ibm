...
description: |-
  Get information about pdr_powervs_workspaces
...
```hcl
data "ibm_pdr_powervs_workspaces" "pdr_powervs_workspaces" {
...
* `id` - The unique identifier of the pdr_powervs_workspaces.
