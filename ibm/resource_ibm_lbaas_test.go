...
func TestAccIBMLbaas_Basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccCheckIBMLbaasConfig_updateHTTPS_ssl_ciphers(name),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"ibm_lbaas.lbaas", "name", name),
					resource.TestCheckResourceAttr(
...
func TestAccIBMLbaas_Private(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIBMLbaasConfig_private(name),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"ibm_lbaas.lbaas", "name", name),
					resource.TestCheckResourceAttr(
			...
			{
				Config: testAccCheckIBMLbaasConfig_private_update(name),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"ibm_lbaas.lbaas", "name", name),
					resource.TestCheckResourceAttr(
			...
			{
				Config: testAccCheckIBMLbaasConfig_private_updateHTTPS(name),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"ibm_lbaas.lbaas", "name", name),
					resource.TestCheckResourceAttr(
...
func testAccCheckIBMLbaasConfig_private(name string) string {
	return fmt.Sprintf(`
resource "ibm_lbaas" "lbaas" {
  name        = "%s"
  description = "desc-used for terraform uat"
...
func testAccCheckIBMLbaasConfig_private_update(name string) string {
	return fmt.Sprintf(`
resource "ibm_lbaas" "lbaas" {
  name        = "%s"
...
func testAccCheckIBMLbaasConfig_private_updateHTTPS(name string) string {
	return fmt.Sprintf(`
...
func testAccCheckIBMLbaasConfig_updateHTTPS_ssl_ciphers(name string) string {
	return fmt.Sprintf(`
resource "ibm_compute_ssl_certificate" "test-cert" {
    certificate = <<EOF
-----BEGIN CERTIFICATE-----
