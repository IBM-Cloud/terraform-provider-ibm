		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("ibm_service_key.servicekey", "credentials.%", "5"),
			...
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.ibm_service_instance.testacc_ds_service_instance", "service_keys.0.credentials.%", "5"),
