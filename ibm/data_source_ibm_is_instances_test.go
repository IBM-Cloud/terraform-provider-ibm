...
`)
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccCheckIBMISInstancesDataSourceConfig(vpcname, subnetname, sshname, publicKey, instanceName),
				Check: resource.ComposeTestCheckFunc(
...
func testAccCheckIBMISInstancesDataSourceConfig(vpcname, subnetname, sshname, publicKey, instanceName string) string {
	return fmt.Sprintf(`
