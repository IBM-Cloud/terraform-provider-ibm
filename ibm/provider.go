...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"ibm_iam_trusted_profiles_claim_rule":    dataSourceIBMIamTrustedProfilesClaimRule(),
			"ibm_iam_trusted_profiles_link":          dataSourceIBMIamTrustedProfilesLink(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"ibm_iam_trusted_profiles":                           resourceIBMIamTrustedProfiles(),
			"ibm_iam_trusted_profiles_claim_rule":                resourceIBMIamTrustedProfilesClaimRule(),
			"ibm_iam_trusted_profiles_link":                      resourceIBMIamTrustedProfilesLink(),
