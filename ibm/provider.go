...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"ibm_resource_aliases":                   dataSourceIbmResourceAliases(),
			"ibm_resource_bindings":                  dataSourceIbmResourceBindings(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"ibm_resource_alias":                                 resourceIbmResourceAlias(),
			"ibm_resource_binding":                               resourceIbmResourceBinding(),
	...
	initOnce.Do(func() {
		globalValidatorDict = ValidatorDict{
			ResourceValidatorDictionary: map[string]*ResourceValidator{
				...
				"ibm_resource_alias":                    resourceIbmResourceAliasValidator(),
				"ibm_resource_binding":                  resourceIbmResourceBindingValidator(),
