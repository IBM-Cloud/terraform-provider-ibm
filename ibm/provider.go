...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"ibm_is_bare_metal_server_disk":               dataSourceBareMetalServerDisk(),
			"ibm_is_bare_metal_server_disks":              dataSourceBareMetalServerDisks(),
			"ibm_is_bare_metal_server_initialization":     dataSourceBareMetalServerInitialization(),
			"ibm_is_bare_metal_server_network_interface":  dataSourceBareMetalServerNetworkInterface(),
			"ibm_is_bare_metal_server_network_interfaces": dataSourceBareMetalServerNetworkInterfaces(),
			"ibm_is_bare_metal_server_profile":            dataSourceBareMetalServerProfile(),
			"ibm_is_bare_metal_server_profiles":           dataSourceIBMISBareMetalServerProfiles(),
			"ibm_is_bare_metal_server":                    dataSourceBareMetalServer(),
			"ibm_is_bare_metal_servers":                   dataSourceIBMISBareMetalServers(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"ibm_is_bare_metal_server_network_interface":         resourceIBMisBareMetalServerNetworkInterface(),
			"ibm_is_bare_metal_server":                           resourceIBMisBareMetalServer(),
	...
	initOnce.Do(func() {
		globalValidatorDict = ValidatorDict{
			ResourceValidatorDictionary: map[string]*ResourceValidator{
				...
				"ibm_is_bare_metal_server":              resourceIBMISBareMetalServerValidator(),
			...
			DataSourceValidatorDictionary: map[string]*ResourceValidator{
				...
				"ibm_is_bare_metal_server":    dataSourceIBMISBareMetalServerValidator(),
