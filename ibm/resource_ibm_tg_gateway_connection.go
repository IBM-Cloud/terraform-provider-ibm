	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			tgLocalGatewayIp: {
				...
				Computed:    true,
				ForceNew:    true,
				Description: "The local gateway IP address.  This field is required for and only applicable to 'gre_tunnel' connection types",
			},
			tgLocalTunnelIp: {
				Type:        schema.TypeString,
				Optional:    true,
				Computed:    true,
				ForceNew:    true,
				Description: "The local tunnel IP address. This field is required for and only applicable to type gre_tunnel connections.",
			},
			tgRemoteBgpAsn: {
				Type:        schema.TypeInt,
				Optional:    true,
				Computed:    true,
				ForceNew:    true,
				Description: "The local network BGP ASN. This field only applies to network type 'gre_tunnel' connections.",
			},
			tgRemoteGatewayIp: {
				Type:        schema.TypeString,
				Optional:    true,
			...
			tgRemoteTunnelIp: {
				...
				Computed:    true,
				ForceNew:    true,
				Description: "The local Remote tunnel IP address. This field only applies to network type 'gre_tunnel' connections.",
			},
			tgZone: {
				Type:        schema.TypeString,
				Optional:    true,
