...
import (
	...
	pfunctions "github.com/IBM-Cloud/terraform-provider-ibm/ibm/provider_framework/functions"
...
func (p *frameworkProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
	...
	// Set the client session for resources, data sources, actions, and ephemeral resources
...
func (p *frameworkProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		// CIS
		cis.NewCISAlertResource,
		cis.NewCISWebhookResource,
		// KMS
		kms.NewKMSKeyResource,
		kms.NewKMSKeyAliasResource,
		// Resource Manager
		resourcemanager.NewResourceGroupResource,
		// VPC
...
func (p *frameworkProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		// CIS
		cis.NewCISAlertsDataSource,
		cis.NewCISWebhooksDataSource,
		// Classic Infrastructure
		classicinfrastructure.NewComputeSshKeyDataSource,
		// KMS
		kms.NewKMSKeyDataSource,
		kms.NewKMSKeyPoliciesDataSource,
		// Resource Manager
		resourcemanager.NewResourceGroupDataSource,
		resourcemanager.NewResourceGroupsDataSource,
		// VPC
		vpc.NewIsSshKeyDataSource,
	}
}
...
func (p *frameworkProvider) EphemeralResources(ctx context.Context) []func() ephemeral.EphemeralResource {
	return []func() ephemeral.EphemeralResource{
		// VPC
		vpc.NewIsSshKeyEphemeralResource,
	}
}
...
func (p *frameworkProvider) Functions(ctx context.Context) []func() function.Function {
	return []func() function.Function{
		// CRN utilities
		pfunctions.NewCRNServiceNameFunction,
	}
}
