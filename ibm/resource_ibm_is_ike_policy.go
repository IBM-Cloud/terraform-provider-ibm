...
func resourceIBMISIKEValidator() *ResourceValidator {
	...
	dh_group := "2, 5, 14"
	ike_version := "1, 2"
	validateSchema = append(validateSchema, ValidateSchema{Identifier: isIKEAuthenticationAlg, ValidateFunctionIdentifier: ValidateAllowedStringValue, Type: TypeStringList, Required: true, AllowedValues: authentication_algorithm})
	validateSchema = append(validateSchema, ValidateSchema{Identifier: isIKEEncryptionAlg, ValidateFunctionIdentifier: ValidateAllowedStringValue, Type: TypeStringList, Required: true, AllowedValues: encryption_algorithm})
	validateSchema = append(validateSchema, ValidateSchema{Identifier: isIKEDhGroup, ValidateFunctionIdentifier: ValidateAllowedIntValue, Type: TypeIntList, Required: true, AllowedValues: dh_group})
	validateSchema = append(validateSchema, ValidateSchema{Identifier: isIKEVERSION, ValidateFunctionIdentifier: ValidateAllowedIntValue, Type: TypeIntList, Optional: true, AllowedValues: ike_version})
