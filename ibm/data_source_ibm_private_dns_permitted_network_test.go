...
func TestAccIBMPrivateDNSNetworkDataSource_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIBMpDNSPermittedNetworksDataSourceConfig(riname, zonename),
...
func testAccCheckIBMpDNSPermittedNetworksDataSourceConfig(riname, zonename string) string {
