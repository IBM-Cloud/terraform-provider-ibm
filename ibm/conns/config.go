...
type ClientSession interface {
	...
	VpcBetaV1API() (*vpcbeta.VpcbetaV1, error)
...
func (sess clientSession) VpcBetaV1API() (*vpcbeta.VpcbetaV1, error) {
...
func (c *Config) ClientSession() (interface{}, error) {
	...
	if err != nil {
		session.vpcbetaErr = fmt.Errorf("[ERROR] Error occured while configuring vpc service: %q", err)
	}
