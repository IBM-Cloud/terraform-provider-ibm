		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(
						"data.ibm_is_instance_group_manager_action.instance_group_manager_action", "instance_group_manager_scheduled"),
					resource.TestCheckResourceAttrSet(
						"data.ibm_is_instance_group_manager_action.instance_group_manager_action", "name"),
					resource.TestCheckResourceAttrSet(
						"data.ibm_is_instance_group_manager_action.instance_group_manager_action", "instance_group_manager_action"),
				),
			},
		},
	})
