...
func init() {
	...
	if Pi_volume_group_id == "" {
		...
		fmt.Println("[INFO] Set the environment variable PI_VOLUME_GROUP_ID for testing ibm_pi_network_name resource else it is set to default value 'terraform-test-power'")
	}
