...
// Additional work required with CIS team to validate these tests and appropriate undocumented parameters


// func TestAccIBMCISDNSRecord_LOC(t *testing.T) {
// 	t.Parallel()
// 	var record v1.DnsRecord
...
// 		Steps: []resource.TestStep{
// 			{
// 				Config: testAccCheckIBMCISDNSRecordConfigLOC(testName, cis_domain),
// 				Check: resource.ComposeTestCheckFunc(
// 					testAccCheckIBMCISDNSRecordExists(resourceName, &record),
// 					resource.TestCheckResourceAttr(
// 						resourceName, "content", "37 46 46.000 N 122 23 35.000 W 0.00m 100.00m 0.00m 0.00m"),
// 					resource.TestCheckResourceAttr(
...
// func TestAccIBMCISDNSRecord_SRV(t *testing.T) {
// 	t.Parallel()
// 	var record v1.DnsRecord
// 	testName := "test"
// 	resourceName := fmt.Sprintf("ibm_cis_dns_record.%s", testName)
...
// 		Steps: []resource.TestStep{
// 			{
// 				Config: testAccCheckIBMCISDNSRecordConfigSRV(testName, cis_domain),
// 				Check: resource.ComposeTestCheckFunc(
// 					testAccCheckIBMCISDNSRecordExists(resourceName, &record),
// 					resource.TestCheckResourceAttr(
// 						resourceName, "content", "0   5222    talk.l.google.com"),
// 					resource.TestCheckResourceAttr(
// 						resourceName, "proxiable", "false"),
// 					resource.TestCheckResourceAttr(
// 						resourceName, "data.%", "7"),
...
// func TestAccIBMCISDNSRecord_Proxied(t *testing.T) {
// 	t.Parallel()
// 	var record v1.DnsRecord
// 	testName := "tf-acctest-proxied"
// 	resourceName := fmt.Sprintf("ibm_cis_dns_record.%s", "testName")
...
// 		Steps: []resource.TestStep{
// 			{
// 				Config: testAccCheckIBMCISDNSRecordConfigProxied(testName, cis_domain),
// 				Check: resource.ComposeTestCheckFunc(
// 					testAccCheckIBMCISDNSRecordExists(resourceName, &record),
// 					resource.TestCheckResourceAttr(
...
// 					resource.TestCheckResourceAttr(
// 						resourceName, "content", cis_domain),
// 					resource.TestCheckResourceAttr(
// 						resourceName, "data.%", "0"),
// 				),
// 			},
