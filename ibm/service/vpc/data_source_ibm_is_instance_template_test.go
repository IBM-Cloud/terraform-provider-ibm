...
func TestAccIBMISInstanceTemplate_AvailabilityPolicy(t *testing.T) {
	randInt := acctest.RandIntRange(600, 700)
	publicKey := strings.TrimSpace(`
	ssh-rsa  root@ffd8363b1226
	`)
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckIBMISInstanceTemplateDAvailabilityPolicyConfig(vpcName, subnetName, sshKeyName, publicKey, templateName),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"data.ibm_is_instance_template.instance_template_data", "name", templateName),
					resource.TestCheckResourceAttrSet(
						"data.ibm_is_instance_template.instance_template_data", "availability.#"),
					resource.TestCheckResourceAttr(
						"data.ibm_is_instance_template.instance_template_data", "availability.0.class", "spot"),
					resource.TestCheckResourceAttrSet(
						"data.ibm_is_instance_template.instance_template_data", "availability_policy.#"),
					resource.TestCheckResourceAttr(
						"data.ibm_is_instance_template.instance_template_data", "availability_policy.0.preemption", "stop"),
					resource.TestCheckResourceAttr(
						"data.ibm_is_instance_template.instance_template_data", "availability_policy_host_failure", "restart"),
				),
			},
		},
	})
...
func testAccCheckIBMISInstanceTemplateDAvailabilityPolicyConfig(vpcName, subnetName, sshKeyName, publicKey, templateName string) string {
	return fmt.Sprintf(`
...
func TestAccIBMISInstanceTemplate_dataBootFirmware(t *testing.T) {
	randInt := acctest.RandIntRange(600, 700)
	publicKey := strings.TrimSpace(`
	ssh-rsa  root@ffd8363b1226
	`)
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckIBMISInstanceTemplateDBootFirmwareConfig(vpcName, subnetName, sshKeyName, publicKey, templateName, bfsm),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"data.ibm_is_instance_template.instance_template_data", "name", templateName),
					resource.TestCheckResourceAttr(
						"data.ibm_is_instance_template.instance_template_data", "boot_firmware_selection_mode", bfsm),
				),
			},
		},
	})
...
func testAccCheckIBMISInstanceTemplateDBootFirmwareConfig(vpcName, subnetName, sshKeyName, publicKey, templateName, bfsm string) string {
	return testAccCheckIBMISInstanceTemplateBootFirmwareConfig(vpcName, subnetName, sshKeyName, publicKey, templateName, bfsm) + fmt.Sprintf(`
		data "ibm_is_instance_template" "instance_template_data" {
			name = ibm_is_instance_template.instancetemplate1.name
		}
	`)
