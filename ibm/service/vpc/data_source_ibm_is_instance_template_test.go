		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"data.ibm_is_instance_template.instance_template_data", "availability.0.class", "standard"),
					resource.TestCheckResourceAttrSet(
						"data.ibm_is_instance_template.instance_template_data", "availability_policy.#"),
					resource.TestCheckResourceAttr(
						"data.ibm_is_instance_template.instance_template_data", "availability_policy.0.host_failure", "restart"),
				),
			},
		},
	})
