		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"data.ibm_is_instance_templates.instance_templates_data", "templates.0.availability.0.class", "standard"),
					resource.TestCheckResourceAttrSet(
						"data.ibm_is_instance_templates.instance_templates_data", "templates.0.availability_policy.#"),
					resource.TestCheckResourceAttr(
						"data.ibm_is_instance_templates.instance_templates_data", "templates.0.availability_policy.0.host_failure", "restart"),
				),
			},
		},
	})
