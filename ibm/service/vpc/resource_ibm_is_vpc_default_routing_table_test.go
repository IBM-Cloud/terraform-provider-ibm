...
func TestAccIBMISVPCDefaultRoutingTable_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckIBMISVPCDefaultRouteTableConfig(routeTableName, name1),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIBMISVPCRouteTableExists("ibm_is_vpc_default_routing_table.test_ibm_is_vpc_default_routing_table", vpcRouteTables),
					resource.TestCheckResourceAttr(
						"ibm_is_default_vpc_routing_table.test_ibm_is_vpc_default_routing_table", "name", routeTableName),
				),
			},
			{
				Config: testAccCheckIBMISVPCDefaultRouteTableConfig(routeTableName1, name1),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIBMISVPCRouteTableExists("ibm_is_vpc_default_routing_table.test_ibm_is_vpc_default_routing_table", vpcRouteTables),
					resource.TestCheckResourceAttr(
						"ibm_is_vpc_default_routing_table.test_ibm_is_vpc_default_routing_table", "name", routeTableName1),
				),
			},
		},
	})
...
func TestAccIBMISVPCDefaultRoutingTable_acceptRoutesFrom(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckIBMISVPCDefaultRouteTableAcceptRoutesFromConfig(routeTableName, name1, acceptRoutesFromVPNServer),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIBMISVPCDefaultRouteTableExists("ibm_is_vpc_default_routing_table.test_ibm_is_vpc_default_routing_table", vpcRouteTables),
					resource.TestCheckResourceAttr(
						"ibm_is_vpc_default_routing_table.test_ibm_is_vpc_default_routing_table", "name", routeTableName),
					resource.TestCheckResourceAttrSet(
						"ibm_is_vpc_default_routing_table.test_ibm_is_vpc_default_routing_table", "accept_routes_from_resource_type.#"),
				),
			},
			{
				Config: testAccCheckIBMISVPCDefaultRouteTableAcceptRoutesFromConfig(routeTableName1, name1, acceptRoutesFromVPNGateway),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIBMISVPCDefaultRouteTableExists("ibm_is_vpc_default_routing_table.test_ibm_is_vpc_default_routing_table", vpcRouteTables),
					resource.TestCheckResourceAttr(
						"ibm_is_vpc_default_routing_table.test_ibm_is_vpc_default_routing_table", "name", routeTableName1),
...
func testAccCheckIBMISVPCDefaultRouteTableConfig(rtName, name string) string {
	return fmt.Sprintf(`
...
func testAccCheckIBMISVPCDefaultRouteTableAcceptRoutesFromConfig(rtName, name, acceptRoutesFromVPNServer string) string {
	return fmt.Sprintf(`
resource "ibm_is_vpc" "testacc_vpc" {
	name = "%s"
}
