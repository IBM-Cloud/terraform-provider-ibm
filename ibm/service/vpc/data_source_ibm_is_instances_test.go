		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resName, "instances.0.availability.0.class", "standard"),
					resource.TestCheckResourceAttrSet(resName, "instances.0.availability_policy.#"),
					resource.TestCheckResourceAttr(resName, "instances.0.availability_policy.0.host_failure", "restart"),
				),
			},
		},
	})
