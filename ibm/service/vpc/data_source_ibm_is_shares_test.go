		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.ibm_is_shares.is_shares", "shares.0.allowed_transit_encryption_modes.#"),
					resource.TestCheckResourceAttrSet("data.ibm_is_shares.is_shares", "shares.0.origin_share"),
					resource.TestCheckResourceAttrSet("data.ibm_is_shares.is_shares", "total_count"),
				),
			},
		},
