...
func TestAccIBMIsDynamicRouteServerPeerGroupDataSourceBasic(t *testing.T) {
	dynamicRouteServerPeerGroupDynamicRouteServerID := fmt.Sprintf("tf_dynamic_route_server_id_%d", acctest.RandIntRange(10, 100))
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIBMIsDynamicRouteServerPeerGroupDataSourceConfigBasic(dynamicRouteServerPeerGroupDynamicRouteServerID),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "id"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "dynamic_route_server_id"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "is_dynamic_route_server_peer_group_id"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "created_at"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "creator.#"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "health_monitor.#"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "href"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "lifecycle_reasons.#"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "lifecycle_state"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "name"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "peers.#"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "prefix_watcher.#"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "resource_type"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "roles.#"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "state"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "status"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "status_reasons.#"),
				),
			},
		},
	})
...
func TestAccIBMIsDynamicRouteServerPeerGroupDataSourceAllArgs(t *testing.T) {
	dynamicRouteServerPeerGroupDynamicRouteServerID := fmt.Sprintf("tf_dynamic_route_server_id_%d", acctest.RandIntRange(10, 100))
	dynamicRouteServerPeerGroupName := fmt.Sprintf("tf_name_%d", acctest.RandIntRange(10, 100))
	dynamicRouteServerPeerGroupState := "disabled"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIBMIsDynamicRouteServerPeerGroupDataSourceConfig(dynamicRouteServerPeerGroupDynamicRouteServerID, dynamicRouteServerPeerGroupName, dynamicRouteServerPeerGroupState),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "id"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "dynamic_route_server_id"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "is_dynamic_route_server_peer_group_id"),
					...
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "href"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "lifecycle_reasons.#"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "lifecycle_reasons.0.code"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "lifecycle_reasons.0.message"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "lifecycle_reasons.0.more_info"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "lifecycle_state"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "name"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "peers.#"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "peers.0.created_at"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "peers.0.creator"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "peers.0.href"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "peers.0.id"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "peers.0.lifecycle_state"),
					resource.TestCheckResourceAttr("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "peers.0.name", dynamicRouteServerPeerGroupName),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "peers.0.resource_type"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "peers.0.status"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "peers.0.asn"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "peers.0.priority"),
					resource.TestCheckResourceAttr("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "peers.0.state", dynamicRouteServerPeerGroupState),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "prefix_watcher.#"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "resource_type"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "roles.#"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "state"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "status"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "status_reasons.#"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "status_reasons.0.code"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "status_reasons.0.message"),
					resource.TestCheckResourceAttrSet("data.ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance", "status_reasons.0.more_info"),
				),
			},
		},
	})
...
func testAccCheckIBMIsDynamicRouteServerPeerGroupDataSourceConfigBasic(dynamicRouteServerPeerGroupDynamicRouteServerID string) string {
	return fmt.Sprintf(`
		...
		data "ibm_is_dynamic_route_server_peer_group" "is_dynamic_route_server_peer_group_instance" {
			dynamic_route_server_id = ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance.dynamic_route_server_id
			is_dynamic_route_server_peer_group_id = ibm_is_dynamic_route_server_peer_group.is_dynamic_route_server_peer_group_instance.is_dynamic_route_server_peer_group_id
		}
	`, dynamicRouteServerPeerGroupDynamicRouteServerID)
}

func testAccCheckIBMIsDynamicRouteServerPeerGroupDataSourceConfig(dynamicRouteServerPeerGroupDynamicRouteServerID string, dynamicRouteServerPeerGroupName string, dynamicRouteServerPeerGroupState string) string {
	return fmt.Sprintf(`
		resource "ibm_is_dynamic_route_server_peer_group" "is_dynamic_route_server_peer_group_instance" {
			dynamic_route_server_id = "%s"
			health_monitor {
	...
	`, dynamicRouteServerPeerGroupDynamicRouteServerID, dynamicRouteServerPeerGroupName, dynamicRouteServerPeerGroupState)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupHealthMonitorToMap(t *testing.T) {
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupHealthMonitorToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupHealthMonitorNextHopToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["mode"] = "bfd"
		model["roles"] = []string{"next_hop"}
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupHealthMonitorNextHopToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupHealthMonitorRouterToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["mode"] = "bgp"
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupHealthMonitorRouterToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupLifecycleReasonToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupLifecycleReasonToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerStatusReasonToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerStatusReasonToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerAddressBidirectionalForwardingDetectionToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		deletedModel := make(map[string]interface{})
		deletedModel["more_info"] = "https://cloud.ibm.com/apidocs/vpc#deleted-resources"
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerAddressBidirectionalForwardingDetectionToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerAddressBidirectionalForwardingDetectionSessionToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		deletedModel := make(map[string]interface{})
		deletedModel["more_info"] = "https://cloud.ibm.com/apidocs/vpc#deleted-resources"
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerAddressBidirectionalForwardingDetectionSessionToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerMemberReferenceToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		deletedModel := make(map[string]interface{})
		deletedModel["more_info"] = "https://cloud.ibm.com/apidocs/vpc#deleted-resources"
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerMemberReferenceToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDeletedToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDeletedToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupVirtualNetworkInterfaceReferenceToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		deletedModel := make(map[string]interface{})
		deletedModel["more_info"] = "https://cloud.ibm.com/apidocs/vpc#deleted-resources"
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupVirtualNetworkInterfaceReferenceToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupReservedIPReferenceToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		deletedModel := make(map[string]interface{})
		deletedModel["more_info"] = "https://cloud.ibm.com/apidocs/vpc#deleted-resources"
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupReservedIPReferenceToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupSubnetReferenceToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		deletedModel := make(map[string]interface{})
		deletedModel["more_info"] = "https://cloud.ibm.com/apidocs/vpc#deleted-resources"
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupSubnetReferenceToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerReferenceToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		deletedModel := make(map[string]interface{})
		deletedModel["more_info"] = "https://cloud.ibm.com/apidocs/vpc#deleted-resources"
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerReferenceToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerAddressEndpointToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dynamicRouteServerPeerGroupPeerAddressEndpointIPGatewayGatewayModel := make(map[string]interface{})
		dynamicRouteServerPeerGroupPeerAddressEndpointIPGatewayGatewayModel["address"] = "192.168.3.4"
		model := make(map[string]interface{})
		...
		model["deleted"] = []map[string]interface{}{}
		model["href"] = "https://us-south.iaas.cloud.ibm.com/v1/subnets/0717-bea6a632-5e13-42a4-b4b8-31dc877abfe4/reserved_ips/0717-6d353a0f-aeb1-4ae1-832e-1110d10981bb"
		model["id"] = "0717-6d353a0f-aeb1-4ae1-832e-1110d10981bb"
		model["name"] = "my-reserved-ip"
		model["resource_type"] = "subnet_reserved_ip"
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerAddressEndpointToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerAddressEndpointIPGatewayGatewayToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["address"] = "192.168.3.4"
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerAddressEndpointIPGatewayGatewayToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerAddressEndpointIPGatewayToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dynamicRouteServerPeerGroupPeerAddressEndpointIPGatewayGatewayModel := make(map[string]interface{})
		dynamicRouteServerPeerGroupPeerAddressEndpointIPGatewayGatewayModel["address"] = "192.168.3.4"
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerAddressEndpointIPGatewayToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerAddressEndpointByReservedIPToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		deletedModel := make(map[string]interface{})
		deletedModel["more_info"] = "https://cloud.ibm.com/apidocs/vpc#deleted-resources"
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerAddressEndpointByReservedIPToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupIPToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["address"] = "192.168.3.4"
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupIPToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerAddressSessionToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		deletedModel := make(map[string]interface{})
		deletedModel["more_info"] = "https://cloud.ibm.com/apidocs/vpc#deleted-resources"
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerAddressSessionToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerNameToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "my-dynamic-route-server-peer-group-peer"
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerNameToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerAddressToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		lifecycleReasonModel := make(map[string]interface{})
		lifecycleReasonModel["code"] = "resource_suspended_by_provider"
		lifecycleReasonModel["message"] = "The resource has been suspended. Contact IBM support with the CRN for next steps."
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerAddressToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerTransitGatewayToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		lifecycleReasonModel := make(map[string]interface{})
		lifecycleReasonModel["code"] = "resource_suspended_by_provider"
		lifecycleReasonModel["message"] = "The resource has been suspended. Contact IBM support with the CRN for next steps."
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerTransitGatewayToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerTransitGatewayEndpointToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerTransitGatewayEndpointToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerTransitGatewayEndpointTransitGatewayReferenceToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["crn"] = "crn:v1:bluemix:public:transit:dal03:a/aa2432b1fa4d4ace891e9b80fc104e34::gateway:ef4dcb1a-fee4-41c7-9e11-9cd99e65c1f4"
		model["id"] = "ef4dcb1a-fee4-41c7-9e11-9cd99e65c1f4"
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerTransitGatewayEndpointTransitGatewayReferenceToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerTransitGatewaySessionToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		deletedModel := make(map[string]interface{})
		deletedModel["more_info"] = "https://cloud.ibm.com/apidocs/vpc#deleted-resources"
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerTransitGatewaySessionToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerTransitGatewaySessionRemoteToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPeerTransitGatewaySessionRemoteToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPrefixWatcherToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPrefixWatcherToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPrefixWatcherExcludedPrefixToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["ge"] = int(0)
		model["le"] = int(32)
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPrefixWatcherExcludedPrefixToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPrefixWatcherMonitoredPrefixToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["ge"] = int(0)
		model["le"] = int(32)
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupPrefixWatcherMonitoredPrefixToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupStatusReasonToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := vpc.DataSourceIBMIsDynamicRouteServerPeerGroupDynamicRouteServerPeerGroupStatusReasonToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
