...
func TestAccIBMISLBPoolMembers_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccCheckIBMISLBPoolMembersConfig(vpcname, subnetname, acc.ISZoneName, acc.ISCIDR, name, poolName, port1, address1),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIBMISLBPoolMemberExists("ibm_is_lb_pool_member.testacc_lb_mem", lb),
					resource.TestCheckResourceAttr(
...
func TestAccIBMISLBPoolMembers_basic_network(t *testing.T) {
	var lb string
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckIBMISLBPoolMembersIDConfig(
...
func TestAccIBMISLBPoolMembers_basic_opt_weight_check(t *testing.T) {
	var lb string
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckIBMISLBPoolMembersWeightConfig(vpcname, subnetname, acc.ISZoneName, acc.ISCIDR, name, poolName, port, address),
				Check: resource.ComposeTestCheckFunc(
...
func testAccCheckIBMISLBPoolMembersExists(n, lbPoolMember string) resource.TestCheckFunc {
...
func testAccCheckIBMISLBPoolMembersIDConfig(vpcname, subnetname, zone, cidr, sshname,
...
func testAccCheckIBMISLBPoolMembersWeightConfig(vpcname, subnetname, zone, cidr, name, poolName, port, address string) string {
	return fmt.Sprintf(`
	resource "ibm_is_vpc" "testacc_vpc" {
		name = "%s"
	}
