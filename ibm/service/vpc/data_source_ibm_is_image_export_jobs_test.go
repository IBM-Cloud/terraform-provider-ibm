		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.ibm_is_image_export_jobs.is_image_exports", "export_jobs.0.encrypted_data_key"),
					...
					resource.TestCheckResourceAttrSet("data.ibm_is_image_export_jobs.is_image_exports", "export_jobs.0.started_at"),
