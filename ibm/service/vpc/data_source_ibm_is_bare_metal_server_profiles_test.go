		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(resName, "profiles.0.zones.#"),
					resource.TestCheckResourceAttrSet(resName, "profiles.0.zones.0.href"),
					resource.TestCheckResourceAttrSet(resName, "profiles.0.zones.0.name"),
				),
			},
		},
	})
