		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.ibm_is_share_profile.is_share_profile", "capacity.0.default"),
					resource.TestCheckResourceAttrSet("data.ibm_is_share_profile.is_share_profile", "iops"),
					resource.TestCheckResourceAttrSet("data.ibm_is_share_profile.is_share_profile", "iops.0.default"),
				),
			},
		},
	})
