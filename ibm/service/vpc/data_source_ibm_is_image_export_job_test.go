		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.ibm_is_image_export_job.is_image_export_job", "encrypted_data_key"),
					...
					resource.TestCheckResourceAttrSet("data.ibm_is_image_export_job.is_image_export_job", "started_at"),
					resource.TestCheckResourceAttrSet("data.ibm_is_image_export_job.is_image_export_job", "status"),
					resource.TestCheckResourceAttrSet("data.ibm_is_image_export_job.is_image_export_job", "status_reasons.#"),
					resource.TestCheckResourceAttrSet("data.ibm_is_image_export_job.is_image_export_job", "status_reasons.0.code"),
					resource.TestCheckResourceAttrSet("data.ibm_is_image_export_job.is_image_export_job", "status_reasons.0.message"),
					resource.TestCheckResourceAttrSet("data.ibm_is_image_export_job.is_image_export_job", "status_reasons.0.more_info"),
