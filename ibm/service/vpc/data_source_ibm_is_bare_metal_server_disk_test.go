...
`)
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIBMISBareMetalServerDiskDataSourceConfig(vpcname, subnetname, sshname, publicKey, name),
...
func testAccCheckIBMISBareMetalServerDiskDataSourceConfig(vpcname, subnetname, sshname, publicKey, name string) string {
