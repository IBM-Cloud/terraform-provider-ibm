		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.ibm_pha_list_service_instance_events.pha_list_service_instance_events_instance", "instance_id"),
...
func TestDataSourceIBMPhaListServiceInstanceEventsPhaEventToMap(t *testing.T) {
	...
	model.Resource = core.StringPtr("instance_id")
