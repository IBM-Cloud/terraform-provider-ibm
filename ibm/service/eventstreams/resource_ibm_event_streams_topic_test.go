		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("ibm_event_streams_mirroring_config.es_mirroring_config", "mirroring_topic_patterns.#", "2"),
					resource.TestCheckResourceAttr("ibm_event_streams_mirroring_config.es_mirroring_config", "mirroring_topic_patterns.0", "topicA"),
					resource.TestCheckResourceAttr("ibm_event_streams_mirroring_config.es_mirroring_config", "mirroring_topic_patterns.1", "topicB"),
				),
			},
		},
	})
...
resource "ibm_resource_instance" "es_instance" {
  ...
  timeouts {
    ...
    delete = "15m"
		...
		parameters["service-endpoints"], parameters["throughput"], parameters["storage_size"], parameters["source_crn"], parameters["source_alias"], parameters["target_alias"])
}
