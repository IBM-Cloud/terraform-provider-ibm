...
func TestAccIbmLogsAlertDefinitionsDataSourceBasic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIbmLogsAlertDefinitionsDataSourceConfigBasic(alertDefinitionName, alertDefinitionDescription),
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.ibm_logs_alert_definitions.logs_alert_definitions_instance", "alert_definitions.0.name"),
					resource.TestCheckResourceAttrSet("data.ibm_logs_alert_definitions.logs_alert_definitions_instance", "alert_definitions.0.type"),
				),
			},
		},
	})
...
func testAccCheckIbmLogsAlertDefinitionsDataSourceConfigBasic(alertDefinitionName string, alertDefinitionDescription string) string {
	return fmt.Sprintf(`
