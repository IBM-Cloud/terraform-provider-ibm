...
func TestAccIbmBrsMigrationHostDataSourceBasic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIbmBrsMigrationHostDataSourceConfigBasic(hostMigrationID, hostType, hostEnv),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.ibm_brs_migration_host.brs_migration_host_instance", "id"),
					resource.TestCheckResourceAttrSet("data.ibm_brs_migration_host.brs_migration_host_instance", "migration_id"),
					resource.TestCheckResourceAttrSet("data.ibm_brs_migration_host.brs_migration_host_instance", "host_id"),
					resource.TestCheckResourceAttrSet("data.ibm_brs_migration_host.brs_migration_host_instance", "type"),
					resource.TestCheckResourceAttrSet("data.ibm_brs_migration_host.brs_migration_host_instance", "env"),
					resource.TestCheckResourceAttrSet("data.ibm_brs_migration_host.brs_migration_host_instance", "compute.#"),
					resource.TestCheckResourceAttrSet("data.ibm_brs_migration_host.brs_migration_host_instance", "volume_attachments.#"),
					resource.TestCheckResourceAttrSet("data.ibm_brs_migration_host.brs_migration_host_instance", "migrated"),
					resource.TestCheckResourceAttrSet("data.ibm_brs_migration_host.brs_migration_host_instance", "registered_at"),
				),
			},
		},
	})
...
func testAccCheckIbmBrsMigrationHostDataSourceConfigBasic(hostMigrationID string, hostType string, hostEnv string) string {
	return fmt.Sprintf(`
		...
		data "ibm_brs_migration_host" "brs_migration_host_instance" {
			...
			host_id = ibm_brs_migration_host.brs_migration_host_instance.host_id
		}
	`, hostMigrationID, hostType, hostEnv)
}


func TestDataSourceIbmBrsMigrationHostHostComputeToMap(t *testing.T) {
	...
	result, err := brsmigration.DataSourceIbmBrsMigrationHostHostComputeToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBrsMigrationHostHostComputeClassicComputeDetailsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["status"] = "pending"
		model["os_family"] = "linux"
	...
	result, err := brsmigration.DataSourceIbmBrsMigrationHostHostComputeClassicComputeDetailsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBrsMigrationHostHostComputeVPCComputeDetailsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["status"] = "pending"
		model["os_family"] = "linux"
	...
	result, err := brsmigration.DataSourceIbmBrsMigrationHostHostComputeVPCComputeDetailsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBrsMigrationHostVolumeAttachmentToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
