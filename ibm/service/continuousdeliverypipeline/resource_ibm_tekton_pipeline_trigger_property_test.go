...
func TestAccIBMTektonPipelineTriggerPropertyBasic(t *testing.T) {
	var conf continuousdeliverypipelinev2.CreateTektonPipelineTriggerRequestTriggersTriggersItemTriggerScmTriggerPropertiesItem
...
func testAccCheckIBMTektonPipelineTriggerPropertyExists(n string, obj continuousdeliverypipelinev2.CreateTektonPipelineTriggerRequestTriggersTriggersItemTriggerScmTriggerPropertiesItem) resource.TestCheckFunc {
