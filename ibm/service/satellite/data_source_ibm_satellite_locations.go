...
func DataSourceIBMSatelliteLocations() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceIBMSatelliteLocationsRead,
...
func dataSourceIBMSatelliteLocationsRead(d *schema.ResourceData, meta interface{}) error {
	...
	var instance *kubernetesserviceapiv1.MultishiftController
	var response *core.DetailedResponse
	err = resource.Retry(1*time.Minute, func() *resource.RetryError {
		instance, response, err = satClient.GetSatelliteLocations(getSatLocOptions)
