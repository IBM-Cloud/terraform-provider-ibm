...
func TestAccIBMCisOrigAuth_Basic(t *testing.T) {
	node := "data.ibm_cis_orig_auth.test"
	resource.Test(t, resource.TestCase{
		PreCheck:  func() { acc.TestAccPreCheckCis(t) },
		Providers: acc.TestAccProviders,
		Steps: []resource.TestStep{
			{
				Config: testAccCheckCisOrigAuthsBasic1("test", acc.CisDomainStatic),
...
func testAccCheckCisOrigAuthsBasic1(id, CisDomainStatic string) string {
