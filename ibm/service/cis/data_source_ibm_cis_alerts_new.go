...
var (
	_ datasource.DataSourceWithConfigure = &CISAlertsDataSource{}
	_ datasource.DataSource              = &CISAlertsDataSource{}
)
...
func NewCISAlertsDataSource() datasource.DataSource {
	return &CISAlertsDataSource{}
}

func (d *CISAlertsDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_cis_alerts_new"
}

func (d *CISAlertsDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *CISAlertsDataSource) Schema(_ context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
