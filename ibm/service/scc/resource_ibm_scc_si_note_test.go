...
func TestAccIBMSccSiNoteCardNumeric(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckIBMSccSiNoteCardNumericBasic(acc.Scc_si_account, providerID, shortDescription, longDescription, kind, noteID),
...
func TestAccIBMSccSiNoteCardBreakdown(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckIBMSccSiNoteCardBreakdownBasic(acc.Scc_si_account, providerID, shortDescription, longDescription, kind, noteID),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckIBMSccSiNoteExists("ibm_scc_si_note.scc_si_note", conf),
					resource.TestCheckResourceAttr("ibm_scc_si_note.scc_si_note", "provider_id", providerID),
					resource.TestCheckResourceAttr("ibm_scc_si_note.scc_si_note", "short_description", shortDescription),
...
func TestAccIBMSccSiNoteCardTimeSeries(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckIBMSccSiNoteCardTimeSeriesBasic(acc.Scc_si_account, providerID, shortDescription, longDescription, kind, noteID),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckIBMSccSiNoteExists("ibm_scc_si_note.scc_si_note", conf),
					resource.TestCheckResourceAttr("ibm_scc_si_note.scc_si_note", "provider_id", providerID),
					resource.TestCheckResourceAttr("ibm_scc_si_note.scc_si_note", "short_description", shortDescription),
...
func TestAccIBMSccSiNoteBasic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckIBMSccSiNoteConfigBasic(acc.Scc_si_account, providerID, shortDescription, longDescription, kind, noteID),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckIBMSccSiNoteExists("ibm_scc_si_note.scc_si_note", conf),
					resource.TestCheckResourceAttr("ibm_scc_si_note.scc_si_note", "provider_id", providerID),
					resource.TestCheckResourceAttr("ibm_scc_si_note.scc_si_note", "short_description", shortDescription),
			...
			{
				Config: testAccCheckIBMSccSiNoteConfigBasic(acc.Scc_si_account, providerID, shortDescriptionUpdate, longDescriptionUpdate, kindUpdate, noteIDUpdate),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("ibm_scc_si_note.scc_si_note", "provider_id", providerID),
...
func TestAccIBMSccSiNoteAllArgs(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckIBMSccSiNoteConfig(acc.Scc_si_account, providerID, shortDescription, longDescription, kind, noteID, shared),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckIBMSccSiNoteExists("ibm_scc_si_note.scc_si_note", conf),
					resource.TestCheckResourceAttr("ibm_scc_si_note.scc_si_note", "provider_id", providerID),
					resource.TestCheckResourceAttr("ibm_scc_si_note.scc_si_note", "short_description", shortDescription),
			...
			{
				Config: testAccCheckIBMSccSiNoteConfig(acc.Scc_si_account, providerID, shortDescriptionUpdate, longDescriptionUpdate, kindUpdate, noteIDUpdate, sharedUpdate),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("ibm_scc_si_note.scc_si_note", "provider_id", providerID),
					resource.TestCheckResourceAttr("ibm_scc_si_note.scc_si_note", "short_description", shortDescriptionUpdate),
					resource.TestCheckResourceAttr("ibm_scc_si_note.scc_si_note", "long_description", longDescriptionUpdate),
...
func TestAccIBMSccSiNoteInvalid(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config:      testAccCheckIBMSccSiNoteConfigInvalid(acc.Scc_si_account, providerID, shortDescription, longDescription, kind, noteID),
...
func TestAccIBMSccSiNoteEmpty(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config:      testAccCheckIBMSccSiNoteConfigEmpty(acc.Scc_si_account, providerID, shortDescription, longDescription, kind, noteID),
				ExpectError: regexp.MustCompile("Invalid combination of arguments"),
			},
		},
	})
...
func testAccCheckIBMSccSiNoteExists(n string, obj findingsv1.APINote) resource.TestCheckFunc {
	...
	return func(s *terraform.State) error {
		...
		findingsClient, err := acc.TestAccProvider.Meta().(conns.ClientSession).FindingsV1()
		if err != nil {
			return err
		}
...
func testAccCheckIBMSccSiNoteDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		...
		if err == nil {
			...
			return fmt.Errorf("[ERROR] Error checking for scc_si_note (%s) has been destroyed: %s", rs.Primary.ID, err)
		}
	}
