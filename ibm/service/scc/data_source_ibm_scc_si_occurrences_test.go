...
func TestAccIBMSccSiOccurrencesDataSourceBasic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckIBMSccSiOccurrencesDataSourceConfigBasic(acc.Scc_si_account, apiOccurrenceProviderID, apiOccurrenceNoteID, apiOccurrenceKind, apiOccurrenceID),
...
func TestAccIBMSccSiOccurrencesDataSourceAllArgs(t *testing.T) {
	...
	apiNoteID := fmt.Sprintf("%s/providers/%s/notes/%s", acc.Scc_si_account, apiOccurrenceProviderID, apiOccurrenceNoteID)
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckIBMSccSiOccurrencesDataSourceConfig(acc.Scc_si_account, apiOccurrenceProviderID, apiOccurrenceNoteID, apiOccurrenceKind, apiOccurrenceID, apiOccurrenceResourceURL, apiOccurrenceRemediation, apiOccurrenceReplaceIfExists),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.ibm_scc_si_occurrences.scc_si_occurrences", "id"),
					resource.TestCheckResourceAttrSet("data.ibm_scc_si_occurrences.scc_si_occurrences", "provider_id"),
