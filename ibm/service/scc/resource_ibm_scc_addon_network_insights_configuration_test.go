...
func TestAccIBMSccAddonNetworkInsightsConfigurationBasic(t *testing.T) {
	var conf addonmanagerv1.NetworkInsightsStatusConfigOutput
	regionID := "us"
	status := "enable"
	regionIDUpdate := "us"
...
func testAccCheckIBMSccAddonNetworkInsightsConfigurationExists(n string, obj addonmanagerv1.NetworkInsightsStatusConfigOutput) resource.TestCheckFunc {
