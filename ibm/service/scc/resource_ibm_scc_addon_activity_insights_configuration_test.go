...
func TestAccIBMSccAddonActivityInsightsConfigurationBasic(t *testing.T) {
	var conf addonmanagerv1.AiEnableAddOnOutput
	regionID := "us"
	status := "enable"
	regionIDUpdate := "us"
...
func testAccCheckIBMSccAddonActivityInsightsConfigurationExists(n string, obj addonmanagerv1.AiEnableAddOnOutput) resource.TestCheckFunc {
