...
func TestAccIbmSmPrivateCertificateConfigurationIntermediateCABasic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIbmSmPrivateCertificateConfigurationIntermediateCAConfigBasic(),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckIbmSmPrivateCertificateConfigurationIntermediateCAExists("ibm_sm_private_certificate_configuration_intermediate_ca.sm_private_certificate_configuration_intermediate_ca", conf),
				),
			},
			resource.TestStep{
				ResourceName:            "ibm_sm_private_certificate_configuration_intermediate_ca.sm_private_certificate_configuration_intermediate_ca",
				ImportState:             true,
...
func testAccCheckIbmSmPrivateCertificateConfigurationIntermediateCAConfigBasic() string {
	return fmt.Sprintf(`
...
func testAccCheckIbmSmPrivateCertificateConfigurationIntermediateCAExists(n string, obj secretsmanagerv2.PrivateCertificateConfigurationIntermediateCA) resource.TestCheckFunc {
