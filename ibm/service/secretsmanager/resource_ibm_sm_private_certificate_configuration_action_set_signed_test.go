...
func TestAccIbmSmPrivateCertificateConfigurationActionSetSignedBasic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIbmSmPrivateCertificateConfigurationActionSetSignedConfigBasic(),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckIbmSmPrivateCertificateConfigurationActionSetSignedExists("ibm_sm_private_certificate_configuration_intermediate_ca.sm_private_certificate_configuration_intermediate_ca", conf),
				),
			},
		},
	})
...
func testAccCheckIbmSmPrivateCertificateConfigurationActionSetSignedConfigBasic() string {
	return fmt.Sprintf(`
...
func testAccCheckIbmSmPrivateCertificateConfigurationActionSetSignedExists(n string, obj secretsmanagerv2.PrivateCertificateConfigurationIntermediateCA) resource.TestCheckFunc {
