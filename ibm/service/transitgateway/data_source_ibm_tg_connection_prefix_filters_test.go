...
func testAccCheckIBMTransitGatewayDataConnectionPrefixFiltersSourceConfig(gatewayName, location, connectionName string) string {
	return fmt.Sprintf(`
	...
	data "ibm_tg_connection_prefix_filters" "ds_tg_prefix_filters" {
		gateway = ibm_tg_gateway.test_tg_gateway.id
		connection_id = ibm_tg_connection.test_tg_connection.connection_id
	}
