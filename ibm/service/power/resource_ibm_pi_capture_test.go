		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(captureRes, vars.Arg_CaptureName, name),
					resource.TestCheckResourceAttrSet(captureRes, vars.Attr_CaptureImageID),
				),
			},
		},
	})
...
func TestAccIBMPICaptureWithVolume(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckIBMPICaptureWithVolumeConfig(name, vars.HealthOk),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIBMPICaptureExists(captureRes),
					resource.TestCheckResourceAttr(captureRes, vars.Arg_CaptureName, name),
					resource.TestCheckResourceAttrSet(captureRes, vars.Attr_CaptureImageID),
