...
func TestResourceIbmRecoveryRecoverPhysicalParamsToMap(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryRecoverPhysicalParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryCommonRecoverObjectSnapshotParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmRecoveryCommonRecoverObjectSnapshotParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryCommonRecoverObjectSnapshotParamsObjectInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmRecoveryCommonRecoverObjectSnapshotParamsObjectInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoverySharepointObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmRecoverySharepointObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryObjectSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmRecoveryObjectSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryObjectTypeVCenterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmRecoveryObjectTypeVCenterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryObjectTypeWindowsClusterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmRecoveryObjectTypeWindowsClusterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryCommonRecoverObjectSnapshotParamsArchivalTargetInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmRecoveryCommonRecoverObjectSnapshotParamsArchivalTargetInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryArchivalTargetTierInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmRecoveryArchivalTargetTierInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryAWSTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmRecoveryAWSTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryAWSTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmRecoveryAWSTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryAzureTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		azureTierModel := make(map[string]interface{})
		azureTierModel["move_after_unit"] = "Days"
		azureTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmRecoveryAzureTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryAzureTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmRecoveryAzureTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryGoogleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		googleTierModel := make(map[string]interface{})
		googleTierModel["move_after_unit"] = "Days"
		googleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmRecoveryGoogleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryGoogleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmRecoveryGoogleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryOracleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		oracleTierModel := make(map[string]interface{})
		oracleTierModel["move_after_unit"] = "Days"
		oracleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmRecoveryOracleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryOracleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmRecoveryOracleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryRecoverPhysicalParamsRecoverVolumeParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalTargetParamsForRecoverVolumeMountTargetModel := make(map[string]interface{})
		physicalTargetParamsForRecoverVolumeMountTargetModel["id"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmRecoveryRecoverPhysicalParamsRecoverVolumeParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryRecoverPhysicalVolumeParamsPhysicalTargetParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalTargetParamsForRecoverVolumeMountTargetModel := make(map[string]interface{})
		physicalTargetParamsForRecoverVolumeMountTargetModel["id"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmRecoveryRecoverPhysicalVolumeParamsPhysicalTargetParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryPhysicalTargetParamsForRecoverVolumeMountTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmRecoveryPhysicalTargetParamsForRecoverVolumeMountTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryRecoverVolumeMappingToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmRecoveryRecoverVolumeMappingToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryPhysicalTargetParamsForRecoverVolumeVlanConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(38)
	...
	result, err := backuprecovery.ResourceIbmRecoveryPhysicalTargetParamsForRecoverVolumeVlanConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryRecoverPhysicalParamsMountVolumeParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel := make(map[string]interface{})
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["username"] = "testString"
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["password"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmRecoveryRecoverPhysicalParamsMountVolumeParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMountPhysicalVolumeParamsPhysicalTargetParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel := make(map[string]interface{})
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["username"] = "testString"
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["password"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmRecoveryMountPhysicalVolumeParamsPhysicalTargetParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryPhysicalTargetParamsForMountVolumeOriginalTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel := make(map[string]interface{})
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["username"] = "testString"
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["password"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmRecoveryPhysicalTargetParamsForMountVolumeOriginalTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryPhysicalMountVolumesOriginalTargetConfigServerCredentialsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmRecoveryPhysicalMountVolumesOriginalTargetConfigServerCredentialsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryPhysicalTargetParamsForMountVolumeNewTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		recoverTargetModel := make(map[string]interface{})
		recoverTargetModel["id"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmRecoveryPhysicalTargetParamsForMountVolumeNewTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryRecoverTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmRecoveryRecoverTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryPhysicalMountVolumesNewTargetConfigServerCredentialsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["username"] = "testString"
		model["password"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmRecoveryPhysicalMountVolumesNewTargetConfigServerCredentialsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMountedVolumeMappingToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmRecoveryMountedVolumeMappingToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryPhysicalTargetParamsForMountVolumeVlanConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(38)
		model["disable_vlan"] = true
	...
	result, err := backuprecovery.ResourceIbmRecoveryPhysicalTargetParamsForMountVolumeVlanConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryRecoverPhysicalParamsRecoverFileAndFolderParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		commonRecoverFileAndFolderInfoModel := make(map[string]interface{})
		commonRecoverFileAndFolderInfoModel["absolute_path"] = "testString"
		commonRecoverFileAndFolderInfoModel["is_directory"] = true
	...
	result, err := backuprecovery.ResourceIbmRecoveryRecoverPhysicalParamsRecoverFileAndFolderParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryCommonRecoverFileAndFolderInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmRecoveryCommonRecoverFileAndFolderInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryRecoverPhysicalFileAndFolderParamsPhysicalTargetParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalTargetParamsForRecoverFileAndFolderRecoverTargetModel := make(map[string]interface{})
		physicalTargetParamsForRecoverFileAndFolderRecoverTargetModel["id"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmRecoveryRecoverPhysicalFileAndFolderParamsPhysicalTargetParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryPhysicalTargetParamsForRecoverFileAndFolderRecoverTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmRecoveryPhysicalTargetParamsForRecoverFileAndFolderRecoverTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryPhysicalTargetParamsForRecoverFileAndFolderVlanConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(38)
		model["disable_vlan"] = true
	...
	result, err := backuprecovery.ResourceIbmRecoveryPhysicalTargetParamsForRecoverFileAndFolderVlanConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryRecoverPhysicalParamsDownloadFileAndFolderParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		commonRecoverFileAndFolderInfoModel := make(map[string]interface{})
		commonRecoverFileAndFolderInfoModel["absolute_path"] = "testString"
		commonRecoverFileAndFolderInfoModel["is_directory"] = true
	...
	result, err := backuprecovery.ResourceIbmRecoveryRecoverPhysicalParamsDownloadFileAndFolderParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryRecoverPhysicalParamsSystemRecoveryParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmRecoveryRecoverPhysicalParamsSystemRecoveryParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryRecoverSqlParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmRecoveryRecoverSqlParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryRecoverSqlAppParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmRecoveryRecoverSqlAppParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryAAGInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmRecoveryAAGInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryHostInformationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = "testString"
		model["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmRecoveryHostInformationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoverySqlTargetParamsForRecoverSqlAppToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		multiStageRestoreOptionsModel := make(map[string]interface{})
		multiStageRestoreOptionsModel["enable_auto_sync"] = true
		multiStageRestoreOptionsModel["enable_multi_stage_restore"] = true
	...
	result, err := backuprecovery.ResourceIbmRecoverySqlTargetParamsForRecoverSqlAppToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryRecoverSqlAppNewSourceConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		multiStageRestoreOptionsModel := make(map[string]interface{})
		multiStageRestoreOptionsModel["enable_auto_sync"] = true
		multiStageRestoreOptionsModel["enable_multi_stage_restore"] = true
	...
	result, err := backuprecovery.ResourceIbmRecoveryRecoverSqlAppNewSourceConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMultiStageRestoreOptionsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmRecoveryMultiStageRestoreOptionsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryFilenamePatternToDirectoryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmRecoveryFilenamePatternToDirectoryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryRecoveryObjectIdentifierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmRecoveryRecoveryObjectIdentifierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryRecoverSqlAppOriginalSourceConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		multiStageRestoreOptionsModel := make(map[string]interface{})
		multiStageRestoreOptionsModel["enable_auto_sync"] = true
		multiStageRestoreOptionsModel["enable_multi_stage_restore"] = true
	...
	result, err := backuprecovery.ResourceIbmRecoveryRecoverSqlAppOriginalSourceConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryRecoveryVlanConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(38)
		model["disable_vlan"] = true
	...
	result, err := backuprecovery.ResourceIbmRecoveryRecoveryVlanConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryTenantToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryTenantToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryExternalVendorTenantMetadataToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmRecoveryExternalVendorTenantMetadataToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryIbmTenantMetadataParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmRecoveryIbmTenantMetadataParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryExternalVendorCustomPropertiesToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmRecoveryExternalVendorCustomPropertiesToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryTenantNetworkToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmRecoveryTenantNetworkToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryCreationInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmRecoveryCreationInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryRetrieveArchiveTaskToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmRecoveryRetrieveArchiveTaskToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToRecoverPhysicalParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToRecoverPhysicalParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToCommonRecoverObjectSnapshotParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToCommonRecoverObjectSnapshotParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToCommonRecoverObjectSnapshotParamsObjectInfo(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToCommonRecoverObjectSnapshotParamsObjectInfo(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToSharepointObjectParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToSharepointObjectParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToObjectSummary(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToObjectSummary(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToObjectTypeVCenterParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToObjectTypeVCenterParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToObjectTypeWindowsClusterParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToObjectTypeWindowsClusterParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToCommonRecoverObjectSnapshotParamsArchivalTargetInfo(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToCommonRecoverObjectSnapshotParamsArchivalTargetInfo(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToArchivalTargetTierInfo(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToArchivalTargetTierInfo(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToAWSTiers(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToAWSTiers(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToAWSTier(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToAWSTier(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToAzureTiers(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToAzureTiers(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToAzureTier(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToAzureTier(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToGoogleTiers(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToGoogleTiers(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToGoogleTier(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToGoogleTier(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToOracleTiers(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToOracleTiers(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToOracleTier(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToOracleTier(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToRecoverPhysicalParamsRecoverVolumeParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToRecoverPhysicalParamsRecoverVolumeParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToRecoverPhysicalVolumeParamsPhysicalTargetParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToRecoverPhysicalVolumeParamsPhysicalTargetParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToPhysicalTargetParamsForRecoverVolumeMountTarget(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToPhysicalTargetParamsForRecoverVolumeMountTarget(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToRecoverVolumeMapping(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToRecoverVolumeMapping(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToPhysicalTargetParamsForRecoverVolumeVlanConfig(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToPhysicalTargetParamsForRecoverVolumeVlanConfig(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToRecoverPhysicalParamsMountVolumeParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToRecoverPhysicalParamsMountVolumeParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToMountPhysicalVolumeParamsPhysicalTargetParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToMountPhysicalVolumeParamsPhysicalTargetParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToPhysicalTargetParamsForMountVolumeOriginalTargetConfig(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToPhysicalTargetParamsForMountVolumeOriginalTargetConfig(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToPhysicalMountVolumesOriginalTargetConfigServerCredentials(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToPhysicalMountVolumesOriginalTargetConfigServerCredentials(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToPhysicalTargetParamsForMountVolumeNewTargetConfig(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToPhysicalTargetParamsForMountVolumeNewTargetConfig(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToRecoverTarget(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToRecoverTarget(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToPhysicalMountVolumesNewTargetConfigServerCredentials(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToPhysicalMountVolumesNewTargetConfigServerCredentials(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToMountedVolumeMapping(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToMountedVolumeMapping(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToPhysicalTargetParamsForMountVolumeVlanConfig(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToPhysicalTargetParamsForMountVolumeVlanConfig(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToRecoverPhysicalParamsRecoverFileAndFolderParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToRecoverPhysicalParamsRecoverFileAndFolderParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToCommonRecoverFileAndFolderInfo(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToCommonRecoverFileAndFolderInfo(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToRecoverPhysicalFileAndFolderParamsPhysicalTargetParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToRecoverPhysicalFileAndFolderParamsPhysicalTargetParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToPhysicalTargetParamsForRecoverFileAndFolderRecoverTarget(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToPhysicalTargetParamsForRecoverFileAndFolderRecoverTarget(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToPhysicalTargetParamsForRecoverFileAndFolderVlanConfig(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToPhysicalTargetParamsForRecoverFileAndFolderVlanConfig(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToRecoverPhysicalParamsDownloadFileAndFolderParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToRecoverPhysicalParamsDownloadFileAndFolderParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToRecoverPhysicalParamsSystemRecoveryParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToRecoverPhysicalParamsSystemRecoveryParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToRecoverSqlParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToRecoverSqlParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToRecoverSqlAppParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToRecoverSqlAppParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToAAGInfo(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToAAGInfo(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToHostInformation(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToHostInformation(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToSqlTargetParamsForRecoverSqlApp(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToSqlTargetParamsForRecoverSqlApp(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToRecoverSqlAppNewSourceConfig(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToRecoverSqlAppNewSourceConfig(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToMultiStageRestoreOptions(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToMultiStageRestoreOptions(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToFilenamePatternToDirectory(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToFilenamePatternToDirectory(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToRecoveryObjectIdentifier(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToRecoveryObjectIdentifier(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToRecoverSqlAppOriginalSourceConfig(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToRecoverSqlAppOriginalSourceConfig(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmRecoveryMapToRecoveryVlanConfig(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmRecoveryMapToRecoveryVlanConfig(model)
	assert.Nil(t, err)
	checkResult(result)
}
