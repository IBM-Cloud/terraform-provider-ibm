...
func TestAccIbmBackupRecoveryManagerGetComponentPreviewDataSourceBasic(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:  func() { acc.TestAccPreCheck(t) },
		Providers: acc.TestAccProviders,
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIbmBackupRecoveryManagerGetComponentPreviewDataSourceConfigBasic(),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.ibm_backup_recovery_manager_get_component_preview.backup_recovery_manager_get_component_preview_instance", "id"),
					resource.TestCheckResourceAttrSet("data.ibm_backup_recovery_manager_get_component_preview.backup_recovery_manager_get_component_preview_instance", "backup_recovery_manager_get_component_preview_id"),
				),
			},
		},
	})
...
func testAccCheckIbmBackupRecoveryManagerGetComponentPreviewDataSourceConfigBasic() string {
	return fmt.Sprintf(`
		data "ibm_backup_recovery_manager_get_component_preview" "backup_recovery_manager_get_component_preview_instance" {
			id = "id"
			...
			sort = [ { attribute="attribute", desc=true } ]
			timezone = "timezone"
		}
	`)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentPreviewComponentToMap(t *testing.T) {
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentPreviewComponentToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentPreviewAttributeAggregationsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		aggregatedAttributesParamsModel := make(map[string]interface{})
		aggregatedAttributesParamsModel["aggregation_type"] = "sum"
		aggregatedAttributesParamsModel["attribute"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentPreviewAttributeAggregationsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentPreviewAggregatedAttributesParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentPreviewAggregatedAttributesParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentPreviewCustomConfigParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		xlsxAttributeCustomConfigParamsModel := make(map[string]interface{})
		xlsxAttributeCustomConfigParamsModel["attribute_name"] = "testString"
		xlsxAttributeCustomConfigParamsModel["custom_label"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentPreviewCustomConfigParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentPreviewXlsxCustomConfigParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		xlsxAttributeCustomConfigParamsModel := make(map[string]interface{})
		xlsxAttributeCustomConfigParamsModel["attribute_name"] = "testString"
		xlsxAttributeCustomConfigParamsModel["custom_label"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentPreviewXlsxCustomConfigParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentPreviewXlsxAttributeCustomConfigParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentPreviewXlsxAttributeCustomConfigParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentPreviewAttributeFilterToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		inFilterParamsModel := make(map[string]interface{})
		inFilterParamsModel["attribute_data_type"] = "Bool"
		inFilterParamsModel["attribute_labels"] = []string{"testString"}
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentPreviewAttributeFilterToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentPreviewInFilterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentPreviewInFilterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentPreviewRangeFilterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentPreviewRangeFilterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentPreviewSystemsFilterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentPreviewSystemsFilterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentPreviewTimeRangeFilterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentPreviewTimeRangeFilterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentPreviewLimitParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["from"] = int(38)
		model["size"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentPreviewLimitParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentPreviewAttributeSortToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["attribute"] = "testString"
		model["desc"] = true
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentPreviewAttributeSortToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
