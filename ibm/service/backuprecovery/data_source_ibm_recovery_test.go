		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.ibm_recovery.recovery_instance", "id"),
					resource.TestCheckResourceAttrSet("data.ibm_recovery.recovery_instance", "recovery_id"),
					resource.TestCheckResourceAttrSet("data.ibm_recovery.recovery_instance", "include_tenants"),
					...
					resource.TestCheckResourceAttrSet("data.ibm_recovery.recovery_instance", "oracle_params.#"),
				),
			},
		},
	})
