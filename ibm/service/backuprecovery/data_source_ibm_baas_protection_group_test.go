...
func TestDataSourceIbmBaasProtectionGroupTimeOfDayToMap(t *testing.T) {
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupTimeOfDayToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupProtectionGroupAlertingPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupProtectionGroupAlertingPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupAlertTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupAlertTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupSlaRuleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupSlaRuleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupProtectionGroupRunToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupProtectionGroupRunToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupClusterIdentifierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupClusterIdentifierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupObjectRunResultToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupObjectRunResultToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupObjectSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupObjectSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupSharepointObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupSharepointObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupObjectTypeVCenterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupObjectTypeVCenterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupObjectTypeWindowsClusterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupObjectTypeWindowsClusterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupBackupRunToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		backupDataStatsModel := make(map[string]interface{})
		backupDataStatsModel["logical_size_bytes"] = int(26)
		backupDataStatsModel["bytes_written"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupBackupRunToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupSnapshotInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		backupDataStatsModel := make(map[string]interface{})
		backupDataStatsModel["logical_size_bytes"] = int(26)
		backupDataStatsModel["bytes_written"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupSnapshotInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupBackupDataStatsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["logical_size_bytes"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupBackupDataStatsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupDataLockConstraintsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupDataLockConstraintsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupBackupAttemptToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		backupDataStatsModel := make(map[string]interface{})
		backupDataStatsModel["logical_size_bytes"] = int(26)
		backupDataStatsModel["bytes_written"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupBackupAttemptToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupReplicationRunToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTargetConfigModel := make(map[string]interface{})
		awsTargetConfigModel["region"] = int(26)
		awsTargetConfigModel["source_id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupReplicationRunToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupReplicationTargetResultToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTargetConfigModel := make(map[string]interface{})
		awsTargetConfigModel["region"] = int(26)
		awsTargetConfigModel["source_id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupReplicationTargetResultToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupAWSTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "testString"
		model["region"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupAWSTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupAzureTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupAzureTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupReplicationDataStatsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["logical_size_bytes"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupReplicationDataStatsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupArchivalRunToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupArchivalRunToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupArchivalTargetResultToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupArchivalTargetResultToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupArchivalTargetTierInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupArchivalTargetTierInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupAWSTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupAWSTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupAWSTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupAWSTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupAzureTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		azureTierModel := make(map[string]interface{})
		azureTierModel["move_after_unit"] = "Days"
		azureTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupAzureTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupAzureTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupAzureTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupGoogleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		googleTierModel := make(map[string]interface{})
		googleTierModel["move_after_unit"] = "Days"
		googleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupGoogleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupGoogleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupGoogleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupOracleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		oracleTierModel := make(map[string]interface{})
		oracleTierModel["move_after_unit"] = "Days"
		oracleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupOracleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupOracleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupOracleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupArchivalDataStatsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["logical_size_bytes"] = int(26)
		model["bytes_read"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupArchivalDataStatsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupWormPropertiesToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupWormPropertiesToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupCloudSpinRunToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		customTagParamsModel := make(map[string]interface{})
		customTagParamsModel["key"] = "testString"
		customTagParamsModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupCloudSpinRunToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupCloudSpinTargetResultToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		customTagParamsModel := make(map[string]interface{})
		customTagParamsModel["key"] = "testString"
		customTagParamsModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupCloudSpinTargetResultToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupAwsCloudSpinParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		customTagParamsModel := make(map[string]interface{})
		customTagParamsModel["key"] = "testString"
		customTagParamsModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupAwsCloudSpinParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupCustomTagParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupCustomTagParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupAzureCloudSpinParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupAzureCloudSpinParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupCloudSpinDataStatsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["physical_bytes_transferred"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupCloudSpinDataStatsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupBackupRunSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		backupDataStatsModel := make(map[string]interface{})
		backupDataStatsModel["logical_size_bytes"] = int(26)
		backupDataStatsModel["bytes_written"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupBackupRunSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupReplicationRunSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTargetConfigModel := make(map[string]interface{})
		awsTargetConfigModel["region"] = int(26)
		awsTargetConfigModel["source_id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupReplicationRunSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupArchivalRunSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupArchivalRunSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupCloudSpinRunSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		customTagParamsModel := make(map[string]interface{})
		customTagParamsModel["key"] = "testString"
		customTagParamsModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupCloudSpinRunSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupTenantToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupTenantToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupExternalVendorTenantMetadataToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupExternalVendorTenantMetadataToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupIbmTenantMetadataParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupIbmTenantMetadataParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupExternalVendorCustomPropertiesToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["key"] = "testString"
		model["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupExternalVendorCustomPropertiesToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupTenantNetworkToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupTenantNetworkToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupMissingEntityParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupMissingEntityParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupKeyValuePairToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["key"] = "testString"
		model["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupKeyValuePairToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupPhysicalProtectionGroupParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupPhysicalProtectionGroupParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupPhysicalVolumeProtectionGroupParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalVolumeProtectionGroupObjectParamsModel := make(map[string]interface{})
		physicalVolumeProtectionGroupObjectParamsModel["id"] = int(26)
		physicalVolumeProtectionGroupObjectParamsModel["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupPhysicalVolumeProtectionGroupParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupPhysicalVolumeProtectionGroupObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupPhysicalVolumeProtectionGroupObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupIndexingPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupIndexingPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupPrePostScriptParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		commonPreBackupScriptParamsModel := make(map[string]interface{})
		commonPreBackupScriptParamsModel["path"] = "testString"
		commonPreBackupScriptParamsModel["params"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupPrePostScriptParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupCommonPreBackupScriptParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupCommonPreBackupScriptParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupCommonPostBackupScriptParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["path"] = "testString"
		model["params"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupCommonPostBackupScriptParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupPhysicalFileProtectionGroupParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalFileBackupPathParamsModel := make(map[string]interface{})
		physicalFileBackupPathParamsModel["included_path"] = "testString"
		physicalFileBackupPathParamsModel["excluded_paths"] = []string{"testString"}
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupPhysicalFileProtectionGroupParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupPhysicalFileProtectionGroupObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalFileBackupPathParamsModel := make(map[string]interface{})
		physicalFileBackupPathParamsModel["included_path"] = "testString"
		physicalFileBackupPathParamsModel["excluded_paths"] = []string{"testString"}
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupPhysicalFileProtectionGroupObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupPhysicalFileBackupPathParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupPhysicalFileBackupPathParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupCancellationTimeoutParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupCancellationTimeoutParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupMSSQLProtectionGroupParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupMSSQLProtectionGroupParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupMSSQLFileProtectionGroupParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		advancedSettingsModel := make(map[string]interface{})
		advancedSettingsModel["cloned_db_backup_status"] = "kError"
		advancedSettingsModel["db_backup_if_not_online_status"] = "kError"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupMSSQLFileProtectionGroupParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupAdvancedSettingsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupAdvancedSettingsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupFilterToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupFilterToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupMSSQLFileProtectionGroupHostParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupMSSQLFileProtectionGroupHostParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupMSSQLFileProtectionGroupObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupMSSQLFileProtectionGroupObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupMSSQLNativeProtectionGroupParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		advancedSettingsModel := make(map[string]interface{})
		advancedSettingsModel["cloned_db_backup_status"] = "kError"
		advancedSettingsModel["db_backup_if_not_online_status"] = "kError"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupMSSQLNativeProtectionGroupParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupMSSQLNativeProtectionGroupObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupMSSQLNativeProtectionGroupObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupMSSQLVolumeProtectionGroupParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		advancedSettingsModel := make(map[string]interface{})
		advancedSettingsModel["cloned_db_backup_status"] = "kError"
		advancedSettingsModel["db_backup_if_not_online_status"] = "kError"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupMSSQLVolumeProtectionGroupParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupMSSQLVolumeProtectionGroupHostParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["enable_system_backup"] = true
		model["host_id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupMSSQLVolumeProtectionGroupHostParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasProtectionGroupMSSQLVolumeProtectionGroupObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasProtectionGroupMSSQLVolumeProtectionGroupObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
