...
func TestDataSourceIbmBaasRecoveriesRecoveryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		...
		creationInfoModel := make(map[string]interface{})
		creationInfoModel["user_name"] = "testString"

		retrieveArchiveTaskModel := make(map[string]interface{})
		retrieveArchiveTaskModel["task_uid"] = "testString"
		retrieveArchiveTaskModel["uptier_expiry_times"] = []int64{int64(26)}
		...
		recoverPhysicalParamsModel := make(map[string]interface{})
		recoverPhysicalParamsModel["objects"] = []map[string]interface{}{commonRecoverObjectSnapshotParamsModel}
		recoverPhysicalParamsModel["recovery_action"] = "RecoverPhysicalVolumes"
		recoverPhysicalParamsModel["recover_volume_params"] = []map[string]interface{}{recoverPhysicalParamsRecoverVolumeParamsModel}
		recoverPhysicalParamsModel["mount_volume_params"] = []map[string]interface{}{recoverPhysicalParamsMountVolumeParamsModel}
		recoverPhysicalParamsModel["recover_file_and_folder_params"] = []map[string]interface{}{recoverPhysicalParamsRecoverFileAndFolderParamsModel}
		recoverPhysicalParamsModel["download_file_and_folder_params"] = []map[string]interface{}{recoverPhysicalParamsDownloadFileAndFolderParamsModel}
		recoverPhysicalParamsModel["system_recovery_params"] = []map[string]interface{}{recoverPhysicalParamsSystemRecoveryParamsModel}
		...
		recoverSqlParamsModel := make(map[string]interface{})
		recoverSqlParamsModel["recover_app_params"] = []map[string]interface{}{recoverSqlAppParamsModel}
		recoverSqlParamsModel["recovery_action"] = "RecoverApps"
		recoverSqlParamsModel["vlan_config"] = []map[string]interface{}{recoveryVlanConfigModel}
		...
		model["snapshot_environment"] = "kPhysical"
		model["recovery_action"] = "RecoverVMs"
		model["permissions"] = []map[string]interface{}{tenantModel}
		model["creation_info"] = []map[string]interface{}{creationInfoModel}
		model["can_tear_down"] = true
		model["tear_down_status"] = "DestroyScheduled"
		model["tear_down_message"] = "testString"
		model["messages"] = []string{"testString"}
		model["is_parent_recovery"] = true
		model["parent_recovery_id"] = "testString"
		model["retrieve_archive_tasks"] = []map[string]interface{}{retrieveArchiveTaskModel}
		model["is_multi_stage_restore"] = true
		model["physical_params"] = []map[string]interface{}{recoverPhysicalParamsModel}
		model["mssql_params"] = []map[string]interface{}{recoverSqlParamsModel}
	...
	creationInfoModel := new(backuprecoveryv1.CreationInfo)
	creationInfoModel.UserName = core.StringPtr("testString")

	retrieveArchiveTaskModel := new(backuprecoveryv1.RetrieveArchiveTask)
	retrieveArchiveTaskModel.TaskUid = core.StringPtr("testString")
	retrieveArchiveTaskModel.UptierExpiryTimes = []int64{int64(26)}
	...
	model := new(backuprecoveryv1.Recovery)
	...
	model.SnapshotEnvironment = core.StringPtr("kPhysical")
	model.RecoveryAction = core.StringPtr("RecoverVMs")
	model.Permissions = []backuprecoveryv1.Tenant{*tenantModel}
	model.CreationInfo = creationInfoModel
	model.CanTearDown = core.BoolPtr(true)
	model.TearDownStatus = core.StringPtr("DestroyScheduled")
	model.TearDownMessage = core.StringPtr("testString")
	model.Messages = []string{"testString"}
	model.IsParentRecovery = core.BoolPtr(true)
	model.ParentRecoveryID = core.StringPtr("testString")
	model.RetrieveArchiveTasks = []backuprecoveryv1.RetrieveArchiveTask{*retrieveArchiveTaskModel}
	model.IsMultiStageRestore = core.BoolPtr(true)
	model.PhysicalParams = recoverPhysicalParamsModel
	model.MssqlParams = recoverSqlParamsModel

	result, err := backuprecovery.DataSourceIbmBaasRecoveriesRecoveryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesTenantToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesTenantToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesExternalVendorTenantMetadataToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesExternalVendorTenantMetadataToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesIbmTenantMetadataParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesIbmTenantMetadataParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesExternalVendorCustomPropertiesToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesExternalVendorCustomPropertiesToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesTenantNetworkToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesTenantNetworkToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesCreationInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesCreationInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesRetrieveArchiveTaskToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesRetrieveArchiveTaskToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesRecoverPhysicalParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesRecoverPhysicalParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesCommonRecoverObjectSnapshotParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesCommonRecoverObjectSnapshotParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesCommonRecoverObjectSnapshotParamsObjectInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesCommonRecoverObjectSnapshotParamsObjectInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesSharepointObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesSharepointObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesObjectSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesObjectSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesObjectTypeVCenterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesObjectTypeVCenterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesObjectTypeWindowsClusterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesObjectTypeWindowsClusterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesCommonRecoverObjectSnapshotParamsArchivalTargetInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesCommonRecoverObjectSnapshotParamsArchivalTargetInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesArchivalTargetTierInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesArchivalTargetTierInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesAWSTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesAWSTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesAWSTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesAWSTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesAzureTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		azureTierModel := make(map[string]interface{})
		azureTierModel["move_after_unit"] = "Days"
		azureTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesAzureTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesAzureTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesAzureTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesGoogleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		googleTierModel := make(map[string]interface{})
		googleTierModel["move_after_unit"] = "Days"
		googleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesGoogleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesGoogleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesGoogleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesOracleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		oracleTierModel := make(map[string]interface{})
		oracleTierModel["move_after_unit"] = "Days"
		oracleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesOracleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesOracleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesOracleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesRecoverPhysicalParamsRecoverVolumeParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalTargetParamsForRecoverVolumeMountTargetModel := make(map[string]interface{})
		physicalTargetParamsForRecoverVolumeMountTargetModel["id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesRecoverPhysicalParamsRecoverVolumeParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesRecoverPhysicalVolumeParamsPhysicalTargetParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalTargetParamsForRecoverVolumeMountTargetModel := make(map[string]interface{})
		physicalTargetParamsForRecoverVolumeMountTargetModel["id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesRecoverPhysicalVolumeParamsPhysicalTargetParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesPhysicalTargetParamsForRecoverVolumeMountTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesPhysicalTargetParamsForRecoverVolumeMountTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesRecoverVolumeMappingToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesRecoverVolumeMappingToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesPhysicalTargetParamsForRecoverVolumeVlanConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(38)
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesPhysicalTargetParamsForRecoverVolumeVlanConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesRecoverPhysicalParamsMountVolumeParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel := make(map[string]interface{})
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["username"] = "testString"
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["password"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesRecoverPhysicalParamsMountVolumeParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesMountPhysicalVolumeParamsPhysicalTargetParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel := make(map[string]interface{})
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["username"] = "testString"
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["password"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesMountPhysicalVolumeParamsPhysicalTargetParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesPhysicalTargetParamsForMountVolumeOriginalTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel := make(map[string]interface{})
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["username"] = "testString"
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["password"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesPhysicalTargetParamsForMountVolumeOriginalTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesPhysicalMountVolumesOriginalTargetConfigServerCredentialsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesPhysicalMountVolumesOriginalTargetConfigServerCredentialsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesPhysicalTargetParamsForMountVolumeNewTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		recoverTargetModel := make(map[string]interface{})
		recoverTargetModel["id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesPhysicalTargetParamsForMountVolumeNewTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesRecoverTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesRecoverTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesPhysicalMountVolumesNewTargetConfigServerCredentialsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["username"] = "testString"
		model["password"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesPhysicalMountVolumesNewTargetConfigServerCredentialsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesMountedVolumeMappingToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesMountedVolumeMappingToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesPhysicalTargetParamsForMountVolumeVlanConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(38)
		model["disable_vlan"] = true
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesPhysicalTargetParamsForMountVolumeVlanConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesRecoverPhysicalParamsRecoverFileAndFolderParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		commonRecoverFileAndFolderInfoModel := make(map[string]interface{})
		commonRecoverFileAndFolderInfoModel["absolute_path"] = "testString"
		commonRecoverFileAndFolderInfoModel["is_directory"] = true
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesRecoverPhysicalParamsRecoverFileAndFolderParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesCommonRecoverFileAndFolderInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesCommonRecoverFileAndFolderInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesRecoverPhysicalFileAndFolderParamsPhysicalTargetParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalTargetParamsForRecoverFileAndFolderRecoverTargetModel := make(map[string]interface{})
		physicalTargetParamsForRecoverFileAndFolderRecoverTargetModel["id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesRecoverPhysicalFileAndFolderParamsPhysicalTargetParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesPhysicalTargetParamsForRecoverFileAndFolderRecoverTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesPhysicalTargetParamsForRecoverFileAndFolderRecoverTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesPhysicalTargetParamsForRecoverFileAndFolderVlanConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(38)
		model["disable_vlan"] = true
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesPhysicalTargetParamsForRecoverFileAndFolderVlanConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesRecoverPhysicalParamsDownloadFileAndFolderParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		commonRecoverFileAndFolderInfoModel := make(map[string]interface{})
		commonRecoverFileAndFolderInfoModel["absolute_path"] = "testString"
		commonRecoverFileAndFolderInfoModel["is_directory"] = true
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesRecoverPhysicalParamsDownloadFileAndFolderParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesRecoverPhysicalParamsSystemRecoveryParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesRecoverPhysicalParamsSystemRecoveryParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesRecoverSqlParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesRecoverSqlParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesRecoverSqlAppParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesRecoverSqlAppParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesAAGInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesAAGInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesHostInformationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = "testString"
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesHostInformationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesSqlTargetParamsForRecoverSqlAppToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		multiStageRestoreOptionsModel := make(map[string]interface{})
		multiStageRestoreOptionsModel["enable_auto_sync"] = true
		multiStageRestoreOptionsModel["enable_multi_stage_restore"] = true
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesSqlTargetParamsForRecoverSqlAppToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesRecoverSqlAppNewSourceConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		multiStageRestoreOptionsModel := make(map[string]interface{})
		multiStageRestoreOptionsModel["enable_auto_sync"] = true
		multiStageRestoreOptionsModel["enable_multi_stage_restore"] = true
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesRecoverSqlAppNewSourceConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesMultiStageRestoreOptionsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesMultiStageRestoreOptionsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesFilenamePatternToDirectoryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesFilenamePatternToDirectoryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesRecoveryObjectIdentifierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesRecoveryObjectIdentifierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesRecoverSqlAppOriginalSourceConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		multiStageRestoreOptionsModel := make(map[string]interface{})
		multiStageRestoreOptionsModel["enable_auto_sync"] = true
		multiStageRestoreOptionsModel["enable_multi_stage_restore"] = true
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesRecoverSqlAppOriginalSourceConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBaasRecoveriesRecoveryVlanConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(38)
		model["disable_vlan"] = true
	...
	result, err := backuprecovery.DataSourceIbmBaasRecoveriesRecoveryVlanConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
