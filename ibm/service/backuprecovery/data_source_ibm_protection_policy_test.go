...
func TestDataSourceIbmProtectionPolicyBackupPolicyToMap(t *testing.T) {
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyBackupPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyRegularBackupPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		minuteScheduleModel := make(map[string]interface{})
		minuteScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyRegularBackupPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyIncrementalBackupPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		minuteScheduleModel := make(map[string]interface{})
		minuteScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyIncrementalBackupPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyIncrementalScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		minuteScheduleModel := make(map[string]interface{})
		minuteScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyIncrementalScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyMinuteScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyMinuteScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyHourScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyHourScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyDayScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyDayScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyWeekScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyWeekScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyMonthScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["day_of_week"] = []string{"Sunday"}
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyMonthScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyYearScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyYearScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyFullBackupPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dayScheduleModel := make(map[string]interface{})
		dayScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyFullBackupPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyFullScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dayScheduleModel := make(map[string]interface{})
		dayScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyFullScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyFullScheduleAndRetentionToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dayScheduleModel := make(map[string]interface{})
		dayScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyFullScheduleAndRetentionToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyRetentionToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dataLockConfigModel := make(map[string]interface{})
		dataLockConfigModel["mode"] = "Compliance"
		dataLockConfigModel["unit"] = "Days"
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyRetentionToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyDataLockConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyDataLockConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyPrimaryBackupTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyPrimaryBackupTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyPrimaryArchivalTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyPrimaryArchivalTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyTierLevelSettingsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyTierLevelSettingsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyAWSTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyAWSTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyAWSTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyAWSTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyAzureTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		azureTierModel := make(map[string]interface{})
		azureTierModel["move_after_unit"] = "Days"
		azureTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyAzureTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyAzureTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyAzureTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyGoogleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		googleTierModel := make(map[string]interface{})
		googleTierModel["move_after_unit"] = "Days"
		googleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyGoogleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyGoogleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyGoogleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyOracleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		oracleTierModel := make(map[string]interface{})
		oracleTierModel["move_after_unit"] = "Days"
		oracleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyOracleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyOracleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyOracleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyLogBackupPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		minuteScheduleModel := make(map[string]interface{})
		minuteScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyLogBackupPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyLogScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		minuteScheduleModel := make(map[string]interface{})
		minuteScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyLogScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyBmrBackupPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dayScheduleModel := make(map[string]interface{})
		dayScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyBmrBackupPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyBmrScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dayScheduleModel := make(map[string]interface{})
		dayScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyBmrScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyCdpBackupPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dataLockConfigModel := make(map[string]interface{})
		dataLockConfigModel["mode"] = "Compliance"
		dataLockConfigModel["unit"] = "Days"
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyCdpBackupPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyCdpRetentionToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dataLockConfigModel := make(map[string]interface{})
		dataLockConfigModel["mode"] = "Compliance"
		dataLockConfigModel["unit"] = "Days"
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyCdpRetentionToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyStorageArraySnapshotBackupPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		minuteScheduleModel := make(map[string]interface{})
		minuteScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyStorageArraySnapshotBackupPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyStorageArraySnapshotScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		minuteScheduleModel := make(map[string]interface{})
		minuteScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyStorageArraySnapshotScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyCancellationTimeoutParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyCancellationTimeoutParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyBlackoutWindowToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyBlackoutWindowToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyTimeOfDayToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["hour"] = int(0)
		model["minute"] = int(0)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyTimeOfDayToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyExtendedRetentionPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyExtendedRetentionPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyExtendedRetentionScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["unit"] = "Runs"
		model["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyExtendedRetentionScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyTargetsConfigurationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyTargetsConfigurationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyReplicationTargetConfigurationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		targetScheduleModel := make(map[string]interface{})
		targetScheduleModel["unit"] = "Runs"
		targetScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyReplicationTargetConfigurationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyTargetScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["unit"] = "Runs"
		model["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyTargetScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyLogRetentionToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dataLockConfigModel := make(map[string]interface{})
		dataLockConfigModel["mode"] = "Compliance"
		dataLockConfigModel["unit"] = "Days"
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyLogRetentionToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyAWSTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyAWSTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyAzureTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyAzureTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyRemoteTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyRemoteTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyArchivalTargetConfigurationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		targetScheduleModel := make(map[string]interface{})
		targetScheduleModel["unit"] = "Runs"
		targetScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyArchivalTargetConfigurationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyCloudSpinTargetConfigurationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		targetScheduleModel := make(map[string]interface{})
		targetScheduleModel["unit"] = "Runs"
		targetScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyCloudSpinTargetConfigurationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyCloudSpinTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		customTagParamsModel := make(map[string]interface{})
		customTagParamsModel["key"] = "testString"
		customTagParamsModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyCloudSpinTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyAwsCloudSpinParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		customTagParamsModel := make(map[string]interface{})
		customTagParamsModel["key"] = "testString"
		customTagParamsModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyAwsCloudSpinParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyCustomTagParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyCustomTagParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyAzureCloudSpinParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyAzureCloudSpinParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyOnpremDeployTargetConfigurationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		targetScheduleModel := make(map[string]interface{})
		targetScheduleModel["unit"] = "Runs"
		targetScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyOnpremDeployTargetConfigurationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyOnpremDeployParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyOnpremDeployParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyRpaasTargetConfigurationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		targetScheduleModel := make(map[string]interface{})
		targetScheduleModel["unit"] = "Runs"
		targetScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyRpaasTargetConfigurationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyCascadedTargetConfigurationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		targetScheduleModel := make(map[string]interface{})
		targetScheduleModel["unit"] = "Runs"
		targetScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyCascadedTargetConfigurationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPolicyRetryOptionsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["retries"] = int(0)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPolicyRetryOptionsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
