...
func TestAccIbmBackupRecoveryManagerGetComponentDataSourceBasic(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:  func() { acc.TestAccPreCheck(t) },
		Providers: acc.TestAccProviders,
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIbmBackupRecoveryManagerGetComponentDataSourceConfigBasic(),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.ibm_backup_recovery_manager_get_component.backup_recovery_manager_get_component_instance", "id"),
					resource.TestCheckResourceAttrSet("data.ibm_backup_recovery_manager_get_component.backup_recovery_manager_get_component_instance", "backup_recovery_manager_get_component_id"),
				),
			},
		},
	})
...
func testAccCheckIbmBackupRecoveryManagerGetComponentDataSourceConfigBasic() string {
	return fmt.Sprintf(`
		data "ibm_backup_recovery_manager_get_component" "backup_recovery_manager_get_component_instance" {
			id = "id"
		}
	`)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentAttributeAggregationsToMap(t *testing.T) {
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentAttributeAggregationsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentAggregatedAttributesParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentAggregatedAttributesParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentCustomConfigParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentCustomConfigParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentXlsxCustomConfigParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		xlsxAttributeCustomConfigParamsModel := make(map[string]interface{})
		xlsxAttributeCustomConfigParamsModel["attribute_name"] = "testString"
		xlsxAttributeCustomConfigParamsModel["custom_label"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentXlsxCustomConfigParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentXlsxAttributeCustomConfigParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentXlsxAttributeCustomConfigParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentAttributeFilterToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentAttributeFilterToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentInFilterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentInFilterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentRangeFilterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentRangeFilterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentSystemsFilterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentSystemsFilterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentTimeRangeFilterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentTimeRangeFilterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentLimitParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["from"] = int(38)
		model["size"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentLimitParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentAttributeSortToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["attribute"] = "testString"
		model["desc"] = true
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentAttributeSortToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
