...
func TestAccIbmBackupRecoveryManagerGetComponentsDataSourceBasic(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:  func() { acc.TestAccPreCheck(t) },
		Providers: acc.TestAccProviders,
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIbmBackupRecoveryManagerGetComponentsDataSourceConfigBasic(),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.ibm_backup_recovery_manager_get_components.backup_recovery_manager_get_components_instance", "id"),
				),
			},
		},
	})
...
func testAccCheckIbmBackupRecoveryManagerGetComponentsDataSourceConfigBasic() string {
	return fmt.Sprintf(`
		data "ibm_backup_recovery_manager_get_components" "backup_recovery_manager_get_components_instance" {
			ids = [ "ids" ]
		}
	`)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentsComponentToMap(t *testing.T) {
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentsComponentToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentsAttributeAggregationsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		aggregatedAttributesParamsModel := make(map[string]interface{})
		aggregatedAttributesParamsModel["aggregation_type"] = "sum"
		aggregatedAttributesParamsModel["attribute"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentsAttributeAggregationsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentsAggregatedAttributesParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentsAggregatedAttributesParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentsCustomConfigParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		xlsxAttributeCustomConfigParamsModel := make(map[string]interface{})
		xlsxAttributeCustomConfigParamsModel["attribute_name"] = "testString"
		xlsxAttributeCustomConfigParamsModel["custom_label"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentsCustomConfigParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentsXlsxCustomConfigParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		xlsxAttributeCustomConfigParamsModel := make(map[string]interface{})
		xlsxAttributeCustomConfigParamsModel["attribute_name"] = "testString"
		xlsxAttributeCustomConfigParamsModel["custom_label"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentsXlsxCustomConfigParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentsXlsxAttributeCustomConfigParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentsXlsxAttributeCustomConfigParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentsAttributeFilterToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		inFilterParamsModel := make(map[string]interface{})
		inFilterParamsModel["attribute_data_type"] = "Bool"
		inFilterParamsModel["attribute_labels"] = []string{"testString"}
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentsAttributeFilterToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentsInFilterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentsInFilterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentsRangeFilterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentsRangeFilterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentsSystemsFilterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentsSystemsFilterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentsTimeRangeFilterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentsTimeRangeFilterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentsLimitParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["from"] = int(38)
		model["size"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentsLimitParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmBackupRecoveryManagerGetComponentsAttributeSortToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["attribute"] = "testString"
		model["desc"] = true
	...
	result, err := backuprecovery.DataSourceIbmBackupRecoveryManagerGetComponentsAttributeSortToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
