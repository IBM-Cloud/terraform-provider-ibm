...
func TestAccIbmProtectionPoliciesDataSourceBasic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIbmProtectionPoliciesDataSourceConfigBasic(protectionPolicyResponseName),
...
func TestAccIbmProtectionPoliciesDataSourceAllArgs(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIbmProtectionPoliciesDataSourceConfig(protectionPolicyResponseName, protectionPolicyResponseDescription, protectionPolicyResponseDataLock, protectionPolicyResponseVersion, protectionPolicyResponseIsCBSEnabled, protectionPolicyResponseLastModificationTimeUsecs, protectionPolicyResponseTemplateID),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.ibm_protection_policies.protection_policies_instance", "id"),
					...
					resource.TestCheckResourceAttr("data.ibm_protection_policies.protection_policies_instance", "policies.0.name", protectionPolicyResponseName),
					resource.TestCheckResourceAttr("data.ibm_protection_policies.protection_policies_instance", "policies.0.description", protectionPolicyResponseDescription),
					resource.TestCheckResourceAttr("data.ibm_protection_policies.protection_policies_instance", "policies.0.data_lock", protectionPolicyResponseDataLock),
					resource.TestCheckResourceAttr("data.ibm_protection_policies.protection_policies_instance", "policies.0.version", protectionPolicyResponseVersion),
					resource.TestCheckResourceAttr("data.ibm_protection_policies.protection_policies_instance", "policies.0.is_cbs_enabled", protectionPolicyResponseIsCBSEnabled),
					resource.TestCheckResourceAttr("data.ibm_protection_policies.protection_policies_instance", "policies.0.last_modification_time_usecs", protectionPolicyResponseLastModificationTimeUsecs),
					resource.TestCheckResourceAttrSet("data.ibm_protection_policies.protection_policies_instance", "policies.0.id"),
					resource.TestCheckResourceAttr("data.ibm_protection_policies.protection_policies_instance", "policies.0.template_id", protectionPolicyResponseTemplateID),
...
func testAccCheckIbmProtectionPoliciesDataSourceConfigBasic(protectionPolicyResponseName string) string {
	return fmt.Sprintf(`
...
func TestDataSourceIbmProtectionPoliciesProtectionPolicyResponseToMap(t *testing.T) {
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesProtectionPolicyResponseToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesBackupPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		minuteScheduleModel := make(map[string]interface{})
		minuteScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesBackupPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesRegularBackupPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		minuteScheduleModel := make(map[string]interface{})
		minuteScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesRegularBackupPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesIncrementalBackupPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		minuteScheduleModel := make(map[string]interface{})
		minuteScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesIncrementalBackupPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesIncrementalScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		minuteScheduleModel := make(map[string]interface{})
		minuteScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesIncrementalScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesMinuteScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesMinuteScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesHourScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesHourScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesDayScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesDayScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesWeekScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesWeekScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesMonthScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["day_of_week"] = []string{"Sunday"}
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesMonthScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesYearScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesYearScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesFullBackupPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dayScheduleModel := make(map[string]interface{})
		dayScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesFullBackupPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesFullScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dayScheduleModel := make(map[string]interface{})
		dayScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesFullScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesFullScheduleAndRetentionToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dayScheduleModel := make(map[string]interface{})
		dayScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesFullScheduleAndRetentionToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesRetentionToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dataLockConfigModel := make(map[string]interface{})
		dataLockConfigModel["mode"] = "Compliance"
		dataLockConfigModel["unit"] = "Days"
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesRetentionToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesDataLockConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesDataLockConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesPrimaryBackupTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesPrimaryBackupTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesPrimaryArchivalTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesPrimaryArchivalTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesTierLevelSettingsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesTierLevelSettingsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesAWSTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesAWSTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesAWSTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesAWSTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesAzureTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		azureTierModel := make(map[string]interface{})
		azureTierModel["move_after_unit"] = "Days"
		azureTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesAzureTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesAzureTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesAzureTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesGoogleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		googleTierModel := make(map[string]interface{})
		googleTierModel["move_after_unit"] = "Days"
		googleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesGoogleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesGoogleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesGoogleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesOracleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		oracleTierModel := make(map[string]interface{})
		oracleTierModel["move_after_unit"] = "Days"
		oracleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesOracleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesOracleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesOracleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesLogBackupPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		minuteScheduleModel := make(map[string]interface{})
		minuteScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesLogBackupPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesLogScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		minuteScheduleModel := make(map[string]interface{})
		minuteScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesLogScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesBmrBackupPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dayScheduleModel := make(map[string]interface{})
		dayScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesBmrBackupPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesBmrScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dayScheduleModel := make(map[string]interface{})
		dayScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesBmrScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesCdpBackupPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dataLockConfigModel := make(map[string]interface{})
		dataLockConfigModel["mode"] = "Compliance"
		dataLockConfigModel["unit"] = "Days"
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesCdpBackupPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesCdpRetentionToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dataLockConfigModel := make(map[string]interface{})
		dataLockConfigModel["mode"] = "Compliance"
		dataLockConfigModel["unit"] = "Days"
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesCdpRetentionToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesStorageArraySnapshotBackupPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		minuteScheduleModel := make(map[string]interface{})
		minuteScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesStorageArraySnapshotBackupPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesStorageArraySnapshotScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		minuteScheduleModel := make(map[string]interface{})
		minuteScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesStorageArraySnapshotScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesCancellationTimeoutParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesCancellationTimeoutParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesBlackoutWindowToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		timeOfDayModel := make(map[string]interface{})
		timeOfDayModel["hour"] = int(0)
		timeOfDayModel["minute"] = int(0)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesBlackoutWindowToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesTimeOfDayToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["hour"] = int(0)
		model["minute"] = int(0)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesTimeOfDayToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesExtendedRetentionPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		extendedRetentionScheduleModel := make(map[string]interface{})
		extendedRetentionScheduleModel["unit"] = "Runs"
		extendedRetentionScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesExtendedRetentionPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesExtendedRetentionScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["unit"] = "Runs"
		model["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesExtendedRetentionScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesTargetsConfigurationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		targetScheduleModel := make(map[string]interface{})
		targetScheduleModel["unit"] = "Runs"
		targetScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesTargetsConfigurationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesReplicationTargetConfigurationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		targetScheduleModel := make(map[string]interface{})
		targetScheduleModel["unit"] = "Runs"
		targetScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesReplicationTargetConfigurationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesTargetScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["unit"] = "Runs"
		model["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesTargetScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesLogRetentionToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		dataLockConfigModel := make(map[string]interface{})
		dataLockConfigModel["mode"] = "Compliance"
		dataLockConfigModel["unit"] = "Days"
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesLogRetentionToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesAWSTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "testString"
		model["region"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesAWSTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesAzureTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesAzureTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesRemoteTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesRemoteTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesArchivalTargetConfigurationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		targetScheduleModel := make(map[string]interface{})
		targetScheduleModel["unit"] = "Runs"
		targetScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesArchivalTargetConfigurationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesCloudSpinTargetConfigurationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		targetScheduleModel := make(map[string]interface{})
		targetScheduleModel["unit"] = "Runs"
		targetScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesCloudSpinTargetConfigurationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesCloudSpinTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		customTagParamsModel := make(map[string]interface{})
		customTagParamsModel["key"] = "testString"
		customTagParamsModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesCloudSpinTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesAwsCloudSpinParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		customTagParamsModel := make(map[string]interface{})
		customTagParamsModel["key"] = "testString"
		customTagParamsModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesAwsCloudSpinParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesCustomTagParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesCustomTagParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesAzureCloudSpinParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesAzureCloudSpinParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesOnpremDeployTargetConfigurationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		targetScheduleModel := make(map[string]interface{})
		targetScheduleModel["unit"] = "Runs"
		targetScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesOnpremDeployTargetConfigurationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesOnpremDeployParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesOnpremDeployParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesRpaasTargetConfigurationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		targetScheduleModel := make(map[string]interface{})
		targetScheduleModel["unit"] = "Runs"
		targetScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesRpaasTargetConfigurationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesCascadedTargetConfigurationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		targetScheduleModel := make(map[string]interface{})
		targetScheduleModel["unit"] = "Runs"
		targetScheduleModel["frequency"] = int(1)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesCascadedTargetConfigurationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionPoliciesRetryOptionsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["retries"] = int(0)
	...
	result, err := backuprecovery.DataSourceIbmProtectionPoliciesRetryOptionsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
