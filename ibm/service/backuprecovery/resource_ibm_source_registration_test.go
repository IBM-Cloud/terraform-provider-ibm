...
func TestAccIbmSourceRegistrationAllArgs(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIbmSourceRegistrationConfig(environment, name, connectionID, connectorGroupID, dataSourceConnectionID),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckIbmSourceRegistrationExists("ibm_source_registration.source_registration_instance", conf),
					resource.TestCheckResourceAttr("ibm_source_registration.source_registration_instance", "environment", environment),
					...
					resource.TestCheckResourceAttr("ibm_source_registration.source_registration_instance", "data_source_connection_id", dataSourceConnectionID),
				),
			},
			resource.TestStep{
				Config: testAccCheckIbmSourceRegistrationConfig(environmentUpdate, nameUpdate, connectionIDUpdate, connectorGroupIDUpdate, dataSourceConnectionIDUpdate),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("ibm_source_registration.source_registration_instance", "environment", environmentUpdate),
					...
					resource.TestCheckResourceAttr("ibm_source_registration.source_registration_instance", "data_source_connection_id", dataSourceConnectionIDUpdate),
				),
			},
			resource.TestStep{
...
func testAccCheckIbmSourceRegistrationConfig(environment string, name string, connectionID string, connectorGroupID string, dataSourceConnectionID string) string {
	return fmt.Sprintf(`
	...
	`, environment, name, connectionID, connectorGroupID, dataSourceConnectionID)
}
...
func TestResourceIbmSourceRegistrationConnectionConfigToMap(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationConnectionConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationKeyValuePairToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationKeyValuePairToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationPhysicalSourceRegistrationParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationPhysicalSourceRegistrationParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationObjectToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationObjectToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationSharepointObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationSharepointObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationObjectSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationObjectSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationObjectTypeVCenterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationObjectTypeVCenterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationObjectTypeWindowsClusterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationObjectTypeWindowsClusterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationObjectProtectionStatsSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["environment"] = "kPhysical"
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationObjectProtectionStatsSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationPermissionInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		userModel := make(map[string]interface{})
		userModel["name"] = "testString"
		userModel["sid"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationPermissionInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationUserToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationUserToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationGroupToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "testString"
		model["sid"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationGroupToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationTenantToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationTenantToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationExternalVendorTenantMetadataToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationExternalVendorTenantMetadataToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationIbmTenantMetadataParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationIbmTenantMetadataParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationExternalVendorCustomPropertiesToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["key"] = "testString"
		model["value"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationExternalVendorCustomPropertiesToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationTenantNetworkToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationTenantNetworkToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationObjectMssqlParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		aagInfoModel := make(map[string]interface{})
		aagInfoModel["name"] = "testString"
		aagInfoModel["object_id"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationObjectMssqlParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationAAGInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "testString"
		model["object_id"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationAAGInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationHostInformationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = "testString"
		model["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationHostInformationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationObjectPhysicalParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationObjectPhysicalParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationEntityExternalMetadataToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationEntityExternalMetadataToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationMaintenanceModeConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		timeRangeUsecsModel := make(map[string]interface{})
		timeRangeUsecsModel["end_time_usecs"] = int(26)
		timeRangeUsecsModel["start_time_usecs"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationMaintenanceModeConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationTimeRangeUsecsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationTimeRangeUsecsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		timeModel := make(map[string]interface{})
		timeModel["hour"] = int(38)
		timeModel["minute"] = int(38)
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationTimeWindowToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		timeModel := make(map[string]interface{})
		timeModel["hour"] = int(38)
		timeModel["minute"] = int(38)
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationTimeWindowToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationTimeToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["hour"] = int(38)
		model["minute"] = int(38)
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationTimeToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationWorkflowInterventionSpecToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationWorkflowInterventionSpecToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationMapToConnectionConfig(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationMapToConnectionConfig(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationMapToKeyValuePair(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationMapToKeyValuePair(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmSourceRegistrationMapToPhysicalSourceRegistrationParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmSourceRegistrationMapToPhysicalSourceRegistrationParams(model)
	assert.Nil(t, err)
	checkResult(result)
}
