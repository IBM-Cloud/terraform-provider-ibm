...
func TestResourceIbmBaasRecoveryRecoverPhysicalParamsToMap(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryRecoverPhysicalParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryCommonRecoverObjectSnapshotParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryCommonRecoverObjectSnapshotParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryCommonRecoverObjectSnapshotParamsObjectInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryCommonRecoverObjectSnapshotParamsObjectInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoverySharepointObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoverySharepointObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryObjectSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryObjectSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryObjectTypeVCenterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryObjectTypeVCenterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryObjectTypeWindowsClusterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryObjectTypeWindowsClusterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryCommonRecoverObjectSnapshotParamsArchivalTargetInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryCommonRecoverObjectSnapshotParamsArchivalTargetInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryArchivalTargetTierInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryArchivalTargetTierInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryAWSTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryAWSTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryAWSTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryAWSTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryAzureTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		azureTierModel := make(map[string]interface{})
		azureTierModel["move_after_unit"] = "Days"
		azureTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryAzureTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryAzureTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryAzureTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryGoogleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		googleTierModel := make(map[string]interface{})
		googleTierModel["move_after_unit"] = "Days"
		googleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryGoogleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryGoogleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryGoogleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryOracleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		oracleTierModel := make(map[string]interface{})
		oracleTierModel["move_after_unit"] = "Days"
		oracleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryOracleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryOracleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryOracleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryRecoverPhysicalParamsRecoverVolumeParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalTargetParamsForRecoverVolumeMountTargetModel := make(map[string]interface{})
		physicalTargetParamsForRecoverVolumeMountTargetModel["id"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryRecoverPhysicalParamsRecoverVolumeParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryRecoverPhysicalVolumeParamsPhysicalTargetParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalTargetParamsForRecoverVolumeMountTargetModel := make(map[string]interface{})
		physicalTargetParamsForRecoverVolumeMountTargetModel["id"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryRecoverPhysicalVolumeParamsPhysicalTargetParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryPhysicalTargetParamsForRecoverVolumeMountTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryPhysicalTargetParamsForRecoverVolumeMountTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryRecoverVolumeMappingToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryRecoverVolumeMappingToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryPhysicalTargetParamsForRecoverVolumeVlanConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(38)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryPhysicalTargetParamsForRecoverVolumeVlanConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryRecoverPhysicalParamsMountVolumeParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel := make(map[string]interface{})
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["username"] = "testString"
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["password"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryRecoverPhysicalParamsMountVolumeParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMountPhysicalVolumeParamsPhysicalTargetParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel := make(map[string]interface{})
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["username"] = "testString"
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["password"] = "testString"
		...
		model["mounted_volume_mapping"] = []map[string]interface{}{}
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMountPhysicalVolumeParamsPhysicalTargetParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryPhysicalTargetParamsForMountVolumeOriginalTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel := make(map[string]interface{})
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["username"] = "testString"
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["password"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryPhysicalTargetParamsForMountVolumeOriginalTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryPhysicalMountVolumesOriginalTargetConfigServerCredentialsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryPhysicalMountVolumesOriginalTargetConfigServerCredentialsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryPhysicalTargetParamsForMountVolumeNewTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		recoverTargetModel := make(map[string]interface{})
		recoverTargetModel["id"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryPhysicalTargetParamsForMountVolumeNewTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryRecoverTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryRecoverTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryPhysicalMountVolumesNewTargetConfigServerCredentialsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["username"] = "testString"
		model["password"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryPhysicalMountVolumesNewTargetConfigServerCredentialsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMountedVolumeMappingToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMountedVolumeMappingToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryPhysicalTargetParamsForMountVolumeVlanConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(38)
		model["disable_vlan"] = true
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryPhysicalTargetParamsForMountVolumeVlanConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryRecoverPhysicalParamsRecoverFileAndFolderParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		commonRecoverFileAndFolderInfoModel := make(map[string]interface{})
		commonRecoverFileAndFolderInfoModel["absolute_path"] = "testString"
		commonRecoverFileAndFolderInfoModel["is_directory"] = true
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryRecoverPhysicalParamsRecoverFileAndFolderParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryCommonRecoverFileAndFolderInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryCommonRecoverFileAndFolderInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryRecoverPhysicalFileAndFolderParamsPhysicalTargetParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalTargetParamsForRecoverFileAndFolderRecoverTargetModel := make(map[string]interface{})
		physicalTargetParamsForRecoverFileAndFolderRecoverTargetModel["id"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryRecoverPhysicalFileAndFolderParamsPhysicalTargetParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryPhysicalTargetParamsForRecoverFileAndFolderRecoverTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryPhysicalTargetParamsForRecoverFileAndFolderRecoverTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryPhysicalTargetParamsForRecoverFileAndFolderVlanConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(38)
		model["disable_vlan"] = true
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryPhysicalTargetParamsForRecoverFileAndFolderVlanConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryRecoverPhysicalParamsDownloadFileAndFolderParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		commonRecoverFileAndFolderInfoModel := make(map[string]interface{})
		commonRecoverFileAndFolderInfoModel["absolute_path"] = "testString"
		commonRecoverFileAndFolderInfoModel["is_directory"] = true
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryRecoverPhysicalParamsDownloadFileAndFolderParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryRecoverPhysicalParamsSystemRecoveryParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryRecoverPhysicalParamsSystemRecoveryParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryRecoverSqlParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryRecoverSqlParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryRecoverSqlAppParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryRecoverSqlAppParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryAAGInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryAAGInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryHostInformationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = "testString"
		model["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryHostInformationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoverySqlTargetParamsForRecoverSqlAppToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		multiStageRestoreOptionsModel := make(map[string]interface{})
		multiStageRestoreOptionsModel["enable_auto_sync"] = true
		multiStageRestoreOptionsModel["enable_multi_stage_restore"] = true
	...
	result, err := backuprecovery.ResourceIbmBaasRecoverySqlTargetParamsForRecoverSqlAppToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryRecoverSqlAppNewSourceConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		multiStageRestoreOptionsModel := make(map[string]interface{})
		multiStageRestoreOptionsModel["enable_auto_sync"] = true
		multiStageRestoreOptionsModel["enable_multi_stage_restore"] = true
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryRecoverSqlAppNewSourceConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMultiStageRestoreOptionsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMultiStageRestoreOptionsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryFilenamePatternToDirectoryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryFilenamePatternToDirectoryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryRecoveryObjectIdentifierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryRecoveryObjectIdentifierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryRecoverSqlAppOriginalSourceConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		multiStageRestoreOptionsModel := make(map[string]interface{})
		multiStageRestoreOptionsModel["enable_auto_sync"] = true
		multiStageRestoreOptionsModel["enable_multi_stage_restore"] = true
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryRecoverSqlAppOriginalSourceConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryRecoveryVlanConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(38)
		model["disable_vlan"] = true
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryRecoveryVlanConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryTenantToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryTenantToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryExternalVendorTenantMetadataToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryExternalVendorTenantMetadataToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryIbmTenantMetadataParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryIbmTenantMetadataParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryExternalVendorCustomPropertiesToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryExternalVendorCustomPropertiesToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryTenantNetworkToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryTenantNetworkToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryCreationInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryCreationInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryRetrieveArchiveTaskToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryRetrieveArchiveTaskToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToRecoverPhysicalParams(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.RecoverPhysicalParams) {
		sharepointObjectParamsModel := new(backuprecoveryv1.SharepointObjectParams)
		sharepointObjectParamsModel.SiteWebURL = core.StringPtr("testString")
	...
	commonRecoverObjectSnapshotParamsModel["protection_group_id"] = "testString"
	commonRecoverObjectSnapshotParamsModel["protection_group_name"] = "testString"
	commonRecoverObjectSnapshotParamsModel["object_info"] = []interface{}{commonRecoverObjectSnapshotParamsObjectInfoModel}
	commonRecoverObjectSnapshotParamsModel["archival_target_info"] = []interface{}{commonRecoverObjectSnapshotParamsArchivalTargetInfoModel}
	commonRecoverObjectSnapshotParamsModel["recover_from_standby"] = true
	...
	recoverPhysicalVolumeParamsPhysicalTargetParamsModel := make(map[string]interface{})
	recoverPhysicalVolumeParamsPhysicalTargetParamsModel["mount_target"] = []interface{}{physicalTargetParamsForRecoverVolumeMountTargetModel}
	recoverPhysicalVolumeParamsPhysicalTargetParamsModel["volume_mapping"] = []interface{}{recoverVolumeMappingModel}
	recoverPhysicalVolumeParamsPhysicalTargetParamsModel["force_unmount_volume"] = true
	recoverPhysicalVolumeParamsPhysicalTargetParamsModel["vlan_config"] = []interface{}{physicalTargetParamsForRecoverVolumeVlanConfigModel}

	recoverPhysicalParamsRecoverVolumeParamsModel := make(map[string]interface{})
	recoverPhysicalParamsRecoverVolumeParamsModel["target_environment"] = "kPhysical"
	recoverPhysicalParamsRecoverVolumeParamsModel["physical_target_params"] = []interface{}{recoverPhysicalVolumeParamsPhysicalTargetParamsModel}
	...
	physicalTargetParamsForMountVolumeOriginalTargetConfigModel := make(map[string]interface{})
	physicalTargetParamsForMountVolumeOriginalTargetConfigModel["server_credentials"] = []interface{}{physicalMountVolumesOriginalTargetConfigServerCredentialsModel}
	...
	physicalTargetParamsForMountVolumeNewTargetConfigModel := make(map[string]interface{})
	physicalTargetParamsForMountVolumeNewTargetConfigModel["mount_target"] = []interface{}{recoverTargetModel}
	physicalTargetParamsForMountVolumeNewTargetConfigModel["server_credentials"] = []interface{}{physicalMountVolumesNewTargetConfigServerCredentialsModel}
	...
	mountPhysicalVolumeParamsPhysicalTargetParamsModel := make(map[string]interface{})
	mountPhysicalVolumeParamsPhysicalTargetParamsModel["mount_to_original_target"] = true
	mountPhysicalVolumeParamsPhysicalTargetParamsModel["original_target_config"] = []interface{}{physicalTargetParamsForMountVolumeOriginalTargetConfigModel}
	mountPhysicalVolumeParamsPhysicalTargetParamsModel["new_target_config"] = []interface{}{physicalTargetParamsForMountVolumeNewTargetConfigModel}
	mountPhysicalVolumeParamsPhysicalTargetParamsModel["read_only_mount"] = true
	mountPhysicalVolumeParamsPhysicalTargetParamsModel["volume_names"] = []interface{}{"testString"}
	mountPhysicalVolumeParamsPhysicalTargetParamsModel["vlan_config"] = []interface{}{physicalTargetParamsForMountVolumeVlanConfigModel}

	recoverPhysicalParamsMountVolumeParamsModel := make(map[string]interface{})
	recoverPhysicalParamsMountVolumeParamsModel["target_environment"] = "kPhysical"
	recoverPhysicalParamsMountVolumeParamsModel["physical_target_params"] = []interface{}{mountPhysicalVolumeParamsPhysicalTargetParamsModel}
	...
	recoverPhysicalFileAndFolderParamsPhysicalTargetParamsModel := make(map[string]interface{})
	recoverPhysicalFileAndFolderParamsPhysicalTargetParamsModel["recover_target"] = []interface{}{physicalTargetParamsForRecoverFileAndFolderRecoverTargetModel}
	recoverPhysicalFileAndFolderParamsPhysicalTargetParamsModel["restore_to_original_paths"] = true
	recoverPhysicalFileAndFolderParamsPhysicalTargetParamsModel["overwrite_existing"] = true
	recoverPhysicalFileAndFolderParamsPhysicalTargetParamsModel["alternate_restore_directory"] = "testString"
	recoverPhysicalFileAndFolderParamsPhysicalTargetParamsModel["preserve_attributes"] = true
	...
	recoverPhysicalFileAndFolderParamsPhysicalTargetParamsModel["continue_on_error"] = true
	recoverPhysicalFileAndFolderParamsPhysicalTargetParamsModel["save_success_files"] = true
	recoverPhysicalFileAndFolderParamsPhysicalTargetParamsModel["vlan_config"] = []interface{}{physicalTargetParamsForRecoverFileAndFolderVlanConfigModel}
	recoverPhysicalFileAndFolderParamsPhysicalTargetParamsModel["restore_entity_type"] = "kRegular"

	recoverPhysicalParamsRecoverFileAndFolderParamsModel := make(map[string]interface{})
	recoverPhysicalParamsRecoverFileAndFolderParamsModel["files_and_folders"] = []interface{}{commonRecoverFileAndFolderInfoModel}
	recoverPhysicalParamsRecoverFileAndFolderParamsModel["target_environment"] = "kPhysical"
	recoverPhysicalParamsRecoverFileAndFolderParamsModel["physical_target_params"] = []interface{}{recoverPhysicalFileAndFolderParamsPhysicalTargetParamsModel}

	recoverPhysicalParamsDownloadFileAndFolderParamsModel := make(map[string]interface{})
	recoverPhysicalParamsDownloadFileAndFolderParamsModel["expiry_time_usecs"] = int(26)
	recoverPhysicalParamsDownloadFileAndFolderParamsModel["files_and_folders"] = []interface{}{commonRecoverFileAndFolderInfoModel}
	recoverPhysicalParamsDownloadFileAndFolderParamsModel["download_file_path"] = "testString"
	...
	model := make(map[string]interface{})
	model["objects"] = []interface{}{commonRecoverObjectSnapshotParamsModel}
	model["recovery_action"] = "RecoverPhysicalVolumes"
	model["recover_volume_params"] = []interface{}{recoverPhysicalParamsRecoverVolumeParamsModel}
	model["mount_volume_params"] = []interface{}{recoverPhysicalParamsMountVolumeParamsModel}
	model["recover_file_and_folder_params"] = []interface{}{recoverPhysicalParamsRecoverFileAndFolderParamsModel}
	model["download_file_and_folder_params"] = []interface{}{recoverPhysicalParamsDownloadFileAndFolderParamsModel}
	model["system_recovery_params"] = []interface{}{recoverPhysicalParamsSystemRecoveryParamsModel}

	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToRecoverPhysicalParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToCommonRecoverObjectSnapshotParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToCommonRecoverObjectSnapshotParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToCommonRecoverObjectSnapshotParamsObjectInfo(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToCommonRecoverObjectSnapshotParamsObjectInfo(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToSharepointObjectParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToSharepointObjectParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToObjectSummary(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToObjectSummary(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToObjectTypeVCenterParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToObjectTypeVCenterParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToObjectTypeWindowsClusterParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToObjectTypeWindowsClusterParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToCommonRecoverObjectSnapshotParamsArchivalTargetInfo(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToCommonRecoverObjectSnapshotParamsArchivalTargetInfo(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToArchivalTargetTierInfo(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToArchivalTargetTierInfo(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToAWSTiers(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToAWSTiers(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToAWSTier(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToAWSTier(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToAzureTiers(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToAzureTiers(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToAzureTier(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToAzureTier(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToGoogleTiers(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToGoogleTiers(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToGoogleTier(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToGoogleTier(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToOracleTiers(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToOracleTiers(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToOracleTier(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToOracleTier(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToRecoverPhysicalParamsRecoverVolumeParams(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.RecoverPhysicalParamsRecoverVolumeParams) {
		physicalTargetParamsForRecoverVolumeMountTargetModel := new(backuprecoveryv1.PhysicalTargetParamsForRecoverVolumeMountTarget)
		physicalTargetParamsForRecoverVolumeMountTargetModel.ID = core.Int64Ptr(int64(26))
	...
	model := make(map[string]interface{})
	model["target_environment"] = "kPhysical"
	model["physical_target_params"] = []interface{}{recoverPhysicalVolumeParamsPhysicalTargetParamsModel}

	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToRecoverPhysicalParamsRecoverVolumeParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToRecoverPhysicalVolumeParamsPhysicalTargetParams(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.RecoverPhysicalVolumeParamsPhysicalTargetParams) {
		physicalTargetParamsForRecoverVolumeMountTargetModel := new(backuprecoveryv1.PhysicalTargetParamsForRecoverVolumeMountTarget)
		physicalTargetParamsForRecoverVolumeMountTargetModel.ID = core.Int64Ptr(int64(26))
	...
	model := make(map[string]interface{})
	model["mount_target"] = []interface{}{physicalTargetParamsForRecoverVolumeMountTargetModel}
	model["volume_mapping"] = []interface{}{recoverVolumeMappingModel}
	model["force_unmount_volume"] = true
	model["vlan_config"] = []interface{}{physicalTargetParamsForRecoverVolumeVlanConfigModel}

	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToRecoverPhysicalVolumeParamsPhysicalTargetParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToPhysicalTargetParamsForRecoverVolumeMountTarget(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.PhysicalTargetParamsForRecoverVolumeMountTarget) {
		model := new(backuprecoveryv1.PhysicalTargetParamsForRecoverVolumeMountTarget)
		model.ID = core.Int64Ptr(int64(26))
		model.Name = core.StringPtr("testString")
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToPhysicalTargetParamsForRecoverVolumeMountTarget(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToRecoverVolumeMapping(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.RecoverVolumeMapping) {
		model := new(backuprecoveryv1.RecoverVolumeMapping)
		model.SourceVolumeGuid = core.StringPtr("testString")
		model.DestinationVolumeGuid = core.StringPtr("testString")
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToRecoverVolumeMapping(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToPhysicalTargetParamsForRecoverVolumeVlanConfig(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.PhysicalTargetParamsForRecoverVolumeVlanConfig) {
		model := new(backuprecoveryv1.PhysicalTargetParamsForRecoverVolumeVlanConfig)
		model.ID = core.Int64Ptr(int64(38))
		model.DisableVlan = core.BoolPtr(true)
		model.InterfaceName = core.StringPtr("testString")
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToPhysicalTargetParamsForRecoverVolumeVlanConfig(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToRecoverPhysicalParamsMountVolumeParams(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.RecoverPhysicalParamsMountVolumeParams) {
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel := new(backuprecoveryv1.PhysicalMountVolumesOriginalTargetConfigServerCredentials)
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel.Username = core.StringPtr("testString")
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel.Password = core.StringPtr("testString")
	...
	model := make(map[string]interface{})
	model["target_environment"] = "kPhysical"
	model["physical_target_params"] = []interface{}{mountPhysicalVolumeParamsPhysicalTargetParamsModel}

	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToRecoverPhysicalParamsMountVolumeParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToMountPhysicalVolumeParamsPhysicalTargetParams(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.MountPhysicalVolumeParamsPhysicalTargetParams) {
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel := new(backuprecoveryv1.PhysicalMountVolumesOriginalTargetConfigServerCredentials)
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel.Username = core.StringPtr("testString")
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel.Password = core.StringPtr("testString")
	...
	model := make(map[string]interface{})
	model["mount_to_original_target"] = true
	model["original_target_config"] = []interface{}{physicalTargetParamsForMountVolumeOriginalTargetConfigModel}
	model["new_target_config"] = []interface{}{physicalTargetParamsForMountVolumeNewTargetConfigModel}
	model["read_only_mount"] = true
	model["volume_names"] = []interface{}{"testString"}
	model["mounted_volume_mapping"] = []interface{}{}
	model["vlan_config"] = []interface{}{physicalTargetParamsForMountVolumeVlanConfigModel}

	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToMountPhysicalVolumeParamsPhysicalTargetParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToPhysicalTargetParamsForMountVolumeOriginalTargetConfig(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.PhysicalTargetParamsForMountVolumeOriginalTargetConfig) {
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel := new(backuprecoveryv1.PhysicalMountVolumesOriginalTargetConfigServerCredentials)
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel.Username = core.StringPtr("testString")
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel.Password = core.StringPtr("testString")
	...
	model := make(map[string]interface{})
	model["server_credentials"] = []interface{}{physicalMountVolumesOriginalTargetConfigServerCredentialsModel}

	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToPhysicalTargetParamsForMountVolumeOriginalTargetConfig(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToPhysicalMountVolumesOriginalTargetConfigServerCredentials(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.PhysicalMountVolumesOriginalTargetConfigServerCredentials) {
		model := new(backuprecoveryv1.PhysicalMountVolumesOriginalTargetConfigServerCredentials)
		model.Username = core.StringPtr("testString")
		model.Password = core.StringPtr("testString")
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToPhysicalMountVolumesOriginalTargetConfigServerCredentials(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToPhysicalTargetParamsForMountVolumeNewTargetConfig(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.PhysicalTargetParamsForMountVolumeNewTargetConfig) {
		recoverTargetModel := new(backuprecoveryv1.RecoverTarget)
		recoverTargetModel.ID = core.Int64Ptr(int64(26))
	...
	model := make(map[string]interface{})
	model["mount_target"] = []interface{}{recoverTargetModel}
	model["server_credentials"] = []interface{}{physicalMountVolumesNewTargetConfigServerCredentialsModel}

	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToPhysicalTargetParamsForMountVolumeNewTargetConfig(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToRecoverTarget(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.RecoverTarget) {
		model := new(backuprecoveryv1.RecoverTarget)
		model.ID = core.Int64Ptr(int64(26))
		model.Name = core.StringPtr("testString")
		model.ParentSourceID = core.Int64Ptr(int64(26))
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToRecoverTarget(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToPhysicalMountVolumesNewTargetConfigServerCredentials(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.PhysicalMountVolumesNewTargetConfigServerCredentials) {
		model := new(backuprecoveryv1.PhysicalMountVolumesNewTargetConfigServerCredentials)
		model.Username = core.StringPtr("testString")
		model.Password = core.StringPtr("testString")
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToPhysicalMountVolumesNewTargetConfigServerCredentials(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToMountedVolumeMapping(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.MountedVolumeMapping) {
		model := new(backuprecoveryv1.MountedVolumeMapping)
		model.OriginalVolume = core.StringPtr("testString")
		model.MountedVolume = core.StringPtr("testString")
		model.FileSystemType = core.StringPtr("testString")
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToMountedVolumeMapping(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToPhysicalTargetParamsForMountVolumeVlanConfig(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.PhysicalTargetParamsForMountVolumeVlanConfig) {
		model := new(backuprecoveryv1.PhysicalTargetParamsForMountVolumeVlanConfig)
		model.ID = core.Int64Ptr(int64(38))
		model.DisableVlan = core.BoolPtr(true)
		model.InterfaceName = core.StringPtr("testString")
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToPhysicalTargetParamsForMountVolumeVlanConfig(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToRecoverPhysicalParamsRecoverFileAndFolderParams(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.RecoverPhysicalParamsRecoverFileAndFolderParams) {
		commonRecoverFileAndFolderInfoModel := new(backuprecoveryv1.CommonRecoverFileAndFolderInfo)
		commonRecoverFileAndFolderInfoModel.AbsolutePath = core.StringPtr("testString")
		commonRecoverFileAndFolderInfoModel.IsDirectory = core.BoolPtr(true)
		commonRecoverFileAndFolderInfoModel.IsViewFileRecovery = core.BoolPtr(true)
	...
	model := make(map[string]interface{})
	model["files_and_folders"] = []interface{}{commonRecoverFileAndFolderInfoModel}
	model["target_environment"] = "kPhysical"
	model["physical_target_params"] = []interface{}{recoverPhysicalFileAndFolderParamsPhysicalTargetParamsModel}

	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToRecoverPhysicalParamsRecoverFileAndFolderParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToCommonRecoverFileAndFolderInfo(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.CommonRecoverFileAndFolderInfo) {
		model := new(backuprecoveryv1.CommonRecoverFileAndFolderInfo)
		model.AbsolutePath = core.StringPtr("testString")
		model.DestinationDir = core.StringPtr("testString")
		model.IsDirectory = core.BoolPtr(true)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToCommonRecoverFileAndFolderInfo(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToRecoverPhysicalFileAndFolderParamsPhysicalTargetParams(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.RecoverPhysicalFileAndFolderParamsPhysicalTargetParams) {
		physicalTargetParamsForRecoverFileAndFolderRecoverTargetModel := new(backuprecoveryv1.PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget)
		physicalTargetParamsForRecoverFileAndFolderRecoverTargetModel.ID = core.Int64Ptr(int64(26))
	...
	model := make(map[string]interface{})
	model["recover_target"] = []interface{}{physicalTargetParamsForRecoverFileAndFolderRecoverTargetModel}
	model["restore_to_original_paths"] = true
	model["overwrite_existing"] = true
	model["alternate_restore_directory"] = "testString"
	model["preserve_attributes"] = true
	...
	model["continue_on_error"] = true
	model["save_success_files"] = true
	model["vlan_config"] = []interface{}{physicalTargetParamsForRecoverFileAndFolderVlanConfigModel}
	model["restore_entity_type"] = "kRegular"

	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToRecoverPhysicalFileAndFolderParamsPhysicalTargetParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToPhysicalTargetParamsForRecoverFileAndFolderRecoverTarget(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget) {
		model := new(backuprecoveryv1.PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget)
		model.ID = core.Int64Ptr(int64(26))
		model.Name = core.StringPtr("testString")
		model.ParentSourceID = core.Int64Ptr(int64(26))
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToPhysicalTargetParamsForRecoverFileAndFolderRecoverTarget(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToPhysicalTargetParamsForRecoverFileAndFolderVlanConfig(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.PhysicalTargetParamsForRecoverFileAndFolderVlanConfig) {
		model := new(backuprecoveryv1.PhysicalTargetParamsForRecoverFileAndFolderVlanConfig)
		model.ID = core.Int64Ptr(int64(38))
		model.DisableVlan = core.BoolPtr(true)
		model.InterfaceName = core.StringPtr("testString")
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToPhysicalTargetParamsForRecoverFileAndFolderVlanConfig(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToRecoverPhysicalParamsDownloadFileAndFolderParams(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.RecoverPhysicalParamsDownloadFileAndFolderParams) {
		commonRecoverFileAndFolderInfoModel := new(backuprecoveryv1.CommonRecoverFileAndFolderInfo)
		commonRecoverFileAndFolderInfoModel.AbsolutePath = core.StringPtr("testString")
		commonRecoverFileAndFolderInfoModel.IsDirectory = core.BoolPtr(true)
		commonRecoverFileAndFolderInfoModel.IsViewFileRecovery = core.BoolPtr(true)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToRecoverPhysicalParamsDownloadFileAndFolderParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToRecoverPhysicalParamsSystemRecoveryParams(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.RecoverPhysicalParamsSystemRecoveryParams) {
		model := new(backuprecoveryv1.RecoverPhysicalParamsSystemRecoveryParams)
		model.FullNasPath = core.StringPtr("testString")
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToRecoverPhysicalParamsSystemRecoveryParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToRecoverSqlParams(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.RecoverSqlParams) {
		sharepointObjectParamsModel := new(backuprecoveryv1.SharepointObjectParams)
		sharepointObjectParamsModel.SiteWebURL = core.StringPtr("testString")
	...
	recoverSqlAppNewSourceConfigModel := make(map[string]interface{})
	recoverSqlAppNewSourceConfigModel["keep_cdc"] = true
	recoverSqlAppNewSourceConfigModel["multi_stage_restore_options"] = []interface{}{multiStageRestoreOptionsModel}
	recoverSqlAppNewSourceConfigModel["native_log_recovery_with_clause"] = "testString"
	recoverSqlAppNewSourceConfigModel["native_recovery_with_clause"] = "testString"
	recoverSqlAppNewSourceConfigModel["overwriting_policy"] = "FailIfExists"
	recoverSqlAppNewSourceConfigModel["replay_entire_last_log"] = true
	recoverSqlAppNewSourceConfigModel["restore_time_usecs"] = int(26)
	recoverSqlAppNewSourceConfigModel["secondary_data_files_dir_list"] = []interface{}{filenamePatternToDirectoryModel}
	recoverSqlAppNewSourceConfigModel["with_no_recovery"] = true
	recoverSqlAppNewSourceConfigModel["data_file_directory_location"] = "testString"
	recoverSqlAppNewSourceConfigModel["database_name"] = "testString"
	recoverSqlAppNewSourceConfigModel["host"] = []interface{}{recoveryObjectIdentifierModel}
	recoverSqlAppNewSourceConfigModel["instance_name"] = "testString"
	recoverSqlAppNewSourceConfigModel["log_file_directory_location"] = "testString"

	recoverSqlAppOriginalSourceConfigModel := make(map[string]interface{})
	recoverSqlAppOriginalSourceConfigModel["keep_cdc"] = true
	recoverSqlAppOriginalSourceConfigModel["multi_stage_restore_options"] = []interface{}{multiStageRestoreOptionsModel}
	recoverSqlAppOriginalSourceConfigModel["native_log_recovery_with_clause"] = "testString"
	recoverSqlAppOriginalSourceConfigModel["native_recovery_with_clause"] = "testString"
	recoverSqlAppOriginalSourceConfigModel["overwriting_policy"] = "FailIfExists"
	recoverSqlAppOriginalSourceConfigModel["replay_entire_last_log"] = true
	recoverSqlAppOriginalSourceConfigModel["restore_time_usecs"] = int(26)
	recoverSqlAppOriginalSourceConfigModel["secondary_data_files_dir_list"] = []interface{}{filenamePatternToDirectoryModel}
	recoverSqlAppOriginalSourceConfigModel["with_no_recovery"] = true
	recoverSqlAppOriginalSourceConfigModel["capture_tail_logs"] = true
	recoverSqlAppOriginalSourceConfigModel["data_file_directory_location"] = "testString"
	recoverSqlAppOriginalSourceConfigModel["log_file_directory_location"] = "testString"
	...
	sqlTargetParamsForRecoverSqlAppModel := make(map[string]interface{})
	sqlTargetParamsForRecoverSqlAppModel["new_source_config"] = []interface{}{recoverSqlAppNewSourceConfigModel}
	sqlTargetParamsForRecoverSqlAppModel["original_source_config"] = []interface{}{recoverSqlAppOriginalSourceConfigModel}
	sqlTargetParamsForRecoverSqlAppModel["recover_to_new_source"] = true
	...
	recoverSqlAppParamsModel["protection_group_id"] = "testString"
	recoverSqlAppParamsModel["protection_group_name"] = "testString"
	recoverSqlAppParamsModel["object_info"] = []interface{}{commonRecoverObjectSnapshotParamsObjectInfoModel}
	recoverSqlAppParamsModel["archival_target_info"] = []interface{}{commonRecoverObjectSnapshotParamsArchivalTargetInfoModel}
	recoverSqlAppParamsModel["recover_from_standby"] = true
	recoverSqlAppParamsModel["aag_info"] = []interface{}{aagInfoModel}
	recoverSqlAppParamsModel["host_info"] = []interface{}{hostInformationModel}
	recoverSqlAppParamsModel["is_encrypted"] = true
	recoverSqlAppParamsModel["sql_target_params"] = []interface{}{sqlTargetParamsForRecoverSqlAppModel}
	recoverSqlAppParamsModel["target_environment"] = "kSQL"
	...
	model := make(map[string]interface{})
	model["recover_app_params"] = []interface{}{recoverSqlAppParamsModel}
	model["recovery_action"] = "RecoverApps"
	model["vlan_config"] = []interface{}{recoveryVlanConfigModel}

	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToRecoverSqlParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToRecoverSqlAppParams(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.RecoverSqlAppParams) {
		sharepointObjectParamsModel := new(backuprecoveryv1.SharepointObjectParams)
		sharepointObjectParamsModel.SiteWebURL = core.StringPtr("testString")
	...
	model["messages"] = []interface{}{"testString"}
	model["bytes_restored"] = int(26)
	model["aag_info"] = []interface{}{aagInfoModel}
	model["host_info"] = []interface{}{hostInformationModel}
	model["is_encrypted"] = true
	model["sql_target_params"] = []interface{}{sqlTargetParamsForRecoverSqlAppModel}
	model["target_environment"] = "kSQL"

	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToRecoverSqlAppParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToAAGInfo(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.AAGInfo) {
		model := new(backuprecoveryv1.AAGInfo)
		model.Name = core.StringPtr("testString")
		model.ObjectID = core.Int64Ptr(int64(26))
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToAAGInfo(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToHostInformation(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.HostInformation) {
		model := new(backuprecoveryv1.HostInformation)
		model.ID = core.StringPtr("testString")
		model.Name = core.StringPtr("testString")
		model.Environment = core.StringPtr("kPhysical")
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToHostInformation(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToSqlTargetParamsForRecoverSqlApp(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.SqlTargetParamsForRecoverSqlApp) {
		multiStageRestoreOptionsModel := new(backuprecoveryv1.MultiStageRestoreOptions)
		multiStageRestoreOptionsModel.EnableAutoSync = core.BoolPtr(true)
		multiStageRestoreOptionsModel.EnableMultiStageRestore = core.BoolPtr(true)
	...
	model := make(map[string]interface{})
	model["new_source_config"] = []interface{}{recoverSqlAppNewSourceConfigModel}
	model["original_source_config"] = []interface{}{recoverSqlAppOriginalSourceConfigModel}
	model["recover_to_new_source"] = true

	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToSqlTargetParamsForRecoverSqlApp(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToRecoverSqlAppNewSourceConfig(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.RecoverSqlAppNewSourceConfig) {
		multiStageRestoreOptionsModel := new(backuprecoveryv1.MultiStageRestoreOptions)
		multiStageRestoreOptionsModel.EnableAutoSync = core.BoolPtr(true)
		multiStageRestoreOptionsModel.EnableMultiStageRestore = core.BoolPtr(true)
	...
	model := make(map[string]interface{})
	model["keep_cdc"] = true
	model["multi_stage_restore_options"] = []interface{}{multiStageRestoreOptionsModel}
	model["native_log_recovery_with_clause"] = "testString"
	model["native_recovery_with_clause"] = "testString"
	model["overwriting_policy"] = "FailIfExists"
	model["replay_entire_last_log"] = true
	model["restore_time_usecs"] = int(26)
	model["secondary_data_files_dir_list"] = []interface{}{filenamePatternToDirectoryModel}
	model["with_no_recovery"] = true
	model["data_file_directory_location"] = "testString"
	model["database_name"] = "testString"
	model["host"] = []interface{}{recoveryObjectIdentifierModel}
	model["instance_name"] = "testString"
	model["log_file_directory_location"] = "testString"

	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToRecoverSqlAppNewSourceConfig(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToMultiStageRestoreOptions(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.MultiStageRestoreOptions) {
		model := new(backuprecoveryv1.MultiStageRestoreOptions)
		model.EnableAutoSync = core.BoolPtr(true)
		model.EnableMultiStageRestore = core.BoolPtr(true)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToMultiStageRestoreOptions(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToFilenamePatternToDirectory(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.FilenamePatternToDirectory) {
		model := new(backuprecoveryv1.FilenamePatternToDirectory)
		model.Directory = core.StringPtr("testString")
		model.FilenamePattern = core.StringPtr("testString")
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToFilenamePatternToDirectory(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToRecoveryObjectIdentifier(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.RecoveryObjectIdentifier) {
		model := new(backuprecoveryv1.RecoveryObjectIdentifier)
		model.ID = core.Int64Ptr(int64(26))
		model.Name = core.StringPtr("testString")
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToRecoveryObjectIdentifier(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToRecoverSqlAppOriginalSourceConfig(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.RecoverSqlAppOriginalSourceConfig) {
		multiStageRestoreOptionsModel := new(backuprecoveryv1.MultiStageRestoreOptions)
		multiStageRestoreOptionsModel.EnableAutoSync = core.BoolPtr(true)
		multiStageRestoreOptionsModel.EnableMultiStageRestore = core.BoolPtr(true)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToRecoverSqlAppOriginalSourceConfig(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryMapToRecoveryVlanConfig(t *testing.T) {
	checkResult := func(result *backuprecoveryv1.RecoveryVlanConfig) {
		model := new(backuprecoveryv1.RecoveryVlanConfig)
		model.ID = core.Int64Ptr(int64(38))
		model.DisableVlan = core.BoolPtr(true)
		model.InterfaceName = core.StringPtr("testString")
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryMapToRecoveryVlanConfig(model)
	assert.Nil(t, err)
	checkResult(result)
}
