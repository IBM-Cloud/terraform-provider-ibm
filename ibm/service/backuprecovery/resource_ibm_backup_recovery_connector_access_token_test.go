...
func testAccCheckIbmBackupRecoveryConnectorAccessTokenConfigBasic(xIbmTenantID string) string {
	return fmt.Sprintf(`
...
func testAccCheckIbmBackupRecoveryConnectorAccessTokenExists(n string, obj backuprecoveryv1.TokenResponse) resource.TestCheckFunc {
...
func testAccCheckIbmBackupRecoveryConnectorAccessTokenDestroy(s *terraform.State) error {
	// backupRecoveryClient, err := acc.TestAccProvider.Meta().(conns.ClientSession).BackupRecoveryV1()
	// if err != nil {
	// 	return err
	// }
