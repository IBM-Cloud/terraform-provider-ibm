...
func TestDataSourceIbmProtectionGroupRunClusterIdentifierToMap(t *testing.T) {
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunClusterIdentifierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunObjectRunResultToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunObjectRunResultToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunObjectSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunObjectSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunSharepointObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunSharepointObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunObjectTypeVCenterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunObjectTypeVCenterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunObjectTypeWindowsClusterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunObjectTypeWindowsClusterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunBackupRunToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		backupDataStatsModel := make(map[string]interface{})
		backupDataStatsModel["logical_size_bytes"] = int(26)
		backupDataStatsModel["bytes_written"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunBackupRunToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunSnapshotInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		backupDataStatsModel := make(map[string]interface{})
		backupDataStatsModel["logical_size_bytes"] = int(26)
		backupDataStatsModel["bytes_written"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunSnapshotInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunBackupDataStatsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["logical_size_bytes"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunBackupDataStatsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunDataLockConstraintsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunDataLockConstraintsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunBackupAttemptToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		backupDataStatsModel := make(map[string]interface{})
		backupDataStatsModel["logical_size_bytes"] = int(26)
		backupDataStatsModel["bytes_written"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunBackupAttemptToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunReplicationRunToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTargetConfigModel := make(map[string]interface{})
		awsTargetConfigModel["region"] = int(26)
		awsTargetConfigModel["source_id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunReplicationRunToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunReplicationTargetResultToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTargetConfigModel := make(map[string]interface{})
		awsTargetConfigModel["region"] = int(26)
		awsTargetConfigModel["source_id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunReplicationTargetResultToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunAWSTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "testString"
		model["region"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunAWSTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunAzureTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunAzureTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunReplicationDataStatsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["logical_size_bytes"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunReplicationDataStatsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunArchivalRunToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunArchivalRunToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunArchivalTargetResultToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunArchivalTargetResultToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunArchivalTargetTierInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunArchivalTargetTierInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunAWSTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunAWSTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunAWSTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunAWSTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunAzureTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		azureTierModel := make(map[string]interface{})
		azureTierModel["move_after_unit"] = "Days"
		azureTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunAzureTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunAzureTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunAzureTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunGoogleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		googleTierModel := make(map[string]interface{})
		googleTierModel["move_after_unit"] = "Days"
		googleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunGoogleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunGoogleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunGoogleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunOracleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		oracleTierModel := make(map[string]interface{})
		oracleTierModel["move_after_unit"] = "Days"
		oracleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunOracleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunOracleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunOracleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunArchivalDataStatsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["logical_size_bytes"] = int(26)
		model["bytes_read"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunArchivalDataStatsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunWormPropertiesToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunWormPropertiesToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunCloudSpinRunToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		customTagParamsModel := make(map[string]interface{})
		customTagParamsModel["key"] = "testString"
		customTagParamsModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunCloudSpinRunToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunCloudSpinTargetResultToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		customTagParamsModel := make(map[string]interface{})
		customTagParamsModel["key"] = "testString"
		customTagParamsModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunCloudSpinTargetResultToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunAwsCloudSpinParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		customTagParamsModel := make(map[string]interface{})
		customTagParamsModel["key"] = "testString"
		customTagParamsModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunAwsCloudSpinParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunCustomTagParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunCustomTagParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunAzureCloudSpinParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunAzureCloudSpinParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunCloudSpinDataStatsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["physical_bytes_transferred"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunCloudSpinDataStatsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunBackupRunSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		backupDataStatsModel := make(map[string]interface{})
		backupDataStatsModel["logical_size_bytes"] = int(26)
		backupDataStatsModel["bytes_written"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunBackupRunSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunReplicationRunSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTargetConfigModel := make(map[string]interface{})
		awsTargetConfigModel["region"] = int(26)
		awsTargetConfigModel["source_id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunReplicationRunSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunArchivalRunSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunArchivalRunSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunCloudSpinRunSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		customTagParamsModel := make(map[string]interface{})
		customTagParamsModel["key"] = "testString"
		customTagParamsModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunCloudSpinRunSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunTenantToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunTenantToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunExternalVendorTenantMetadataToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunExternalVendorTenantMetadataToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunIbmTenantMetadataParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunIbmTenantMetadataParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunExternalVendorCustomPropertiesToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["key"] = "testString"
		model["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunExternalVendorCustomPropertiesToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmProtectionGroupRunTenantNetworkToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmProtectionGroupRunTenantNetworkToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
