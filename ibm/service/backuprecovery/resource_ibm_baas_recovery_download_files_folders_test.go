...
func TestResourceIbmBaasRecoveryDownloadFilesFoldersDocumentObjectToMap(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersDocumentObjectToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersCommonRecoverObjectSnapshotParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersCommonRecoverObjectSnapshotParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersCommonRecoverObjectSnapshotParamsObjectInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersCommonRecoverObjectSnapshotParamsObjectInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersSharepointObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersSharepointObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersObjectSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersObjectSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersObjectTypeVCenterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersObjectTypeVCenterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersObjectTypeWindowsClusterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersObjectTypeWindowsClusterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersCommonRecoverObjectSnapshotParamsArchivalTargetInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersCommonRecoverObjectSnapshotParamsArchivalTargetInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersArchivalTargetTierInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersArchivalTargetTierInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersAWSTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersAWSTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersAWSTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersAWSTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersAzureTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		azureTierModel := make(map[string]interface{})
		azureTierModel["move_after_unit"] = "Days"
		azureTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersAzureTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersAzureTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersAzureTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersGoogleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		googleTierModel := make(map[string]interface{})
		googleTierModel["move_after_unit"] = "Days"
		googleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersGoogleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersGoogleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersGoogleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersOracleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		oracleTierModel := make(map[string]interface{})
		oracleTierModel["move_after_unit"] = "Days"
		oracleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersOracleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersOracleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersOracleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersFilesAndFoldersObjectToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersFilesAndFoldersObjectToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersMapToCommonRecoverObjectSnapshotParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersMapToCommonRecoverObjectSnapshotParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersMapToCommonRecoverObjectSnapshotParamsObjectInfo(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersMapToCommonRecoverObjectSnapshotParamsObjectInfo(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersMapToSharepointObjectParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersMapToSharepointObjectParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersMapToObjectSummary(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersMapToObjectSummary(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersMapToObjectTypeVCenterParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersMapToObjectTypeVCenterParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersMapToObjectTypeWindowsClusterParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersMapToObjectTypeWindowsClusterParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersMapToCommonRecoverObjectSnapshotParamsArchivalTargetInfo(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersMapToCommonRecoverObjectSnapshotParamsArchivalTargetInfo(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersMapToArchivalTargetTierInfo(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersMapToArchivalTargetTierInfo(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersMapToAWSTiers(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersMapToAWSTiers(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersMapToAWSTier(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersMapToAWSTier(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersMapToAzureTiers(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersMapToAzureTiers(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersMapToAzureTier(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersMapToAzureTier(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersMapToGoogleTiers(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersMapToGoogleTiers(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersMapToGoogleTier(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersMapToGoogleTier(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersMapToOracleTiers(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersMapToOracleTiers(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersMapToOracleTier(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersMapToOracleTier(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersMapToFilesAndFoldersObject(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersMapToFilesAndFoldersObject(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmBaasRecoveryDownloadFilesFoldersMapToDocumentObject(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmBaasRecoveryDownloadFilesFoldersMapToDocumentObject(model)
	assert.Nil(t, err)
	checkResult(result)
}
