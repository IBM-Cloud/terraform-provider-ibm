...
func TestDataSourceIbmRecoveriesRecoveryToMap(t *testing.T) {
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesRecoveryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesTenantToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesTenantToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesExternalVendorTenantMetadataToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesExternalVendorTenantMetadataToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesIbmTenantMetadataParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesIbmTenantMetadataParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesExternalVendorCustomPropertiesToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesExternalVendorCustomPropertiesToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesTenantNetworkToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesTenantNetworkToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesCreationInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesCreationInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesRetrieveArchiveTaskToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesRetrieveArchiveTaskToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesRecoverPhysicalParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesRecoverPhysicalParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesCommonRecoverObjectSnapshotParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesCommonRecoverObjectSnapshotParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesCommonRecoverObjectSnapshotParamsObjectInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesCommonRecoverObjectSnapshotParamsObjectInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesSharepointObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesSharepointObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesObjectSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesObjectSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesObjectTypeVCenterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesObjectTypeVCenterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesObjectTypeWindowsClusterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesObjectTypeWindowsClusterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesCommonRecoverObjectSnapshotParamsArchivalTargetInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesCommonRecoverObjectSnapshotParamsArchivalTargetInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesArchivalTargetTierInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesArchivalTargetTierInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesAWSTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesAWSTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesAWSTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesAWSTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesAzureTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		azureTierModel := make(map[string]interface{})
		azureTierModel["move_after_unit"] = "Days"
		azureTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesAzureTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesAzureTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesAzureTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesGoogleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		googleTierModel := make(map[string]interface{})
		googleTierModel["move_after_unit"] = "Days"
		googleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesGoogleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesGoogleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesGoogleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesOracleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		oracleTierModel := make(map[string]interface{})
		oracleTierModel["move_after_unit"] = "Days"
		oracleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesOracleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesOracleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesOracleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesRecoverPhysicalParamsRecoverVolumeParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalTargetParamsForRecoverVolumeMountTargetModel := make(map[string]interface{})
		physicalTargetParamsForRecoverVolumeMountTargetModel["id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesRecoverPhysicalParamsRecoverVolumeParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesRecoverPhysicalVolumeParamsPhysicalTargetParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalTargetParamsForRecoverVolumeMountTargetModel := make(map[string]interface{})
		physicalTargetParamsForRecoverVolumeMountTargetModel["id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesRecoverPhysicalVolumeParamsPhysicalTargetParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesPhysicalTargetParamsForRecoverVolumeMountTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesPhysicalTargetParamsForRecoverVolumeMountTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesRecoverVolumeMappingToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesRecoverVolumeMappingToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesPhysicalTargetParamsForRecoverVolumeVlanConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(38)
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesPhysicalTargetParamsForRecoverVolumeVlanConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesRecoverPhysicalParamsMountVolumeParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel := make(map[string]interface{})
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["username"] = "testString"
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["password"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesRecoverPhysicalParamsMountVolumeParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesMountPhysicalVolumeParamsPhysicalTargetParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel := make(map[string]interface{})
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["username"] = "testString"
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["password"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesMountPhysicalVolumeParamsPhysicalTargetParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesPhysicalTargetParamsForMountVolumeOriginalTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel := make(map[string]interface{})
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["username"] = "testString"
		physicalMountVolumesOriginalTargetConfigServerCredentialsModel["password"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesPhysicalTargetParamsForMountVolumeOriginalTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesPhysicalMountVolumesOriginalTargetConfigServerCredentialsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesPhysicalMountVolumesOriginalTargetConfigServerCredentialsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesPhysicalTargetParamsForMountVolumeNewTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		recoverTargetModel := make(map[string]interface{})
		recoverTargetModel["id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesPhysicalTargetParamsForMountVolumeNewTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesRecoverTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesRecoverTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesPhysicalMountVolumesNewTargetConfigServerCredentialsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["username"] = "testString"
		model["password"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesPhysicalMountVolumesNewTargetConfigServerCredentialsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesMountedVolumeMappingToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesMountedVolumeMappingToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesPhysicalTargetParamsForMountVolumeVlanConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(38)
		model["disable_vlan"] = true
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesPhysicalTargetParamsForMountVolumeVlanConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesRecoverPhysicalParamsRecoverFileAndFolderParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		commonRecoverFileAndFolderInfoModel := make(map[string]interface{})
		commonRecoverFileAndFolderInfoModel["absolute_path"] = "testString"
		commonRecoverFileAndFolderInfoModel["is_directory"] = true
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesRecoverPhysicalParamsRecoverFileAndFolderParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesCommonRecoverFileAndFolderInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesCommonRecoverFileAndFolderInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesRecoverPhysicalFileAndFolderParamsPhysicalTargetParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalTargetParamsForRecoverFileAndFolderRecoverTargetModel := make(map[string]interface{})
		physicalTargetParamsForRecoverFileAndFolderRecoverTargetModel["id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesRecoverPhysicalFileAndFolderParamsPhysicalTargetParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesPhysicalTargetParamsForRecoverFileAndFolderRecoverTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesPhysicalTargetParamsForRecoverFileAndFolderRecoverTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesPhysicalTargetParamsForRecoverFileAndFolderVlanConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(38)
		model["disable_vlan"] = true
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesPhysicalTargetParamsForRecoverFileAndFolderVlanConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesRecoverPhysicalParamsDownloadFileAndFolderParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		commonRecoverFileAndFolderInfoModel := make(map[string]interface{})
		commonRecoverFileAndFolderInfoModel["absolute_path"] = "testString"
		commonRecoverFileAndFolderInfoModel["is_directory"] = true
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesRecoverPhysicalParamsDownloadFileAndFolderParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesRecoverPhysicalParamsSystemRecoveryParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesRecoverPhysicalParamsSystemRecoveryParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesRecoverSqlParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesRecoverSqlParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesRecoverSqlAppParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesRecoverSqlAppParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesAAGInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesAAGInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesHostInformationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = "testString"
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesHostInformationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesSqlTargetParamsForRecoverSqlAppToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		multiStageRestoreOptionsModel := make(map[string]interface{})
		multiStageRestoreOptionsModel["enable_auto_sync"] = true
		multiStageRestoreOptionsModel["enable_multi_stage_restore"] = true
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesSqlTargetParamsForRecoverSqlAppToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesRecoverSqlAppNewSourceConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		multiStageRestoreOptionsModel := make(map[string]interface{})
		multiStageRestoreOptionsModel["enable_auto_sync"] = true
		multiStageRestoreOptionsModel["enable_multi_stage_restore"] = true
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesRecoverSqlAppNewSourceConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesMultiStageRestoreOptionsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesMultiStageRestoreOptionsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesFilenamePatternToDirectoryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesFilenamePatternToDirectoryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesRecoveryObjectIdentifierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesRecoveryObjectIdentifierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesRecoverSqlAppOriginalSourceConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		multiStageRestoreOptionsModel := make(map[string]interface{})
		multiStageRestoreOptionsModel["enable_auto_sync"] = true
		multiStageRestoreOptionsModel["enable_multi_stage_restore"] = true
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesRecoverSqlAppOriginalSourceConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmRecoveriesRecoveryVlanConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(38)
		model["disable_vlan"] = true
	...
	result, err := backuprecovery.DataSourceIbmRecoveriesRecoveryVlanConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
