		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "name"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "backup_policy.#"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "backup_policy.0.run_timeouts.#"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "backup_policy.0.storage_array_snapshot.#"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "backup_policy.0.bmr.#"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "backup_policy.0.cdp.#"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "backup_policy.0.log.#"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.#"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.full.#"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.full_backups.#"),
					resource.TestCheckResourceAttr("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.incremental.#", "1"),
					resource.TestCheckResourceAttr("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.incremental.0.schedule.#", "1"),
					resource.TestCheckResourceAttr("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.incremental.0.schedule.0.day_schedule.#", "1"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.incremental.0.schedule.0.day_schedule.0.frequency"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.incremental.0.schedule.0.hour_schedule.#"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.incremental.0.schedule.0.minute_schedule.#"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.incremental.0.schedule.0.month_schedule.#"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.incremental.0.schedule.0.week_schedule.#"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.incremental.0.schedule.0.year_schedule.#"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.incremental.0.schedule.0.unit"),
					resource.TestCheckResourceAttr("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.primary_backup_target.#", "1"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.primary_backup_target.0.archival_target_settings.#"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.primary_backup_target.0.target_type"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.primary_backup_target.0.use_default_backup_target"),
					resource.TestCheckResourceAttr("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.retention.#", "1"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.retention.0.data_lock_config.#"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.retention.0.duration"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "regular.0.retention.0.unit"),
					...
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "retry_options.0.retries"),
					resource.TestCheckResourceAttrSet("data.ibm_baas_protection_policy.baas_protection_policy_instance", "retry_options.0.retry_interval_mins"),
