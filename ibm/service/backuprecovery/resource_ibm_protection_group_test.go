...
func TestAccIbmProtectionGroupAllArgs(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIbmProtectionGroupConfig(name, policyID, priority, description, endTimeUsecs, lastModifiedTimestampUsecs, qosPolicy, abortInBlackouts, pauseInBlackouts, isPaused, environment),
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckIbmProtectionGroupExists("ibm_protection_group.protection_group_instance", conf),
					resource.TestCheckResourceAttr("ibm_protection_group.protection_group_instance", "name", name),
					resource.TestCheckResourceAttr("ibm_protection_group.protection_group_instance", "policy_id", policyID),
			...
			resource.TestStep{
				Config: testAccCheckIbmProtectionGroupConfig(nameUpdate, policyIDUpdate, priorityUpdate, descriptionUpdate, endTimeUsecsUpdate, lastModifiedTimestampUsecsUpdate, qosPolicyUpdate, abortInBlackoutsUpdate, pauseInBlackoutsUpdate, isPausedUpdate, environmentUpdate),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("ibm_protection_group.protection_group_instance", "name", nameUpdate),
					resource.TestCheckResourceAttr("ibm_protection_group.protection_group_instance", "policy_id", policyIDUpdate),
...
func testAccCheckIbmProtectionGroupConfig(name string, policyID string, priority string, description string, endTimeUsecs string, lastModifiedTimestampUsecs string, qosPolicy string, abortInBlackouts string, pauseInBlackouts string, isPaused string, environment string) string {
	return fmt.Sprintf(`
	...
	`, name, policyID, priority, description, endTimeUsecs, lastModifiedTimestampUsecs, qosPolicy, abortInBlackouts, pauseInBlackouts, isPaused, environment)
}
...
func TestResourceIbmProtectionGroupTimeOfDayToMap(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupTimeOfDayToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupProtectionGroupAlertingPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupProtectionGroupAlertingPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupAlertTargetToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupAlertTargetToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupSlaRuleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupSlaRuleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupKeyValuePairToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupKeyValuePairToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupPhysicalProtectionGroupParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupPhysicalProtectionGroupParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupPhysicalVolumeProtectionGroupParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalVolumeProtectionGroupObjectParamsModel := make(map[string]interface{})
		physicalVolumeProtectionGroupObjectParamsModel["id"] = int(26)
		physicalVolumeProtectionGroupObjectParamsModel["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupPhysicalVolumeProtectionGroupParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupPhysicalVolumeProtectionGroupObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupPhysicalVolumeProtectionGroupObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupIndexingPolicyToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupIndexingPolicyToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupPrePostScriptParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		commonPreBackupScriptParamsModel := make(map[string]interface{})
		commonPreBackupScriptParamsModel["path"] = "testString"
		commonPreBackupScriptParamsModel["params"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupPrePostScriptParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupCommonPreBackupScriptParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupCommonPreBackupScriptParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupCommonPostBackupScriptParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["path"] = "testString"
		model["params"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupCommonPostBackupScriptParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupPhysicalFileProtectionGroupParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalFileBackupPathParamsModel := make(map[string]interface{})
		physicalFileBackupPathParamsModel["included_path"] = "testString"
		physicalFileBackupPathParamsModel["excluded_paths"] = []string{"testString"}
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupPhysicalFileProtectionGroupParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupPhysicalFileProtectionGroupObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		physicalFileBackupPathParamsModel := make(map[string]interface{})
		physicalFileBackupPathParamsModel["included_path"] = "testString"
		physicalFileBackupPathParamsModel["excluded_paths"] = []string{"testString"}
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupPhysicalFileProtectionGroupObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupPhysicalFileBackupPathParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupPhysicalFileBackupPathParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupCancellationTimeoutParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupCancellationTimeoutParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMSSQLProtectionGroupParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMSSQLProtectionGroupParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMSSQLFileProtectionGroupParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		advancedSettingsModel := make(map[string]interface{})
		advancedSettingsModel["cloned_db_backup_status"] = "kError"
		advancedSettingsModel["db_backup_if_not_online_status"] = "kError"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMSSQLFileProtectionGroupParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupAdvancedSettingsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupAdvancedSettingsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupFilterToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupFilterToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMSSQLFileProtectionGroupHostParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMSSQLFileProtectionGroupHostParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMSSQLFileProtectionGroupObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMSSQLFileProtectionGroupObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMSSQLNativeProtectionGroupParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		advancedSettingsModel := make(map[string]interface{})
		advancedSettingsModel["cloned_db_backup_status"] = "kError"
		advancedSettingsModel["db_backup_if_not_online_status"] = "kError"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMSSQLNativeProtectionGroupParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMSSQLNativeProtectionGroupObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMSSQLNativeProtectionGroupObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMSSQLVolumeProtectionGroupParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		advancedSettingsModel := make(map[string]interface{})
		advancedSettingsModel["cloned_db_backup_status"] = "kError"
		advancedSettingsModel["db_backup_if_not_online_status"] = "kError"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMSSQLVolumeProtectionGroupParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMSSQLVolumeProtectionGroupHostParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["enable_system_backup"] = true
		model["host_id"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMSSQLVolumeProtectionGroupHostParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMSSQLVolumeProtectionGroupObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMSSQLVolumeProtectionGroupObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupProtectionGroupRunToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupProtectionGroupRunToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupClusterIdentifierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupClusterIdentifierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupObjectRunResultToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupObjectRunResultToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupObjectSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupObjectSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupSharepointObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupSharepointObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupObjectTypeVCenterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupObjectTypeVCenterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupObjectTypeWindowsClusterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupObjectTypeWindowsClusterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupBackupRunToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		backupDataStatsModel := make(map[string]interface{})
		backupDataStatsModel["logical_size_bytes"] = int(26)
		backupDataStatsModel["bytes_written"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupBackupRunToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupSnapshotInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		backupDataStatsModel := make(map[string]interface{})
		backupDataStatsModel["logical_size_bytes"] = int(26)
		backupDataStatsModel["bytes_written"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupSnapshotInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupBackupDataStatsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["logical_size_bytes"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupBackupDataStatsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupDataLockConstraintsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupDataLockConstraintsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupBackupAttemptToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		backupDataStatsModel := make(map[string]interface{})
		backupDataStatsModel["logical_size_bytes"] = int(26)
		backupDataStatsModel["bytes_written"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupBackupAttemptToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupReplicationRunToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTargetConfigModel := make(map[string]interface{})
		awsTargetConfigModel["region"] = int(26)
		awsTargetConfigModel["source_id"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupReplicationRunToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupReplicationTargetResultToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTargetConfigModel := make(map[string]interface{})
		awsTargetConfigModel["region"] = int(26)
		awsTargetConfigModel["source_id"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupReplicationTargetResultToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupAWSTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "testString"
		model["region"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupAWSTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupAzureTargetConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupAzureTargetConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupReplicationDataStatsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["logical_size_bytes"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupReplicationDataStatsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupArchivalRunToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupArchivalRunToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupArchivalTargetResultToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupArchivalTargetResultToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupArchivalTargetTierInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupArchivalTargetTierInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupAWSTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupAWSTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupAWSTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupAWSTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupAzureTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		azureTierModel := make(map[string]interface{})
		azureTierModel["move_after_unit"] = "Days"
		azureTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupAzureTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupAzureTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupAzureTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupGoogleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		googleTierModel := make(map[string]interface{})
		googleTierModel["move_after_unit"] = "Days"
		googleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupGoogleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupGoogleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupGoogleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupOracleTiersToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		oracleTierModel := make(map[string]interface{})
		oracleTierModel["move_after_unit"] = "Days"
		oracleTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupOracleTiersToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupOracleTierToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["move_after_unit"] = "Days"
		model["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupOracleTierToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupArchivalDataStatsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["logical_size_bytes"] = int(26)
		model["bytes_read"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupArchivalDataStatsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupWormPropertiesToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupWormPropertiesToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupCloudSpinRunToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		customTagParamsModel := make(map[string]interface{})
		customTagParamsModel["key"] = "testString"
		customTagParamsModel["value"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupCloudSpinRunToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupCloudSpinTargetResultToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		customTagParamsModel := make(map[string]interface{})
		customTagParamsModel["key"] = "testString"
		customTagParamsModel["value"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupCloudSpinTargetResultToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupAwsCloudSpinParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		customTagParamsModel := make(map[string]interface{})
		customTagParamsModel["key"] = "testString"
		customTagParamsModel["value"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupAwsCloudSpinParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupCustomTagParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["key"] = "testString"
		model["value"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupCustomTagParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupAzureCloudSpinParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupAzureCloudSpinParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupCloudSpinDataStatsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["physical_bytes_transferred"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupCloudSpinDataStatsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupBackupRunSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		backupDataStatsModel := make(map[string]interface{})
		backupDataStatsModel["logical_size_bytes"] = int(26)
		backupDataStatsModel["bytes_written"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupBackupRunSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupReplicationRunSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTargetConfigModel := make(map[string]interface{})
		awsTargetConfigModel["region"] = int(26)
		awsTargetConfigModel["source_id"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupReplicationRunSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupArchivalRunSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		awsTierModel := make(map[string]interface{})
		awsTierModel["move_after_unit"] = "Days"
		awsTierModel["move_after"] = int(26)
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupArchivalRunSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupCloudSpinRunSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		customTagParamsModel := make(map[string]interface{})
		customTagParamsModel["key"] = "testString"
		customTagParamsModel["value"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupCloudSpinRunSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupTenantToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupTenantToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupExternalVendorTenantMetadataToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupExternalVendorTenantMetadataToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupIbmTenantMetadataParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupIbmTenantMetadataParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupExternalVendorCustomPropertiesToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["key"] = "testString"
		model["value"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupExternalVendorCustomPropertiesToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupTenantNetworkToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupTenantNetworkToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMissingEntityParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = int(26)
		model["name"] = "testString"
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMissingEntityParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToTimeOfDay(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToTimeOfDay(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToProtectionGroupAlertingPolicy(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToProtectionGroupAlertingPolicy(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToAlertTarget(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToAlertTarget(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToSlaRule(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToSlaRule(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToKeyValuePair(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToKeyValuePair(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToPhysicalProtectionGroupParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToPhysicalProtectionGroupParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToPhysicalVolumeProtectionGroupParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToPhysicalVolumeProtectionGroupParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToPhysicalVolumeProtectionGroupObjectParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToPhysicalVolumeProtectionGroupObjectParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToIndexingPolicy(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToIndexingPolicy(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToPrePostScriptParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToPrePostScriptParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToCommonPreBackupScriptParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToCommonPreBackupScriptParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToCommonPostBackupScriptParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToCommonPostBackupScriptParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToPhysicalFileProtectionGroupParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToPhysicalFileProtectionGroupParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToPhysicalFileProtectionGroupObjectParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToPhysicalFileProtectionGroupObjectParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToPhysicalFileBackupPathParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToPhysicalFileBackupPathParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToCancellationTimeoutParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToCancellationTimeoutParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToMSSQLProtectionGroupParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToMSSQLProtectionGroupParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToMSSQLFileProtectionGroupParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToMSSQLFileProtectionGroupParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToAdvancedSettings(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToAdvancedSettings(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToFilter(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToFilter(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToMSSQLFileProtectionGroupHostParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToMSSQLFileProtectionGroupHostParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToMSSQLFileProtectionGroupObjectParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToMSSQLFileProtectionGroupObjectParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToMSSQLNativeProtectionGroupParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToMSSQLNativeProtectionGroupParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToMSSQLNativeProtectionGroupObjectParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToMSSQLNativeProtectionGroupObjectParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToMSSQLVolumeProtectionGroupParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToMSSQLVolumeProtectionGroupParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToMSSQLVolumeProtectionGroupHostParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToMSSQLVolumeProtectionGroupHostParams(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestResourceIbmProtectionGroupMapToMSSQLVolumeProtectionGroupObjectParams(t *testing.T) {
	...
	result, err := backuprecovery.ResourceIbmProtectionGroupMapToMSSQLVolumeProtectionGroupObjectParams(model)
	assert.Nil(t, err)
	checkResult(result)
}
