...
func TestAccIbmSourceRegistrationsDataSourceBasic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIbmSourceRegistrationsDataSourceConfigBasic(sourceRegistrationReponseParamsEnvironment),
...
func TestAccIbmSourceRegistrationsDataSourceAllArgs(t *testing.T) {
	sourceRegistrationReponseParamsEnvironment := "kPhysical"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIbmSourceRegistrationsDataSourceConfig(sourceRegistrationReponseParamsEnvironment, sourceRegistrationReponseParamsName, sourceRegistrationReponseParamsConnectionID, sourceRegistrationReponseParamsConnectorGroupID, sourceRegistrationReponseParamsDataSourceConnectionID),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.ibm_source_registrations.source_registrations_instance", "id"),
					resource.TestCheckResourceAttrSet("data.ibm_source_registrations.source_registrations_instance", "ids"),
					resource.TestCheckResourceAttrSet("data.ibm_source_registrations.source_registrations_instance", "include_source_credentials"),
					resource.TestCheckResourceAttrSet("data.ibm_source_registrations.source_registrations_instance", "encryption_key"),
					resource.TestCheckResourceAttrSet("data.ibm_source_registrations.source_registrations_instance", "use_cached_data"),
					resource.TestCheckResourceAttrSet("data.ibm_source_registrations.source_registrations_instance", "include_external_metadata"),
					resource.TestCheckResourceAttrSet("data.ibm_source_registrations.source_registrations_instance", "ignore_tenant_migration_in_progress_check"),
					resource.TestCheckResourceAttrSet("data.ibm_source_registrations.source_registrations_instance", "registrations.#"),
					resource.TestCheckResourceAttrSet("data.ibm_source_registrations.source_registrations_instance", "registrations.0.id"),
					resource.TestCheckResourceAttrSet("data.ibm_source_registrations.source_registrations_instance", "registrations.0.source_id"),
					resource.TestCheckResourceAttr("data.ibm_source_registrations.source_registrations_instance", "registrations.0.environment", sourceRegistrationReponseParamsEnvironment),
					resource.TestCheckResourceAttr("data.ibm_source_registrations.source_registrations_instance", "registrations.0.name", sourceRegistrationReponseParamsName),
					resource.TestCheckResourceAttr("data.ibm_source_registrations.source_registrations_instance", "registrations.0.connection_id", sourceRegistrationReponseParamsConnectionID),
					resource.TestCheckResourceAttr("data.ibm_source_registrations.source_registrations_instance", "registrations.0.connector_group_id", sourceRegistrationReponseParamsConnectorGroupID),
					resource.TestCheckResourceAttr("data.ibm_source_registrations.source_registrations_instance", "registrations.0.data_source_connection_id", sourceRegistrationReponseParamsDataSourceConnectionID),
					resource.TestCheckResourceAttrSet("data.ibm_source_registrations.source_registrations_instance", "registrations.0.authentication_status"),
					resource.TestCheckResourceAttrSet("data.ibm_source_registrations.source_registrations_instance", "registrations.0.registration_time_msecs"),
					resource.TestCheckResourceAttrSet("data.ibm_source_registrations.source_registrations_instance", "registrations.0.last_refreshed_time_msecs"),
				),
			},
		},
	})
...
func testAccCheckIbmSourceRegistrationsDataSourceConfigBasic(sourceRegistrationReponseParamsEnvironment string) string {
	return fmt.Sprintf(`
...
func TestDataSourceIbmSourceRegistrationsSourceRegistrationReponseParamsToMap(t *testing.T) {
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsSourceRegistrationReponseParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsObjectToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsObjectToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsSharepointObjectParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsSharepointObjectParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsObjectSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		sharepointObjectParamsModel := make(map[string]interface{})
		sharepointObjectParamsModel["site_web_url"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsObjectSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsObjectTypeVCenterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsObjectTypeVCenterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsObjectTypeWindowsClusterParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsObjectTypeWindowsClusterParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsObjectProtectionStatsSummaryToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["environment"] = "kPhysical"
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsObjectProtectionStatsSummaryToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsPermissionInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		userModel := make(map[string]interface{})
		userModel["name"] = "testString"
		userModel["sid"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsPermissionInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsUserToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsUserToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsGroupToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "testString"
		model["sid"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsGroupToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsTenantToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsTenantToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsExternalVendorTenantMetadataToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsExternalVendorTenantMetadataToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsIbmTenantMetadataParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		externalVendorCustomPropertiesModel := make(map[string]interface{})
		externalVendorCustomPropertiesModel["key"] = "testString"
		externalVendorCustomPropertiesModel["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsIbmTenantMetadataParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsExternalVendorCustomPropertiesToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsExternalVendorCustomPropertiesToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsTenantNetworkToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsTenantNetworkToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsObjectMssqlParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		aagInfoModel := make(map[string]interface{})
		aagInfoModel["name"] = "testString"
		aagInfoModel["object_id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsObjectMssqlParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsAAGInfoToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["name"] = "testString"
		model["object_id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsAAGInfoToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsHostInformationToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["id"] = "testString"
		model["name"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsHostInformationToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsObjectPhysicalParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsObjectPhysicalParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsConnectionConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["connection_id"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsConnectionConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsKeyValuePairToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["key"] = "testString"
		model["value"] = "testString"
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsKeyValuePairToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsEntityExternalMetadataToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		timeRangeUsecsModel := make(map[string]interface{})
		timeRangeUsecsModel["end_time_usecs"] = int(26)
		timeRangeUsecsModel["start_time_usecs"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsEntityExternalMetadataToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsMaintenanceModeConfigToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		timeRangeUsecsModel := make(map[string]interface{})
		timeRangeUsecsModel["end_time_usecs"] = int(26)
		timeRangeUsecsModel["start_time_usecs"] = int(26)
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsMaintenanceModeConfigToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsTimeRangeUsecsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsTimeRangeUsecsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsScheduleToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		timeModel := make(map[string]interface{})
		timeModel["hour"] = int(38)
		timeModel["minute"] = int(38)
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsScheduleToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsTimeWindowToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		timeModel := make(map[string]interface{})
		timeModel["hour"] = int(38)
		timeModel["minute"] = int(38)
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsTimeWindowToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsTimeToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
		model["hour"] = int(38)
		model["minute"] = int(38)
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsTimeToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsWorkflowInterventionSpecToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsWorkflowInterventionSpecToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}

func TestDataSourceIbmSourceRegistrationsPhysicalSourceRegistrationParamsToMap(t *testing.T) {
	checkResult := func(result map[string]interface{}) {
		model := make(map[string]interface{})
	...
	result, err := backuprecovery.DataSourceIbmSourceRegistrationsPhysicalSourceRegistrationParamsToMap(model)
	assert.Nil(t, err)
	checkResult(result)
}
