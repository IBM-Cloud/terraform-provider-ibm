				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"filepath": {
							Type:        schema.TypeString,
							Required:    true,
							Description: "The filepath to store the ",
						},
						"passphrase": {
							Type:        schema.TypeString,
							Required:    true,
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"filepaths": {
							Type:        schema.TypeSet,
							Required:    true,
							Description: "The filepaths to store the shares of the backup key",
						},
						"keyname": {
							Type:        schema.TypeString,
							Required:    true,
...
func resourceIBMKmsCryptoUnitsCreate(d *schema.ResourceData, meta interface{}) error {
