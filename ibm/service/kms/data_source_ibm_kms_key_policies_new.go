...
var (
	_ datasource.DataSourceWithConfigure = &KMSKeyPoliciesDataSource{}
	_ datasource.DataSource              = &KMSKeyPoliciesDataSource{}
)
...
func NewKMSKeyPoliciesDataSource() datasource.DataSource {
	return &KMSKeyPoliciesDataSource{}
}

func (d *KMSKeyPoliciesDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_kms_key_policies_new"
}

func (d *KMSKeyPoliciesDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *KMSKeyPoliciesDataSource) Schema(_ context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
