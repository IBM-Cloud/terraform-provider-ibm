...
var (
	_ datasource.DataSourceWithConfigure = &KMSKeyDataSource{}
	_ datasource.DataSource              = &KMSKeyDataSource{}
)
...
func (d *KMSKeyDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_kms_key_new"
}

func (d *KMSKeyDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *KMSKeyDataSource) Schema(_ context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
