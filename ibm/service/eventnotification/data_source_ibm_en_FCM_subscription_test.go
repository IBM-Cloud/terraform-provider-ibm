...
func TestAccIBMEnFCMSubscriptionDataSourceAllArgs(t *testing.T) {
...
func testAccCheckIBMEnFCMSubscriptionDataSourceConfig(instanceName, name, description string) string {
	return fmt.Sprintf(`
