...
func TestAccIBMEnAPNSDestinationDataSourceBasic(t *testing.T) {
...
func testAccCheckIBMEnAPNSDestinationDataSourceConfigBasic(instanceName, name, description string) string {
	return fmt.Sprintf(`
