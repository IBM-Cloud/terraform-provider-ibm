...
func TestAccIBMEnSMTPUserDataSourceBasic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIBMEnSMTPUserDataSourceConfigBasic(smtpUserInstanceID),
...
func testAccCheckIBMEnSMTPUserDataSourceConfigBasic(smtpUserInstanceID string) string {
	return fmt.Sprintf(`
