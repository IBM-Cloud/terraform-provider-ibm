...
func resourceIBMISVPCValidator() *ResourceValidator {
	...
	validateSchema = append(validateSchema, ValidateSchema{Identifier: isVPCAddressPrefixManagement, ValidateFunctionIdentifier: ValidateAllowedStringValue, Type: TypeStringList, Optional: true, Default: "auto", AllowedValues: address_prefix_management})
