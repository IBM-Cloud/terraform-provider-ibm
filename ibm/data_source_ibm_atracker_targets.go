...
func dataSourceIBMAtrackerTargetsRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		log.Printf("[DEBUG] ListTargets failed %s\n%s", err, response)
		return err
	}
...
func dataSourceTargetListTargetsToMap(targetsItem atrackerv1.Target) (targetsMap map[string]interface{}) {
	...
	if targetsItem.InstanceID != nil {
		targetsMap["instance_id"] = targetsItem.InstanceID
	}
