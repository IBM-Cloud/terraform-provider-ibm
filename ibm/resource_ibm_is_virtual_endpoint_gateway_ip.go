...
const (
	isVirtualEndpointGatewayID                   = "gateway_id"
	isVirtualEndpointGatewayIPID                 = "reserved_ip_id"
...
func resourceIBMisVirtualEndpointGatewayIPRead(d *schema.ResourceData, meta interface{}) error {
	...
	d.Set(isVirtualEndpointGatewayIPTarget,
		flattenEndpointGatewayIPTarget(result.Target.(*vpcscoped.ReservedIPTarget)))
	return nil
}
...
func flattenEndpointGatewayIPTarget(target *vpcscoped.ReservedIPTarget) interface{} {
