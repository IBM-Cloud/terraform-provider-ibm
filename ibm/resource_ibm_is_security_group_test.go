...
func TestAccIBMISSecurityGroup_basic(t *testing.T) {
	...
	vpcname := fmt.Sprintf("terraformsecurityuat-vpc-%d", acctest.RandIntRange(10, 100))
	name1 := fmt.Sprintf("terraformsecurityuat-create-step-name-%d", acctest.RandIntRange(10, 100))
