...
func TestAccIBMIsLbPoolMembersDataSourceBasic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccCheckIBMIsLbPoolMembersDataSourceConfigBasic(vpcname, subnetname, ISZoneName, ISCIDR, name, poolName, port, address),
...
func testAccCheckIBMIsLbPoolMembersDataSourceConfigBasic(vpcname, subnetname, zone, cidr, name, poolName, port, address string) string {
	return testAccCheckIBMISLBPoolMemberConfig(vpcname, subnetname, ISZoneName, ISCIDR, name, poolName, port, address) + fmt.Sprintf(`
