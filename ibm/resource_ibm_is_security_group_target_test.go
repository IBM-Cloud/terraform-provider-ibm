...
func TestAccIBMISSecurityGroupTarget_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCheckIBMISsecurityGroupTargetConfig(vpcname, subnetname, ISZoneName, ISCIDR, lbname, name),
...
resource "ibm_is_security_group_target" "testacc_security_group_target" {
    security_group_id = ibm_is_security_group.testacc_security_group_one.id
