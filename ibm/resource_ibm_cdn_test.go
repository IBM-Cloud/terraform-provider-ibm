		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					//testAccCheckIBMDNSDomainAttributes(&cdn),
					//saveIBMDNSDomainId(&cdn, &firstCdnId),
...
func testAccCheckIBMCDNExists(n string, cdn *datatypes.Network_CdnMarketplace_Configuration_Mapping) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		//service2 := services.GetDnsDomainServic
		//found_Id2 :=
		if err != nil {
			return err
		}
		a := *foundId[0].UniqueId
		if a != rs.Primary.ID {
			return errors.New("Record not found")
		}
		log.Println("id found......................id found........id found.......")
		//if strconv.Itoa(int(*foundId.Id)) != rs.Primary.ID {
		//	return errors.New("Record not found")
		//}
		//*cdn = foundId
