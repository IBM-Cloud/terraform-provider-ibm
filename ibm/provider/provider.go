...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"ibm_toolchain_tool_secretsmanager":      toolchain.ResourceIBMToolchainToolSecretsmanager(),
			...
			"ibm_toolchain_tool_devopsinsights":      toolchain.ResourceIBMToolchainToolDevopsinsights(),
			...
			"ibm_toolchain_tool_securitycompliance":  toolchain.ResourceIBMToolchainToolSecuritycompliance(),
			"ibm_toolchain_tool_privateworker":       toolchain.ResourceIBMToolchainToolPrivateworker(),
			"ibm_toolchain_tool_appconfig":           toolchain.ResourceIBMToolchainToolAppconfig(),
			"ibm_toolchain_tool_jenkins":             toolchain.ResourceIBMToolchainToolJenkins(),
			"ibm_toolchain_tool_jira":                toolchain.ResourceIBMToolchainToolJira(),
			"ibm_toolchain_tool_nexus":               toolchain.ResourceIBMToolchainToolNexus(),
			"ibm_toolchain_tool_pagerduty":           toolchain.ResourceIBMToolchainToolPagerduty(),
			"ibm_toolchain_tool_rationalteamconcert": toolchain.ResourceIBMToolchainToolRationalteamconcert(),
			"ibm_toolchain_tool_saucelabs":           toolchain.ResourceIBMToolchainToolSaucelabs(),
		},
	...
	initOnce.Do(func() {
		globalValidatorDict = validate.ValidatorDict{
			ResourceValidatorDictionary: map[string]*validate.ResourceValidator{
				...
				"ibm_toolchain_tool_secretsmanager":      toolchain.ResourceIBMToolchainToolSecretsmanagerValidator(),
				...
				"ibm_toolchain_tool_devopsinsights":      toolchain.ResourceIBMToolchainToolDevopsinsightsValidator(),
				...
				"ibm_toolchain_tool_securitycompliance":  toolchain.ResourceIBMToolchainToolSecuritycomplianceValidator(),
				"ibm_toolchain_tool_privateworker":       toolchain.ResourceIBMToolchainToolPrivateworkerValidator(),
				"ibm_toolchain_tool_appconfig":           toolchain.ResourceIBMToolchainToolAppconfigValidator(),
				"ibm_toolchain_tool_jenkins":             toolchain.ResourceIBMToolchainToolJenkinsValidator(),
				"ibm_toolchain_tool_jira":                toolchain.ResourceIBMToolchainToolJiraValidator(),
				"ibm_toolchain_tool_nexus":               toolchain.ResourceIBMToolchainToolNexusValidator(),
				"ibm_toolchain_tool_pagerduty":           toolchain.ResourceIBMToolchainToolPagerdutyValidator(),
				"ibm_toolchain_tool_rationalteamconcert": toolchain.ResourceIBMToolchainToolRationalteamconcertValidator(),
				"ibm_toolchain_tool_saucelabs":           toolchain.ResourceIBMToolchainToolSaucelabsValidator(),
			},
