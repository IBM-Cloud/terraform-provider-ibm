...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"ibm_is_private_path_service_gateway_endpoint_gateway_binding_permit": vpc.ResourceIBMIsPrivatePathServiceGatewayEndpointGatewayBindingPermit(),
			"ibm_is_private_path_service_gateway_endpoint_gateway_binding_deny":   vpc.ResourceIBMIsPrivatePathServiceGatewayEndpointGatewayBindingDeny(),
