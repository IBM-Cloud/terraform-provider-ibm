...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"ibm_sm_configuration_public_certificate_cis":                    secretsmanager.AddInstanceFields(secretsmanager.ResourceIbmSmConfigurationPublicCertificateCis()),
			"ibm_sm_configuration_public_certificate_classic_infrastructure": secretsmanager.AddInstanceFields(secretsmanager.ResourceIbmSmConfigurationPublicCertificateClassicInfrastructure()),
	...
	initOnce.Do(func() {
		globalValidatorDict = validate.ValidatorDict{
			ResourceValidatorDictionary: map[string]*validate.ResourceValidator{
				...
				"ibm_sm_configuration_public_certificate_cis":                    secretsmanager.ResourceIbmSmConfigurationPublicCertificateCisValidator(),
				"ibm_sm_configuration_public_certificate_classic_infrastructure": secretsmanager.ResourceIbmSmConfigurationPublicCertificateClassicInfrastructureValidator(),
			},
