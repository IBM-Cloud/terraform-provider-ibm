...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"ibm_is_image_export":                    vpc.DataSourceIBMIsImageExport(),
			"ibm_is_image_exports":                   vpc.DataSourceIBMIsImageExports(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"ibm_is_image_export":                                vpc.ResourceIBMIsImageExport(),
	...
	initOnce.Do(func() {
		globalValidatorDict = validate.ValidatorDict{
			ResourceValidatorDictionary: map[string]*validate.ResourceValidator{
				...
				"ibm_is_image_export":                      vpc.ResourceIBMIsImageExportValidator(),
