...
// GetPriceIdByPackageId return the priceids of the items according to the location group ids of the datacenter u specify
func GetPriceIdByPackageId(addon string, listofpriceids []int, sess *session.Session, packageid int) (int, error) {
