...
// WithGeneration adds the generation to the get volumes params
func (o *GetVolumesParams) WithGeneration(generation int64) *GetVolumesParams {
	o.SetGeneration(generation)
	return o
}

// SetGeneration adds the generation to the get volumes params
func (o *GetVolumesParams) SetGeneration(generation int64) {
