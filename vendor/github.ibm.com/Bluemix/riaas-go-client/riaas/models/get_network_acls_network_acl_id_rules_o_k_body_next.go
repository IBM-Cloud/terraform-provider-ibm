...
func (m *GetNetworkAclsNetworkACLIDRulesOKBodyNext) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetNetworkAclsNetworkACLIDRulesOKBodyNext) validateHref(formats strfmt.Registry) error {
...
func (m *GetNetworkAclsNetworkACLIDRulesOKBodyNext) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetNetworkAclsNetworkACLIDRulesOKBodyNext) UnmarshalBinary(b []byte) error {
