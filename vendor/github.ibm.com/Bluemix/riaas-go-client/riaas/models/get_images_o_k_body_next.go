...
func (m *GetImagesOKBodyNext) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetImagesOKBodyNext) validateHref(formats strfmt.Registry) error {
...
func (m *GetImagesOKBodyNext) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetImagesOKBodyNext) UnmarshalBinary(b []byte) error {
