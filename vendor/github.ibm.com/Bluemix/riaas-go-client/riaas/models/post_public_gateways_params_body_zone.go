...
func (m *PostPublicGatewaysParamsBodyZone) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostPublicGatewaysParamsBodyZone) validateName(formats strfmt.Registry) error {
...
func (m *PostPublicGatewaysParamsBodyZone) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PostPublicGatewaysParamsBodyZone) UnmarshalBinary(b []byte) error {
