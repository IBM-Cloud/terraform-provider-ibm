...
variable "iam_trusted_profiles_claim_rule_cr_type" {
...
variable "iam_trusted_profiles_claim_rule_expiration" {
...
variable "data_source_iam_trusted_profiles_claim_rule_profile_id" {
  description = "ID of the trusted profile."
  type        = string
  default     = "profile_id"
}
variable "iam_trusted_profiles_claim_rule_rule_id" {
