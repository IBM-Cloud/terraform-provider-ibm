...
output "ibm_tekton_pipeline_definition" {
  value       = ibm_tekton_pipeline_definition.tekton_pipeline_definition_instance
...
// Modify this if only certain data should be exposed
output "ibm_tekton_pipeline_trigger_property" {
  value       = ibm_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property_instance
...
// Modify this if only certain data should be exposed
output "ibm_tekton_pipeline_trigger" {
