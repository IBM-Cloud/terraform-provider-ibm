...
// Resource arguments for baas_connection_registration_token
variable "baas_connection_registration_token_connection_id" {
  description = "Specifies the ID of the connection, connectors belonging to which are to be fetched."
  type        = string
  default     = "connection_id"
}
variable "baas_connection_registration_token_x_ibm_tenant_id" {
...
variable "baas_protection_group_run_request_run_type" {
...
// Resource arguments for baas_data_source_connection
variable "baas_data_source_connection_x_ibm_tenant_id" {
  description = "Id of the tenant accessing the cluster."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_data_source_connection_connection_name" {
...
variable "baas_recovery_download_files_folders_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_recovery_download_files_folders_name" {
  description = "Specifies the name of the recovery task. This field must be set and must be a unique name."
  type        = string
  default     = "name"
}
variable "baas_recovery_download_files_folders_parent_recovery_id" {
...
variable "baas_recovery_download_files_folders_glacier_retrieval_type" {
...
// Resource arguments for baas_restore_points
variable "baas_restore_points_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_restore_points_end_time_usecs" {
  description = "Specifies the end time specified as a Unix epoch Timestamp in microseconds."
  type        = number
  default     = 12
}
variable "baas_restore_points_environment" {
  description = "Specifies the protection source environment type."
  type        = string
  default     = "kVMware"
}
variable "baas_restore_points_protection_group_ids" {
  description = "Specifies the jobs for which to get the full snapshot information."
  type        = list(string)
  default     = [ "protectionGroupIds" ]
}
variable "baas_restore_points_source_id" {
  description = "Specifies the id of the Protection Source which is to be restored."
  type        = number
  default     = 1
}
variable "baas_restore_points_start_time_usecs" {
  description = "Specifies the start time specified as a Unix epoch Timestamp in microseconds."
  type        = number
  default     = 14
}

// Resource arguments for baas_perform_action_on_protection_group_run_request
variable "baas_perform_action_on_protection_group_run_request_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_perform_action_on_protection_group_run_request_action" {
  description = "Specifies the type of the action which will be performed on protection runs."
  type        = string
  default     = "Pause"
}

// Resource arguments for baas_protection_group
variable "baas_protection_group_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_protection_group_name" {
  description = "Specifies the name of the Protection Group."
  type        = string
  default     = "name"
}
variable "baas_protection_group_policy_id" {
...
variable "baas_protection_group_priority" {
  description = "Specifies the priority of the Protection Group."
  type        = string
  default     = "kLow"
}
variable "baas_protection_group_description" {
  description = "Specifies a description of the Protection Group."
  type        = string
  default     = "description"
}
variable "baas_protection_group_end_time_usecs" {
...
variable "baas_protection_group_last_modified_timestamp_usecs" {
...
variable "baas_protection_group_qos_policy" {
  description = "Specifies whether the Protection Group will be written to HDD or SSD."
  type        = string
  default     = "kBackupHDD"
}
variable "baas_protection_group_abort_in_blackouts" {
...
variable "baas_protection_group_pause_in_blackouts" {
...
variable "baas_protection_group_is_paused" {
...
variable "baas_protection_group_environment" {
  description = "Specifies the environment of the Protection Group."
  type        = string
  default     = "kPhysical"
}

// Resource arguments for baas_protection_policy
variable "baas_protection_policy_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_protection_policy_name" {
  description = "Specifies the name of the Protection Policy."
  type        = string
  default     = "name"
}
variable "baas_protection_policy_description" {
  description = "Specifies the description of the Protection Policy."
  type        = string
  default     = "description"
}
variable "baas_protection_policy_data_lock" {
  description = "This field is now deprecated. Please use the DataLockConfig in the backup retention."
  type        = string
  default     = "Compliance"
}
variable "baas_protection_policy_version" {
...
variable "baas_protection_policy_is_cbs_enabled" {
...
variable "baas_protection_policy_last_modification_time_usecs" {
...
variable "baas_protection_policy_template_id" {
...
// Resource arguments for baas_recovery
variable "baas_recovery_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_recovery_request_initiator_type" {
...
variable "baas_recovery_name" {
  description = "Specifies the name of the Recovery."
  type        = string
  default     = "name"
}
variable "baas_recovery_snapshot_environment" {
  description = "Specifies the type of snapshot environment for which the Recovery was performed."
  type        = string
  default     = "kPhysical"
}

// Resource arguments for baas_search_indexed_object
variable "baas_search_indexed_object_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_search_indexed_object_protection_group_ids" {
...
variable "baas_search_indexed_object_storage_domain_ids" {
...
variable "baas_search_indexed_object_tenant_id" {
  description = "TenantId contains id of the tenant for which objects are to be returned."
  type        = string
  default     = "tenant_id"
}
variable "baas_search_indexed_object_include_tenants" {
...
variable "baas_search_indexed_object_must_have_snapshot_tag_ids" {
  description = "Specifies snapshot tags which must be all present in the document."
  type        = list(string)
  default     = [ "mustHaveSnapshotTagIds" ]
}
variable "baas_search_indexed_object_might_have_snapshot_tag_ids" {
...
variable "baas_search_indexed_object_pagination_cookie" {
...
// Resource arguments for baas_source_registration
variable "baas_source_registration_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_source_registration_environment" {
  description = "Specifies the environment type of the Protection Source."
  type        = string
  default     = "kPhysical"
}
variable "baas_source_registration_name" {
  description = "The user specified name for this source."
  type        = string
  default     = "name"
}
variable "baas_source_registration_connection_id" {
...
variable "baas_source_registration_connector_group_id" {
  description = "Specifies the connector group id of connector groups."
  type        = number
  default     = 1
}
variable "baas_source_registration_data_source_connection_id" {
...
// Resource arguments for baas_update_protection_group_run_request
variable "baas_update_protection_group_run_request_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}

// Data source arguments for baas_agent_upgrade_tasks
variable "baas_agent_upgrade_tasks_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_agent_upgrade_tasks_ids" {
...
variable "baas_data_source_connections_connection_ids" {
  description = "Specifies the unique IDs of the connections which are to be fetched."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_data_source_connections_connection_names" {
  description = "Specifies the names of the connections which are to be fetched."
  type        = list(string)
  default     = [ "placeholder" ]
}

// Data source arguments for baas_data_source_connectors
variable "baas_data_source_connectors_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_data_source_connectors_connector_ids" {
  description = "Specifies the unique IDs of the connectors which are to be fetched."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_data_source_connectors_connector_names" {
  description = "Specifies the names of the connectors which are to be fetched."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_data_source_connectors_connection_id" {
  description = "Specifies the ID of the connection, connectors belonging to which are to be fetched."
  type        = string
  default     = "placeholder"
}
...
variable "baas_object_snapshots_baas_object_snapshots_id" {
  description = "Specifies the id of the Object."
  type        = number
  default     = 2
}
variable "baas_object_snapshots_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_object_snapshots_from_time_usecs" {
...
variable "baas_object_snapshots_to_time_usecs" {
...
variable "baas_object_snapshots_run_start_from_time_usecs" {
...
variable "baas_object_snapshots_run_start_to_time_usecs" {
...
variable "baas_object_snapshots_protection_group_ids" {
...
variable "baas_object_snapshots_run_instance_ids" {
...
variable "baas_object_snapshots_region_ids" {
  description = "Filter by a list of region IDs."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_object_snapshots_object_action_keys" {
...
// Data source arguments for baas_search_objects
variable "baas_search_objects_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_search_objects_request_initiator_type" {
  description = "Specifies the type of request from UI, which is used for services like magneto to determine the priority of requests."
  type        = string
  default     = "placeholder"
}
variable "baas_search_objects_search_string" {
...
variable "baas_search_objects_environments" {
  description = "Specifies the environment type to filter objects."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_search_objects_protection_types" {
  description = "Specifies the protection type to filter objects."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_search_objects_protection_group_ids" {
...
variable "baas_search_objects_source_uuids" {
...
variable "baas_search_objects_is_protected" {
...
variable "baas_search_objects_is_deleted" {
...
variable "baas_search_objects_last_run_status_list" {
...
variable "baas_search_objects_cluster_identifiers" {
...
variable "baas_search_objects_include_deleted_objects" {
...
variable "baas_search_objects_pagination_cookie" {
  description = "Specifies the pagination cookie with which subsequent parts of the response can be fetched."
  type        = string
  default     = "placeholder"
}
variable "baas_search_objects_count" {
  description = "Specifies the number of objects to be fetched for the specified pagination cookie."
  type        = number
  default     = 0
}
variable "baas_search_objects_must_have_tag_ids" {
  description = "Specifies tags which must be all present in the document."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_search_objects_might_have_tag_ids" {
  description = "Specifies list of tags, one or more of which might be present in the document. These are OR'ed together and the resulting criteria AND'ed with the rest of the query."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_search_objects_must_have_snapshot_tag_ids" {
  description = "Specifies snapshot tags which must be all present in the document."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_search_objects_might_have_snapshot_tag_ids" {
  description = "Specifies list of snapshot tags, one or more of which might be present in the document. These are OR'ed together and the resulting criteria AND'ed with the rest of the query."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_search_objects_tag_search_name" {
...
// Data source arguments for baas_search_protected_objects
variable "baas_search_protected_objects_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_search_protected_objects_request_initiator_type" {
  description = "Specifies the type of request from UI, which is used for services like magneto to determine the priority of requests."
  type        = string
  default     = "placeholder"
}
variable "baas_search_protected_objects_search_string" {
...
variable "baas_search_protected_objects_environments" {
  description = "Specifies the environment type to filter objects."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_search_protected_objects_snapshot_actions" {
  description = "Specifies a list of recovery actions. Only snapshots that applies to these actions will be returned."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_search_protected_objects_object_action_key" {
...
variable "baas_search_protected_objects_protection_group_ids" {
  description = "Specifies a list of Protection Group ids to filter the objects. If specified, the objects protected by specified Protection Group ids will be returned."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_search_protected_objects_object_ids" {
  description = "Specifies a list of Object ids to filter."
  type        = list(number)
  default     = [ 0 ]
}
variable "baas_search_protected_objects_sub_result_size" {
  description = "Specifies the size of objects to be fetched for a single subresult."
  type        = number
  default     = 0
}
variable "baas_search_protected_objects_filter_snapshot_from_usecs" {
...
variable "baas_search_protected_objects_filter_snapshot_to_usecs" {
...
variable "baas_search_protected_objects_os_types" {
  description = "Specifies the operating system types to filter objects on."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_search_protected_objects_source_ids" {
  description = "Specifies a list of Protection Source object ids to filter the objects. If specified, the object which are present in those Sources will be returned."
  type        = list(number)
  default     = [ 0 ]
}
variable "baas_search_protected_objects_run_instance_ids" {
...
variable "baas_search_protected_objects_cdp_protected_only" {
  description = "Specifies whether to only return the CDP protected objects."
  type        = bool
  default     = false
}
variable "baas_search_protected_objects_use_cached_data" {
...
// Data source arguments for baas_protection_group
variable "data_baas_protection_group_baas_protection_group_id" {
  description = "Specifies a unique id of the Protection Group."
  type        = string
  default     = "baas_protection_group_id"
}
variable "data_baas_protection_group_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "data_baas_protection_group_request_initiator_type" {
  description = "Specifies the type of request from UI, which is used for services like magneto to determine the priority of requests."
  type        = string
  default     = "placeholder"
}
variable "data_baas_protection_group_include_last_run_info" {
...
variable "data_baas_protection_group_prune_excluded_source_ids" {
...
variable "data_baas_protection_group_prune_source_ids" {
  description = "If true, the response will exclude the list of source IDs within the group specified."
  type        = bool
  default     = false
}

// Data source arguments for baas_protection_groups
variable "baas_protection_groups_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_protection_groups_request_initiator_type" {
  description = "Specifies the type of request from UI, which is used for services like magneto to determine the priority of requests."
  type        = string
  default     = "placeholder"
}
variable "baas_protection_groups_ids" {
  description = "Filter by a list of Protection Group ids."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_protection_groups_names" {
  description = "Filter by a list of Protection Group names."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_protection_groups_policy_ids" {
...
variable "baas_protection_groups_include_groups_with_datalock_only" {
  description = "Whether to only return Protection Groups with a datalock."
  type        = bool
  default     = false
}
variable "baas_protection_groups_environments" {
...
variable "baas_protection_groups_is_active" {
...
variable "baas_protection_groups_is_deleted" {
...
variable "baas_protection_groups_is_paused" {
...
variable "baas_protection_groups_last_run_local_backup_status" {
...
variable "baas_protection_groups_last_run_replication_status" {
  description = "Filter by last remote replication run status.<br> 'Running' indicates that the run is still running.<br> 'Canceled' indicates that the run has been canceled.<br> 'Canceling' indicates that the run is in the process of being canceled.<br> 'Failed' indicates that the run has failed.<br> 'Missed' indicates that the run was unable to take place at the scheduled time because the previous run was still happening.<br> 'Succeeded' indicates that the run has finished successfully.<br> 'SucceededWithWarning' indicates that the run finished successfully, but there were some warning messages.<br> 'Paused' indicates that the ongoing run has been paused.<br> 'Skipped' indicates that the run was skipped."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_protection_groups_last_run_archival_status" {
  description = "Filter by last cloud archival run status.<br> 'Running' indicates that the run is still running.<br> 'Canceled' indicates that the run has been canceled.<br> 'Canceling' indicates that the run is in the process of being canceled.<br> 'Failed' indicates that the run has failed.<br> 'Missed' indicates that the run was unable to take place at the scheduled time because the previous run was still happening.<br> 'Succeeded' indicates that the run has finished successfully.<br> 'SucceededWithWarning' indicates that the run finished successfully, but there were some warning messages.<br> 'Paused' indicates that the ongoing run has been paused.<br> 'Skipped' indicates that the run was skipped."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_protection_groups_last_run_cloud_spin_status" {
  description = "Filter by last cloud spin run status.<br> 'Running' indicates that the run is still running.<br> 'Canceled' indicates that the run has been canceled.<br> 'Canceling' indicates that the run is in the process of being canceled.<br> 'Failed' indicates that the run has failed.<br> 'Missed' indicates that the run was unable to take place at the scheduled time because the previous run was still happening.<br> 'Succeeded' indicates that the run has finished successfully.<br> 'SucceededWithWarning' indicates that the run finished successfully, but there were some warning messages.<br> 'Paused' indicates that the ongoing run has been paused.<br> 'Skipped' indicates that the run was skipped."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_protection_groups_last_run_any_status" {
  description = "Filter by last any run status.<br> 'Running' indicates that the run is still running.<br> 'Canceled' indicates that the run has been canceled.<br> 'Canceling' indicates that the run is in the process of being canceled.<br> 'Failed' indicates that the run has failed.<br> 'Missed' indicates that the run was unable to take place at the scheduled time because the previous run was still happening.<br> 'Succeeded' indicates that the run has finished successfully.<br> 'SucceededWithWarning' indicates that the run finished successfully, but there were some warning messages.<br> 'Paused' indicates that the ongoing run has been paused.<br> 'Skipped' indicates that the run was skipped."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_protection_groups_is_last_run_sla_violated" {
  description = "If true, return Protection Groups for which last run SLA was violated."
  type        = bool
  default     = false
}
variable "baas_protection_groups_include_last_run_info" {
  description = "If true, the response will include last run info. If it is false or not specified, the last run info won't be returned."
  type        = bool
  default     = false
}
variable "baas_protection_groups_prune_excluded_source_ids" {
  description = "If true, the response will not include the list of excluded source IDs in groups that contain this field. This can be set to true in order to improve performance if excluded source IDs are not needed by the user."
  type        = bool
  default     = false
}
variable "baas_protection_groups_prune_source_ids" {
  description = "If true, the response will exclude the list of source IDs within the group specified."
  type        = bool
  default     = false
}
variable "baas_protection_groups_use_cached_data" {
  description = "Specifies whether we can serve the GET request from the read replica cache. There is a lag of 15 seconds between the read replica and primary data source."
  type        = bool
  default     = false
}
variable "baas_protection_groups_source_ids" {
...
// Data source arguments for baas_protection_group_run
variable "baas_protection_group_run_baas_protection_group_run_id" {
  description = "Specifies a unique id of the Protection Group."
  type        = string
  default     = "baas_protection_group_run_id"
}
variable "baas_protection_group_run_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_protection_group_run_request_initiator_type" {
  description = "Specifies the type of request from UI, which is used for services like magneto to determine the priority of requests."
  type        = string
  default     = "placeholder"
}
variable "baas_protection_group_run_run_id" {
  description = "Specifies the protection run id."
  type        = string
  default     = "placeholder"
}
variable "baas_protection_group_run_start_time_usecs" {
...
variable "baas_protection_group_run_end_time_usecs" {
...
variable "baas_protection_group_run_run_types" {
  description = "Filter by run type. Only protection run matching the specified types will be returned."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_protection_group_run_include_object_details" {
...
variable "baas_protection_group_run_local_backup_run_status" {
...
variable "baas_protection_group_run_replication_run_status" {
...
variable "baas_protection_group_run_archival_run_status" {
  description = "Specifies a list of archival status, runs matching the status will be returned.<br> 'Running' indicates that the run is still running.<br> 'Canceled' indicates that the run has been canceled.<br> 'Canceling' indicates that the run is in the process of being canceled.<br> 'Failed' indicates that the run has failed.<br> 'Missed' indicates that the run was unable to take place at the scheduled time because the previous run was still happening.<br> 'Succeeded' indicates that the run has finished successfully.<br> 'SucceededWithWarning' indicates that the run finished successfully, but there were some warning messages.<br> 'Paused' indicates that the ongoing run has been paused.<br> 'Skipped' indicates that the run was skipped."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_protection_group_run_cloud_spin_run_status" {
...
variable "baas_protection_group_run_num_runs" {
  description = "Specifies the max number of runs. If not specified, at most 100 runs will be returned."
  type        = number
  default     = 0
}
variable "baas_protection_group_run_exclude_non_restorable_runs" {
...
variable "baas_protection_group_run_run_tags" {
...
variable "baas_protection_group_run_use_cached_data" {
  description = "Specifies whether we can serve the GET request from the read replica cache. There is a lag of 15 seconds between the read replica and primary data source."
  type        = bool
  default     = false
}
variable "baas_protection_group_run_filter_by_end_time" {
...
variable "baas_protection_group_run_snapshot_target_types" {
  description = "Specifies the snapshot's target type which should be filtered."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_protection_group_run_only_return_successful_copy_run" {
  description = "only successful copyruns are returned."
  type        = bool
  default     = false
}
variable "baas_protection_group_run_filter_by_copy_task_end_time" {
...
// Data source arguments for baas_protection_group_runs
variable "baas_protection_group_runs_baas_protection_group_runs_id" {
  description = "Specifies a unique id of the Protection Group."
  type        = string
  default     = "baas_protection_group_runs_id"
}
variable "baas_protection_group_runs_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_protection_group_runs_request_initiator_type" {
  description = "Specifies the type of request from UI, which is used for services like magneto to determine the priority of requests."
  type        = string
  default     = "placeholder"
}
variable "baas_protection_group_runs_run_id" {
  description = "Specifies the protection run id."
  type        = string
  default     = "placeholder"
}
variable "baas_protection_group_runs_start_time_usecs" {
  description = "Start time for time range filter. Specify the start time as a Unix epoch Timestamp (in microseconds), only runs executing after this time will be returned. By default it is endTimeUsecs minus an hour."
  type        = number
  default     = 0
}
variable "baas_protection_group_runs_end_time_usecs" {
  description = "End time for time range filter. Specify the end time as a Unix epoch Timestamp (in microseconds), only runs executing before this time will be returned. By default it is current time."
  type        = number
  default     = 0
}
variable "baas_protection_group_runs_run_types" {
  description = "Filter by run type. Only protection run matching the specified types will be returned."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_protection_group_runs_include_object_details" {
  description = "Specifies if the result includes the object details for each protection run. If set to true, details of the protected object will be returned. If set to false or not specified, details will not be returned."
  type        = bool
  default     = false
}
variable "baas_protection_group_runs_local_backup_run_status" {
  description = "Specifies a list of local backup status, runs matching the status will be returned.<br> 'Running' indicates that the run is still running.<br> 'Canceled' indicates that the run has been canceled.<br> 'Canceling' indicates that the run is in the process of being canceled.<br> 'Failed' indicates that the run has failed.<br> 'Missed' indicates that the run was unable to take place at the scheduled time because the previous run was still happening.<br> 'Succeeded' indicates that the run has finished successfully.<br> 'SucceededWithWarning' indicates that the run finished successfully, but there were some warning messages.<br> 'Paused' indicates that the ongoing run has been paused.<br> 'Skipped' indicates that the run was skipped."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_protection_group_runs_replication_run_status" {
  description = "Specifies a list of replication status, runs matching the status will be returned.<br> 'Running' indicates that the run is still running.<br> 'Canceled' indicates that the run has been canceled.<br> 'Canceling' indicates that the run is in the process of being canceled.<br> 'Failed' indicates that the run has failed.<br> 'Missed' indicates that the run was unable to take place at the scheduled time because the previous run was still happening.<br> 'Succeeded' indicates that the run has finished successfully.<br> 'SucceededWithWarning' indicates that the run finished successfully, but there were some warning messages.<br> 'Paused' indicates that the ongoing run has been paused.<br> 'Skipped' indicates that the run was skipped."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_protection_group_runs_archival_run_status" {
  description = "Specifies a list of archival status, runs matching the status will be returned.<br> 'Running' indicates that the run is still running.<br> 'Canceled' indicates that the run has been canceled.<br> 'Canceling' indicates that the run is in the process of being canceled.<br> 'Failed' indicates that the run has failed.<br> 'Missed' indicates that the run was unable to take place at the scheduled time because the previous run was still happening.<br> 'Succeeded' indicates that the run has finished successfully.<br> 'SucceededWithWarning' indicates that the run finished successfully, but there were some warning messages.<br> 'Paused' indicates that the ongoing run has been paused.<br> 'Skipped' indicates that the run was skipped."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_protection_group_runs_cloud_spin_run_status" {
  description = "Specifies a list of cloud spin status, runs matching the status will be returned.<br> 'Running' indicates that the run is still running.<br> 'Canceled' indicates that the run has been canceled.<br> 'Canceling' indicates that the run is in the process of being canceled.<br> 'Failed' indicates that the run has failed.<br> 'Missed' indicates that the run was unable to take place at the scheduled time because the previous run was still happening.<br> 'Succeeded' indicates that the run has finished successfully.<br> 'SucceededWithWarning' indicates that the run finished successfully, but there were some warning messages.<br> 'Paused' indicates that the ongoing run has been paused.<br> 'Skipped' indicates that the run was skipped."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_protection_group_runs_num_runs" {
  description = "Specifies the max number of runs. If not specified, at most 100 runs will be returned."
  type        = number
  default     = 0
}
variable "baas_protection_group_runs_exclude_non_restorable_runs" {
  description = "Specifies whether to exclude non restorable runs. Run is treated restorable only if there is atleast one object snapshot (which may be either a local or an archival snapshot) which is not deleted or expired. Default value is false."
  type        = bool
  default     = false
}
variable "baas_protection_group_runs_run_tags" {
  description = "Specifies a list of tags for protection runs. If this is specified, only the runs which match these tags will be returned."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_protection_group_runs_use_cached_data" {
  description = "Specifies whether we can serve the GET request from the read replica cache. There is a lag of 15 seconds between the read replica and primary data source."
  type        = bool
  default     = false
}
variable "baas_protection_group_runs_filter_by_end_time" {
  description = "If true, the runs with backup end time within the specified time range will be returned. Otherwise, the runs with start time in the time range are returned."
  type        = bool
  default     = false
}
variable "baas_protection_group_runs_snapshot_target_types" {
  description = "Specifies the snapshot's target type which should be filtered."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_protection_group_runs_only_return_successful_copy_run" {
  description = "only successful copyruns are returned."
  type        = bool
  default     = false
}
variable "baas_protection_group_runs_filter_by_copy_task_end_time" {
  description = "If true, then the details of the runs for which any copyTask completed in the given timerange will be returned. Only one of filterByEndTime and filterByCopyTaskEndTime can be set."
  type        = bool
  default     = false
}

// Data source arguments for baas_protection_policies
variable "baas_protection_policies_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_protection_policies_request_initiator_type" {
  description = "Specifies the type of request from UI, which is used for services like magneto to determine the priority of requests."
  type        = string
  default     = "placeholder"
}
variable "baas_protection_policies_ids" {
  description = "Filter policies by a list of policy ids."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_protection_policies_policy_names" {
  description = "Filter policies by a list of policy names."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_protection_policies_types" {
  description = "Types specifies the policy type of policies to be returned."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_protection_policies_exclude_linked_policies" {
...
variable "baas_protection_policies_include_replicated_policies" {
...
variable "baas_protection_policies_include_stats" {
...
// Data source arguments for baas_protection_policy
variable "data_baas_protection_policy_baas_protection_policy_id" {
  description = "Specifies a unique id of the Protection Policy to return."
  type        = string
  default     = "baas_protection_policy_id"
}
variable "data_baas_protection_policy_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "data_baas_protection_policy_request_initiator_type" {
  description = "Specifies the type of request from UI, which is used for services like magneto to determine the priority of requests."
  type        = string
  default     = "placeholder"
}

// Data source arguments for baas_recovery
variable "data_baas_recovery_baas_recovery_id" {
  description = "Specifies the id of a Recovery."
  type        = string
  default     = "baas_recovery_id"
}
variable "data_baas_recovery_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}

// Data source arguments for baas_recoveries
variable "baas_recoveries_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_recoveries_ids" {
  description = "Filter Recoveries for given ids."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_recoveries_return_only_child_recoveries" {
  description = "Returns only child recoveries if passed as true. This filter should always be used along with 'ids' filter."
  type        = bool
  default     = false
}
variable "baas_recoveries_start_time_usecs" {
...
variable "baas_recoveries_end_time_usecs" {
...
variable "baas_recoveries_snapshot_target_type" {
  description = "Specifies the snapshot's target type from which recovery has been performed."
  type        = list(string)
  default     = [ "placeholder" ]
}
variable "baas_recoveries_archival_target_type" {
...
variable "baas_recoveries_snapshot_environments" {
...
variable "baas_recoveries_status" {
...
variable "baas_recoveries_recovery_actions" {
...
// Data source arguments for baas_source_registrations
variable "baas_source_registrations_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_source_registrations_ids" {
...
variable "baas_source_registrations_include_source_credentials" {
...
variable "baas_source_registrations_encryption_key" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "placeholder"
}
variable "baas_source_registrations_use_cached_data" {
  description = "Specifies whether we can serve the GET request from the read replica cache. There is a lag of 15 seconds between the read replica and primary data source."
  type        = bool
  default     = false
}
variable "baas_source_registrations_include_external_metadata" {
...
variable "baas_source_registrations_ignore_tenant_migration_in_progress_check" {
  description = "If true, tenant migration check will be ignored."
  type        = bool
  default     = false
}

// Data source arguments for baas_source_registration
variable "data_baas_source_registration_baas_source_registration_id" {
  description = "Specifies the id of the Protection Source registration."
  type        = number
  default     = 2
}
variable "data_baas_source_registration_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "data_baas_source_registration_request_initiator_type" {
  description = "Specifies the type of request from UI, which is used for services like magneto to determine the priority of requests."
  type        = string
  default     = "placeholder"
}

// Data source arguments for baas_download_indexed_files
variable "baas_download_indexed_files_snapshots_id" {
  description = "Specifies the snapshot id to download from."
  type        = string
  default     = "snapshots_id"
}
variable "baas_download_indexed_files_x_ibm_tenant_id" {
  description = "Specifies the key to be used to encrypt the source credential. If includeSourceCredentials is set to true this key must be specified."
  type        = string
  default     = "x_ibm_tenant_id"
}
variable "baas_download_indexed_files_file_path" {
