...
|------|-------------|------|---------|
| instance_id | Secrets Manager instance ID. | `string` | true |
...
| href | The URL of the instance resource. |

### Resource: ibm_sm_admin_token
...
| created_at    | The date that the admin token was created.                    |
