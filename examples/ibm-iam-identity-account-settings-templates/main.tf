...
data "ibm_iam_account_settings_template" "account_settings_template_instance_data" {
 template_id = ibm_iam_account_settings_template.account_settings_template_instance.id
 version = ibm_iam_account_settings_template.account_settings_template_instance.version
}
data "ibm_iam_account_settings_template" "account_settings_template_new_version_data" {
 template_id = ibm_iam_account_settings_template.account_settings_template_new_version.id
 version = ibm_iam_account_settings_template.account_settings_template_new_version.version
}
