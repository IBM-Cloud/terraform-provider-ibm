...
require (
	github.com/IBM-Cloud/secrets-manager-mt-go-sdk v0.0.0
)
...
replace github.com/IBM-Cloud/secrets-manager-mt-go-sdk v0.0.0 => ./../../../github.com/IBM-Cloud/secrets-manager-mt-go-sdk
