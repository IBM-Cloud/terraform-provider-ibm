...
require (
	...
	github.com/IBM/event-notifications-go-admin-sdk v0.5.0
...
replace github.com/IBM/event-notifications-go-admin-sdk v0.5.0 => /Users/divyasingh/Desktop/Terraform-Code/event-notifications-go-admin-sdk
