...
func (m *GetPublicGatewaysOKBodyNext) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetPublicGatewaysOKBodyNext) validateHref(formats strfmt.Registry) error {
...
func (m *GetPublicGatewaysOKBodyNext) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetPublicGatewaysOKBodyNext) UnmarshalBinary(b []byte) error {
