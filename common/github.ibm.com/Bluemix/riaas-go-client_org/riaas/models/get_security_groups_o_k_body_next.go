...
func (m *GetSecurityGroupsOKBodyNext) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetSecurityGroupsOKBodyNext) validateHref(formats strfmt.Registry) error {
...
func (m *GetSecurityGroupsOKBodyNext) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetSecurityGroupsOKBodyNext) UnmarshalBinary(b []byte) error {
