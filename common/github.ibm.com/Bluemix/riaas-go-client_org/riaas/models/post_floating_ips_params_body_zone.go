...
func (m *PostFloatingIpsParamsBodyZone) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostFloatingIpsParamsBodyZone) validateName(formats strfmt.Registry) error {
...
func (m *PostFloatingIpsParamsBodyZone) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PostFloatingIpsParamsBodyZone) UnmarshalBinary(b []byte) error {
