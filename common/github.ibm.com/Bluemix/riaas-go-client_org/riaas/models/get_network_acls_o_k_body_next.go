...
func (m *GetNetworkAclsOKBodyNext) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetNetworkAclsOKBodyNext) validateHref(formats strfmt.Registry) error {
...
func (m *GetNetworkAclsOKBodyNext) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetNetworkAclsOKBodyNext) UnmarshalBinary(b []byte) error {
