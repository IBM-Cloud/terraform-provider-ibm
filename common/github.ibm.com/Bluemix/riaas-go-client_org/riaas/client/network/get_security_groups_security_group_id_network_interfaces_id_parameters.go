...
func (o *GetSecurityGroupsSecurityGroupIDNetworkInterfacesIDParams) WithGeneration(generation int64) *GetSecurityGroupsSecurityGroupIDNetworkInterfacesIDParams {
	o.SetGeneration(generation)
	return o
}

// SetGeneration adds the generation to the get security groups security group ID network interfaces ID params
func (o *GetSecurityGroupsSecurityGroupIDNetworkInterfacesIDParams) SetGeneration(generation int64) {
