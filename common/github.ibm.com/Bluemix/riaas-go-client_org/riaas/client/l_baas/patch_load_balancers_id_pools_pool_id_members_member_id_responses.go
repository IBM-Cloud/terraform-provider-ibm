...
func (o *PatchLoadBalancersIDPoolsPoolIDMembersMemberIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPatchLoadBalancersIDPoolsPoolIDMembersMemberIDOK()
...
func NewPatchLoadBalancersIDPoolsPoolIDMembersMemberIDOK() *PatchLoadBalancersIDPoolsPoolIDMembersMemberIDOK {
	return &PatchLoadBalancersIDPoolsPoolIDMembersMemberIDOK{}
}
...
func (o *PatchLoadBalancersIDPoolsPoolIDMembersMemberIDOK) Error() string {
	return fmt.Sprintf("[PATCH /load_balancers/{id}/pools/{pool_id}/members/{member_id}][%d] patchLoadBalancersIdPoolsPoolIdMembersMemberIdOK  %+v", 200, o.Payload)
}

func (o *PatchLoadBalancersIDPoolsPoolIDMembersMemberIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
