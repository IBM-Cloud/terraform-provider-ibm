...
// IpsecPolicyIdentity ipsec policy identity
// swagger:model IPsecPolicyIdentity
...
func (m *IpsecPolicyIdentity) validateHref(formats strfmt.Registry) error {
...
func (m *IpsecPolicyIdentity) validateID(formats strfmt.Registry) error {
