...
// AddressPrefixZone ZoneReference
// swagger:model AddressPrefixZone
...
func (m *AddressPrefixZone) validateHref(formats strfmt.Registry) error {
...
func (m *AddressPrefixZone) validateName(formats strfmt.Registry) error {
