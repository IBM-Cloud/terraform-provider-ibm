...
func (o *PatchVolumesIDParams) WithBody(body PatchVolumesIDBody) *PatchVolumesIDParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the patch volumes ID params
func (o *PatchVolumesIDParams) SetBody(body PatchVolumesIDBody) {
	o.Body = body
}
