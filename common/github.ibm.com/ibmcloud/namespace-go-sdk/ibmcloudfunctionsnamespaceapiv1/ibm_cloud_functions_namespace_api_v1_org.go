 ...
 ***********************************************************************************************************************************************************
 *																			   *
 *  Generated namespace SDK has the following changes.													   *
 *  When we regenerate the sdk please refer below comments and do the changes to 'ibm_cloud_functions_namespace_api_v1.go'				   *
 *																			   *
 ***********************************************************************************************************************************************************
 *  @import statements:
 *	  - Replace 'github.com/IBM/cloud-go-sdk/common' to 'common "github.ibm.com/ibmcloud/namespace-go-sdk/common"'
 *
 *  @Type structure name:
 *   - Replace 'IbmCloudFunctionsNamespaceApiV1' to 'IbmCloudFunctionsNamespaceAPIV1'
 *   - Replace 'IbmCloudFunctionsNamespaceApiV1Options' to 'IbmCloudFunctionsNamespaceOptions'
 *
 *  @Type structure variables:
 *   - Replace variable name 'ApiKeyCreated' to 'APIKeyCreated'
 *   - Replace variable name 'ApiKeyID' to 'APIKeyID'
 *   - Add below variables to 'NamespaceResponse' structure
 ...
 *
 *  @Function name:
 *   - Replace method name 'NewIbmCloudFunctionsNamespaceApiV1UsingExternalConfig' to 'NewIbmCloudFunctionsNamespaceAPIV1UsingExternalConfig'
 *   - Replace method name 'NewIbmCloudFunctionsNamespaceApiV1' to 'NewIbmCloudFunctionsNamespaceAPIV1'
 *
 *   @Object name:
 *    - Replace object name 'ibmCloudFunctionsNamespaceApi' to 'ibmCloudFunctionsNamespaceAPI'
 *    - Replace type structure name 'IbmCloudFunctionsNamespaceApiV1' to 'IbmCloudFunctionsNamespaceAPIV1'
 *
 *   @Function Reciever Type
 *    - Replace method reciever name '(ibmCloudFunctionsNamespaceApi *IbmCloudFunctionsNamespaceApiV1)' to '(ibmCloudFunctionsNamespaceAPI *IbmCloudFunctionsNamespaceAPIV1)'
 *
 *   @fmt.Errorf:
 *    - Replace all the occurance of statement 'An error occurred while processing the operation response.' with 'an error occurred while processing the operation response'
 *
 *   -@Add following interfaces and implement interface methods to handle namespaceresponse list
 *
 *	//NamespaceResource ..
 ...
 *	type NamespaceListResource interface {
 *		GetNamespaces() []NamespaceResource
 *	}
 *
 *	//NamespaceResourceList ..
 *	type NamespaceResourceList []NamespaceResource
 *
 * 	/GetNamespaces ..
