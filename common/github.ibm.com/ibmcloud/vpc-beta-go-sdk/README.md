...
Go Beta client library to interact with the various [IBM Cloud VPC Services Beta APIs](https://cloud.ibm.com/apidocs?category=vpc).
...
```
go get -u github.ibm.com/ibmcloud/vpc-beta-go-sdk/vpcclassicv1
```

To install VPC Go SDK service, use the following.

```
go get -u github.ibm.com/ibmcloud/vpc-beta-go-sdk/vpcbetav1
```
...
import (
	...
	"github.ibm.com/ibmcloud/vpc-beta-go-sdk/vpcbetav1"
)
```
...
[[constraint]]
  ...
  version = "0.0.1"
[[constraint]]
  name = "github.ibm.com/ibmcloud/vpc-beta-go-sdk/vpcbetav1"
  version = "0.0.1"
```
