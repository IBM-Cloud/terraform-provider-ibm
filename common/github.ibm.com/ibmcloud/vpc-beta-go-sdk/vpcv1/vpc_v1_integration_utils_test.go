...
func ListShareProfiles(vpcService *vpcv1.VpcV1) (result *vpcv1.ShareProfileCollection, response *core.DetailedResponse, err error) {
...
func GetShareProfile(vpcService *vpcv1.VpcV1, name string) (result *vpcv1.ShareProfile, response *core.DetailedResponse, err error) {
...
func ListShares(vpcService *vpcv1.VpcV1) (result *vpcv1.ShareCollection, response *core.DetailedResponse, err error) {
...
func CreateShare(vpcService *vpcv1.VpcV1, createdVPCID, name *string) (result *vpcv1.Share, response *core.DetailedResponse, err error) {
	...
	sharePrototypeShareContextModel := &vpcv1.SharePrototypeShareContext{
...
func GetShare(vpcService *vpcv1.VpcV1, shareID *string) (result *vpcv1.Share, response *core.DetailedResponse, err error) {
...
func UpdateShare(vpcService *vpcv1.VpcV1, shareID, etag, name *string) (result *vpcv1.Share, response *core.DetailedResponse, err error) {
...
func GetShareSource(vpcService *vpcv1.VpcV1, shareID *string) (result *vpcv1.Share, response *core.DetailedResponse, err error) {
...
func FailoverShare(vpcService *vpcv1.VpcV1, shareID *string) (response *core.DetailedResponse, err error) {
...
func ListShareTargets(vpcService *vpcv1.VpcV1, shareID *string) (result *vpcv1.ShareTargetCollection, response *core.DetailedResponse, err error) {
	listShareTargetsOptions := &vpcv1.ListShareTargetsOptions{
		ShareID: shareID,
	}

	result, response, err = vpcService.ListShareTargets(listShareTargetsOptions)
	return
}

func CreateShareTarget(vpcService *vpcv1.VpcV1, vpcID, shareID, name *string) (result *vpcv1.ShareTarget, response *core.DetailedResponse, err error) {
	vpcIdentityModel := &vpcv1.VPCIdentityByID{
		ID: vpcID,
	}
	...
	result, response, err = vpcService.CreateShareTarget(createShareTargetOptions)
	return
}

func GetShareTarget(vpcService *vpcv1.VpcV1, shareID, targetID *string) (result *vpcv1.ShareTarget, response *core.DetailedResponse, err error) {
	getShareTargetOptions := &vpcv1.GetShareTargetOptions{
		ShareID: shareID,
		ID:      targetID,
	}

	result, response, err = vpcService.GetShareTarget(getShareTargetOptions)
	return
}

func UpdateShareTarget(vpcService *vpcv1.VpcV1, shareID, targetID, name *string) (result *vpcv1.ShareTarget, response *core.DetailedResponse, err error) {
	...
	result, response, err = vpcService.UpdateShareTarget(updateShareTargetOptions)
	return
}

func DeleteShareTarget(vpcService *vpcv1.VpcV1, shareID, targetID *string) (result *vpcv1.ShareTarget, response *core.DetailedResponse, err error) {
	deleteShareTargetOptions := &vpcv1.DeleteShareTargetOptions{
		ShareID: shareID,
		ID:      targetID,
	}

	result, response, err = vpcService.DeleteShareTarget(deleteShareTargetOptions)
	return
}

func DeleteShareSource(vpcService *vpcv1.VpcV1, shareID *string) (response *core.DetailedResponse, err error) {
...
func DeleteShare(vpcService *vpcv1.VpcV1, shareID, etag *string) (result *vpcv1.Share, response *core.DetailedResponse, err error) {
...
func PollInstance(vpcService *vpcv1.VpcV1, ID, status string, pollFrequency int) bool {
	...
	for {
		if count < pollFrequency {
			...
			fmt.Println("Expected status of VSI - ", "pending")
			if err != nil && res == nil {
