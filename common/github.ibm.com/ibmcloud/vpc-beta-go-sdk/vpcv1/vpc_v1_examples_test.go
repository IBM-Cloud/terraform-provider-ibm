...
var _ = Describe(`VpcV1 Examples Tests`, func() {
	...
	Describe(`VpcV1 request examples`, func() {
		...
		It(`CreateShare request example`, func() {
			...
			shareTargetPrototypeModel1 := &vpcv1.ShareTargetPrototype{
				Name: core.StringPtr("my-share-target-1"),
				VPC:  vpcIdentityModel,
			}
			sharePrototypeShareContextModel1 := &vpcv1.SharePrototypeShareContext{
				Iops:                core.Int64Ptr(int64(100)),
				Name:                core.StringPtr("my-replica-share-1"),
				Profile:             shareProfileIdentityModel,
				ReplicationCronSpec: core.StringPtr("0 */5 * * *"),
				Targets:             []vpcv1.ShareTargetPrototype{*shareTargetPrototypeModel1},
				UserTags:            []string{"my-share-tag-1"},
				Zone:                zoneIdentityModel,
			}
			sharePrototype1 := &vpcv1.SharePrototype{
