...
var _ = Describe(`VpcV1 Examples Tests`, func() {
	...
	Describe(`VpcV1 request examples`, func() {
		...
		It(`ListInstanceNetworkInterfaceIps request example`, func() {
			...
			listInstanceNetworkInterfaceIpsOptions := vpcService.NewListInstanceNetworkInterfaceIpsOptions(
				"testString",
				"testString",
			)
			...
			b, _ := json.MarshalIndent(reservedIPCollectionNetworkInterfaceContext, "", "  ")
			fmt.Println(string(b))
		...
		It(`ListBackupPolicies request example`, func() {
			...
			b, _ := json.MarshalIndent(backupPolicyCollection, "", "  ")
			fmt.Println(string(b))
		...
		It(`CreateBackupPolicy request example`, func() {
			...
			b, _ := json.MarshalIndent(backupPolicy, "", "  ")
			fmt.Println(string(b))
		...
		It(`ListBackupPolicyPlans request example`, func() {
			...
			b, _ := json.MarshalIndent(backupPolicyPlanCollection, "", "  ")
			fmt.Println(string(b))
		...
		It(`GetBackupPolicyPlan request example`, func() {
			...
			b, _ := json.MarshalIndent(backupPolicyPlan, "", "  ")
			fmt.Println(string(b))
		...
		It(`GetBareMetalServerConsole request example`, func() {
			...
			fmt.Printf("\nGetBareMetalServerConsole() response status code: %d\n", response.StatusCode)
		...
		It(`CreateBareMetalServerRestart request example`, func() {
			...
			fmt.Printf("\nCreateBareMetalServerRestart() response status code: %d\n", response.StatusCode)
		...
		It(`CreateBareMetalServerStart request example`, func() {
			...
			fmt.Printf("\nCreateBareMetalServerStart() response status code: %d\n", response.StatusCode)
		...
		It(`CreateBareMetalServerStop request example`, func() {
			...
			fmt.Printf("\nCreateBareMetalServerStop() response status code: %d\n", response.StatusCode)
		...
		It(`ListVPNGatewayAdvertisedCIDRs request example`, func() {
			fmt.Println("\nListVPNGatewayAdvertisedCIDRs() result:")
		...
		It(`CheckVPNGatewayAdvertisedCIDR request example`, func() {
			...
			fmt.Printf("\nCheckVPNGatewayAdvertisedCIDR() response status code: %d\n", response.StatusCode)
		...
		It(`AddVPNGatewayAdvertisedCIDR request example`, func() {
			...
			fmt.Printf("\nAddVPNGatewayAdvertisedCIDR() response status code: %d\n", response.StatusCode)
		...
		It(`ListVPNServers request example`, func() {
			...
			b, _ := json.MarshalIndent(vpnServerCollection, "", "  ")
			fmt.Println(string(b))
		...
		It(`CreateVPNServer request example`, func() {
			...
			b, _ := json.MarshalIndent(vpnServer, "", "  ")
			fmt.Println(string(b))
		...
		It(`UpdateVPNServer request example`, func() {
			...
			updateVPNServerOptions.SetIfMatch("96d225c4-56bd-43d9-98fc-d7148e5c5028")
		...
		It(`GetVPNServerClientConfiguration request example`, func() {
			...
			b, _ := json.MarshalIndent(vpnServerClientConfiguration, "", "  ")
			fmt.Println(string(b))
		...
		It(`ListVPNServerClients request example`, func() {
			...
			b, _ := json.MarshalIndent(vpnServerClientCollection, "", "  ")
			fmt.Println(string(b))
		...
		It(`GetVPNServerClient request example`, func() {
			...
			b, _ := json.MarshalIndent(vpnServerClient, "", "  ")
			fmt.Println(string(b))
		...
		It(`DisconnectVPNClient request example`, func() {
			...
			fmt.Printf("\nDisconnectVPNClient() response status code: %d\n", response.StatusCode)
		...
		It(`ListVPNServerRoutes request example`, func() {
			...
			b, _ := json.MarshalIndent(vpnServerRouteCollection, "", "  ")
			fmt.Println(string(b))
		...
		It(`CreateVPNServerRoute request example`, func() {
			...
			b, _ := json.MarshalIndent(vpnServerRoute, "", "  ")
			fmt.Println(string(b))
		...
		It(`RemoveVPNGatewayAdvertisedCIDR request example`, func() {
			...
			fmt.Printf("\nRemoveVPNGatewayAdvertisedCIDR() response status code: %d\n", response.StatusCode)
		...
		It(`RemoveBareMetalServerNetworkInterfaceFloatingIP request example`, func() {
			...
			fmt.Printf("\nRemoveBareMetalServerNetworkInterfaceFloatingIP() response status code: %d\n", response.StatusCode)
		...
		It(`DeleteVPNServerRoute request example`, func() {
			...
			fmt.Printf("\nDeleteVPNServerRoute() response status code: %d\n", response.StatusCode)
		...
		It(`DeleteVPNServerClient request example`, func() {
			...
			fmt.Printf("\nDeleteVPNServerClient() response status code: %d\n", response.StatusCode)
		...
		It(`DeleteVPNServer request example`, func() {
			...
			fmt.Printf("\nDeleteVPNServer() response status code: %d\n", response.StatusCode)
