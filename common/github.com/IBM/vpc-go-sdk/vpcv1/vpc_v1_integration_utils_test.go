...
func UpdateInstanceGroupManagerPolicy(vpcService *vpcv1.VpcV1, igID, mID, id string) (template vpcv1.InstanceGroupManagerPolicyIntf, response *core.DetailedResponse, err error) {
